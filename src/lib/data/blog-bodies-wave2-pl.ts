/**
 * Wave 2: Polish long-form blog bodies for Alemniam.
 * Written for Polish households living in Germany; links intentionally follow
 * the existing Polish locale + German recipe-slug convention.
 */

const zrodla = `
## Źródła, bezpieczeństwo i dalsza lektura

Przy gotowaniu dla domu trzymamy się prostych, sprawdzonych zasad, a nie viralowych porad. O przechowywaniu, higienie i zbilansowanym jedzeniu czytamy materiały [Narodowego Centrum Edukacji Żywieniowej](https://ncez.pzh.gov.pl), praktyczne porady [BZfE](https://www.bzfe.de) oraz informacje dla konsumentów na portalu [Unii Europejskiej](https://europa.eu/youreurope/citizens/consumers/index_en.htm). To źródła orientacyjne — przy alergii, ciąży lub chorobie decyzję konsultujemy z lekarzem albo dietetykiem.
`;

const dopracujPrzewodnik = (temat: string) => `
## Plan, który działa w zwykłym tygodniu

${temat} najlepiej wychodzi wtedy, gdy nie próbujemy zrobić wszystkiego naraz. My zaczynamy od jednej decyzji: co ma być gotowe dzisiaj, co może spokojnie poczekać do jutra, a co warto przygotować do zamrażarki. W niemieckiej kuchni — często mniejszej niż ta, którą pamiętamy z rodzinnego domu — kolejność pracy jest ważniejsza niż liczba akcesoriów. Najpierw robimy miejsce na blacie, wyjmujemy pojemniki i ustalamy ilość porcji. Dopiero potem kupujemy.

Zapisujemy też drobne obserwacje: marka mąki, czas gotowania, ilość soli, to czy dzieci zjadły wersję łagodniejszą. Nie chodzi o obsesję pomiaru. Chodzi o własny, powtarzalny punkt odniesienia. Dzięki temu następna niedziela nie zaczyna się od zgadywania. Jeśli coś nie wyszło, zmieniamy jeden element, a nie cały przepis. To najspokojniejsza droga do dobrego domowego smaku.

## Smak budowany małymi decyzjami

Nie próbujemy osiągnąć „autentyczności” przez dokładanie wszystkiego, co kojarzy się z polską kuchnią. Dobre danie ma czytelny główny smak. Gdy gotujemy zupę, najpierw ma smakować wywar; gdy robimy farsz, ma być wyczuwalny jego podstawowy składnik; gdy podajemy kiszonkę, ma być świeża i kwaśna, a nie przesolona. My próbujemy potrawy w trakcie pracy, ale pamiętamy, że po wystudzeniu lub odpoczynku aromaty się zmieniają. Szczególnie sól, kwas, majeranek i czosnek potrzebują chwili, aby przestać być pojedynczymi nutami.

Produkty z dwóch krajów nie są problemem. Kupujemy świeże warzywa i bazowe rzeczy tam, gdzie są najlepsze po drodze, a w polskim sklepie szukamy składników o konkretnym charakterze. Krótsza lista zakupów oznacza mniej stresu i mniej produktów zapomnianych na dnie lodówki. Jeśli czegoś nie ma, najpierw pytamy: jaką funkcję pełni w daniu? Kwasowość, kremowość, dymny aromat, struktura? Dopiero potem wybieramy zamiennik. Tak działa kuchnia, która pozostaje polska w smaku, ale nie jest zależna od jednej półki.

## Stół i komunikacja

My mówimy domownikom, co będzie na obiad i kiedy można się włączyć. Ktoś może obrać warzywa, opisać pojemniki albo spróbować farszu. Dzieci nie muszą od razu jeść wszystkiego; mała porcja bez presji jest lepsza niż negocjacje przy pełnym talerzu. Gości pytamy wcześniej o ważne ograniczenia, a nie w chwili podania. Przy alergiach czy diecie eliminacyjnej używamy oddzielnych narzędzi i nie zakładamy, że „odrobina nic nie zmieni”.

Podanie też jest częścią planu. Gorące danie czeka w garnku, a nie odwrotnie. Na małym stole stawiamy tylko to, co jest potrzebne, resztę dokładamy później. Dzięki temu jedzenie nie stygnie, a gospodarz nie krąży między kuchnią i salonem. To zwyczajne rozwiązania, ale właśnie one pozwalają nam pamiętać obiad jako spotkanie, a nie serię zadań.

## Krótka kontrola jakości

Zanim podamy, my robimy pauzę na trzy pytania. Czy danie jest bezpiecznie gorące albo właściwie schłodzone? Czy ma równowagę soli, kwasu i tłuszczu? Czy na stole jest wygodna porcja dla każdej osoby? Ta minuta pomaga zauważyć brak łyżki, zbyt zimną zupę czy farsz, który potrzebuje pieprzu. Nie poprawiamy potrawy impulsywnie. Dodajemy małymi porcjami, mieszamy i próbujemy ponownie.

Po obiedzie zapisujemy tylko jedną rzecz, którą chcemy zachować lub zmienić. „Mniej soli”, „farsz wystudzić wcześniej”, „zrobić dwie porcje do zamrażarki” — taka notatka jest użyteczna. Dzięki niej nasza kuchnia rozwija się z każdym powtórzeniem, bez presji, że każde gotowanie musi być idealne.

## Jak ograniczyć marnowanie

My kupujemy składniki z przeznaczeniem, nie „na wszelki wypadek”. Resztę dzielimy na małe porcje, opisujemy datą i chłodzimy możliwie szybko. Gorącej potrawy nie zostawiamy na noc na kuchence; po lekkim przestudzeniu trafia do płytkich pojemników. Dania z mięsem, nabiałem albo rybą wymagają szczególnej ostrożności. W razie wątpliwości co do zapachu, temperatury lub czasu przechowywania nie ryzykujemy — oszczędność nie jest warta zdrowia.

Warto też planować „drugi talerz”: to, co dziś jest obiadem, jutro może być dodatkiem do pieczonych ziemniaków, farszem do naleśników albo porcją na szybki wieczór. Zamrażarka nie jest półką wstydu. Jest narzędziem, które pozwala gotować po polsku także wtedy, gdy tydzień w Niemczech robi się zbyt szybki.

## Jakość, higiena i orientacja

My pracujemy ze świeżymi składnikami, czystymi rękami i jasnymi ścieżkami temperatury. Surowe mięso trzymamy oddzielnie od produktów gotowych do jedzenia; resztki szybko chłodzimy w płytkich pojemnikach i podgrzewamy tylko porcjami. Praktyczne wskazówki: [NCEŻ](https://ncez.pzh.gov.pl), [BZfE](https://www.bzfe.de), [Komisja Europejska — rolnictwo](https://agriculture.ec.europa.eu).

### Zakupy z jasnym celem

My kupujemy specjalne składniki celowo, a podstawy tam, gdzie jakość i cena się zgadzają. W [sklepie polskim](/pl/blog/sklep-polski-zakupy) szukamy fermentów, [twarogu](/pl/blog/twarog-w-niemczech), grzybów i kiełbasy; w niemieckim markecie — warzyw, mąki i nabiału.

## FAQ

### Czy my musimy kupować wszystko „oryginalnie”?

Nie. My stawiamy na smak, funkcję i powtarzalną jakość.

### Jak my planujemy ilości bez marnowania?

My liczymy gości i posiłki, potem kupujemy. Dokładamy porcje przy stole, a resztki chowamy bezpiecznie.

### Co my robimy, gdy nie jesteśmy pewni świeżości?

My nie liczymy wyłącznie na przyprawę albo podgrzanie. Przy wątpliwości wyrzucamy produkt.

### Czy my możemy przygotować dania wcześniej?

Tak. My rozdzielamy składniki sensownie, szybko chłodzimy i opisujemy datę.

### Jak my utrzymujemy klarowny smak?

My próbujemy etapami i dopiero na końcu dodajemy kwas, sól i świeże zioła.

## Dalsze gotowanie

My łączymy technikę z konkretnym daniem: [pierogi ruskie](/pl/rezepte/pierogi/ruskie), [żurek](/pl/rezepte/zurek), [bigos](/pl/rezepte/bigos) albo [ciasto na pierogi](/pl/blog/ciasto-na-pierogi).
${zrodla}`;

const dopracujZakup = (nazwa: string) => `
...
export const bodyPierogiGuidePl = `Pierogi są dla wielu z nas najprostszym sposobem, by zwykła niedziela w Niemczech miała polski rytm. Nie potrzebujemy idealnej kuchni ani „oryginalnej” mąki przywiezionej z kraju. Potrzebujemy dobrego planu, miękkiego [ciasta na pierogi](/pl/blog/ciasto-na-pierogi) i farszu, który nie wypływa przy gotowaniu.
...
Mąka 405 lub 550 działa, lecz każda marka inaczej pije wodę. Dlatego wlewamy ją stopniowo i dajemy kuli odpocząć minimum 20 minut. Dzielimy masę, resztę przykrywamy, wałkujemy od środka i wycinamy równe koła. Nakładamy mniej farszu, niż podpowiada odruch: pieróg ma się łatwo zamknąć, a nie walczyć o każdy milimetr rantu. Brzeg oczyszczamy z farszu, ściskamy kciukiem i palcem, a pierwszą sztukę gotujemy testowo.

## Gotowanie i mrożenie

Woda ma łagodnie wrzeć, nie kipieć jak przy makaronie. Wrzucamy małe partie, mieszamy tylko na początku, a po wypłynięciu dajemy im kilka minut zależnie od grubości. Surowe pierogi mrozimy najpierw osobno na tacy, potem przesypujemy do opisanych worków. Nie rozmrażamy ich przed gotowaniem. To właśnie ten zapas ratuje poniedziałkowy wieczór.

**To nie pierogi:** [knedle ze śliwkami](/pl/rezepte/knedle-sliwki) to okrągłe knedle owocowe z ciastem ziemniaczanym — własna forma, własny intent. [Pierogi leniwe](/pl/rezepte/pierogi-leniwe) to kluseczki z twarogu bez lepienia; obie strony nie należą do sklejanej partii tego przewodnika.

## Najczęstsze kłopoty

Pękanie oznacza zwykle suche albo nieodstałe ciasto. Otwieranie się — zbyt dużo farszu lub mokry rant. Gumowata struktura po gotowaniu wynika z grubej warstwy ciasta albo zbyt mocnego wrzenia. My nie poprawiamy wszystkiego mąką; najpierw sprawdzamy odpoczynek, wilgotność i temperaturę farszu.

## FAQ — pierogi w domu

### Czy my musimy używać jajka?

Nie. My często używamy jednego jajka do większej partii dla stabilności, ale ciasto z mąki, wody i soli także może być bardzo dobre.

### Czy my możemy zrobić pierogi dzień wcześniej?

Tak. My wolimy uformować i zamrozić je surowe, zamiast przechowywać ugotowane sztuki w lodówce.

### Jak my dzielimy pracę?

Jedna osoba wałkuje i wycina, druga nakłada farsz i skleja. To szybciej i znacznie przyjemniej niż samotny maraton.
${dopracujPrzewodnik("Produkcja pierogów")}`;

export const bodyFreezerMealPrepPl = `Zamrażarka w polskim domu w Niemczech nie musi być magazynem przypadkowych pudełek. Dobrze prowadzona daje nam kilka spokojnych obiadów bez rezygnowania z domowego smaku.
...
${dopracujZakup('Foremka do pierogów')}`;

export const bodyPolnischeSuppenPl = `Polska zupa w Niemczech ma wielką przewagę: da się ugotować rozsądnie z produktów z REWE, Kauflandu czy sklepu polskiego, a potem dobrze podgrzać następnego dnia. Nie potrzebuje dekoracji; potrzebuje czystego smaku i czasu.
...
Bo spokojny garnek daje czystszy smak i mniej mętny wywar.
${dopracujPrzewodnik("Polskie zupy")}`;

export const bodyRosolTechnikPl = `Rosół nie wymaga tajemnicy rodzinnej. Wymaga cierpliwości, dobrych produktów i łagodnego ognia. To właśnie technika odróżnia klarowną, pachnącą miskę od ciężkiego, mętnego wywaru.

## Mięso i warzywa

My wybieramy kawałki z kością oraz trochę mięsa, które później wykorzystamy do farszu. Marchew, pietruszkę, seler i por dokładnie myjemy. Cebulę można opalić na suchej patelni dla koloru, lecz nie trzeba jej spalać. W niemieckim sklepie wszystkie te składniki są łatwo dostępne; liczy się świeżość, nie egzotyczna etykieta.

## Temperatura decyduje

Garnek ma tylko lekko mrugać. Zbieramy pianę na początku, potem nie mieszamy bez potrzeby i nie przykrywamy szczelnie. Zbyt szybkie gotowanie rozprasza tłuszcz, rozbija białko i odbiera przejrzystość. My dajemy rosołowi czas, a sól dodajemy pod koniec, kiedy płyn już częściowo odparował.
...
### Czy my przykrywamy garnek?

My zostawiamy niewielką szczelinę. Dzięki temu łatwiej kontrolujemy temperaturę i redukcję.

### Czy my solimy od początku?

Nie. My solimy ostrożnie pod koniec, bo wywar zmienia objętość podczas gotowania.

### Czy my możemy zamrozić rosół?

Tak, bez makaronu. My chłodzimy go szybko i mrozimy w porcjach.
...
${dopracujPrzewodnik("Rosół")}`;

export const bodyZakwasZurekPl = `Zakwas na żurek jest prosty, ale nie jest produktem „bez zasad”. Mąka żytnia, woda, czosnek i czas tworzą kwaśną bazę, którą trzeba prowadzić czysto i spokojnie. Dla nas w Niemczech to wygodna alternatywa, gdy gotowy zakwas ze sklepu polskiego nie jest pod ręką.
...
Możemy, ale my najpierw go mieszamy i wlewamy etapami, aby łatwiej kontrolować smak.
${dopracujPrzewodnik("Zakwas na żurek")}`;

export const bodyBigosGuidePl = `Bigos jest jednym z najbardziej wdzięcznych dań do życia w Niemczech: dojrzewa w lodówce, dobrze znosi mrożenie i nie wymaga gotowania na pokaz. Potrzebuje jednak kapusty o dobrym smaku, czasu i rozsądku z tłuszczem.

## Kapusta prowadzi garnek

My próbujemy kapusty kiszonej przed gotowaniem. Jeśli jest bardzo kwaśna albo słona, krótko ją płuczemy, ale nie wypłukujemy całego charakteru. Świeżą kapustę dodajemy dla łagodności, a suszone grzyby dla głębi. Dobra kiełbasa ze [sklepu polskiego](/pl/blog/sklep-polski-zakupy) może podnieść całość bardziej niż kolejne trzy przyprawy.

## Mięso i czas

Mięso podsmażamy partiami, żeby się rumieniło, a nie gotowało we własnej wodzie. Potem łączymy je z kapustą i dusimy spokojnie. Wino, śliwki czy koncentrat to wybory domu, nie obowiązek. My nie próbujemy uzyskać „bigosu na trzeci dzień” w trzy godziny: po schłodzeniu i ponownym podgrzaniu smaki naprawdę lepiej się łączą.

## Korekta smaku

Na końcu oceniamy kwas, słodycz, sól i dymność. Jeśli bigos jest płaski, nie dosypujemy od razu soli — czasem potrzebuje pieprzu, grzybowego płynu lub odrobiny kwasu. Jeśli jest ciężki, podajemy go z prostym chlebem i kwaśnym dodatkiem, nie z kolejną porcją tłuszczu.

## FAQ — bigos

### Czy my możemy użyć tylko kapusty kiszonej?

Możemy. My czasem dodajemy świeżą dla równowagi, ale nie jest to reguła.

### Czy my zamrażamy bigos?

Tak. My dzielimy go na porcje, bo po rozmrożeniu łatwiej podgrzać tylko tyle, ile potrzeba.

### Czy my gotujemy bigos bez mięsa?

Oczywiście. My budujemy wtedy głębię grzybami, śliwką i dobrze podsmażoną cebulą.
${dopracujPrzewodnik("Bigos")}`;

export const bodySmietanaSchmandPl = `Śmietana, Schmand, Crème fraîche i Quark wyglądają podobnie tylko z daleka. W polskiej kuchni ich zadanie jest konkretne: złagodzić zupę, związać sos albo dodać świeżości do pierogów — nie przykryć całe danie.
...
Nie. To produkty o innym zadaniu i strukturze.
${dopracujPrzewodnik("Śmietana, Schmand i niemiecki nabiał")}`;

export const bodyKielbasaArtenPl = `Kiełbasa w polskiej kuchni nie jest jedną kategorią. Biała pracuje inaczej niż wędzona, cienka inaczej niż krakowska, a produkt do kanapki nie zawsze nadaje się do długiego duszenia.
...
Tak, w małych porcjach i szybko po zakupie, jeśli nie wykorzystamy jej w najbliższych dniach.
${dopracujPrzewodnik("Kiełbasa w polskiej kuchni")}`;

export const bodyErsatzproduktePl = `Zamienniki w Niemczech nie są porażką tradycji. Są częścią rozsądnego gotowania, gdy sklep polski jest daleko, produkt zniknął z półki albo chcemy ugotować obiad dziś, a nie po dwugodzinnej wyprawie.
...
Tak. My wolimy jeden dobry żurek i spokojną rozmowę niż zmęczony stół pełen półproduktów.
${dopracujPrzewodnik("Wielkanoc")}`;

export const bodyTlustyCzwartekPl = `Tłusty czwartek w Niemczech może być małym rytuałem po pracy, nie projektem cukierniczym na cały dzień. Pączki kupione w polskiej cukierni są w porządku, a domowe mają sens wtedy, gdy mamy czas na wyrastanie, smażenie i sprzątanie.

## Wybierz wersję dnia

My decydujemy wcześniej: kupujemy kilka dobrych pączków, robimy faworki albo smażymy małą partię domową. Niemiecki „Berliner” bywa miły, ale ma inną strukturę i nadzienie; nie musi udawać polskiego pączka. Jeśli pieczemy, dbamy o świeże drożdże, temperaturę mleka i odpoczynek ciasta. Ilości i kroki: [przepis na pączki](/pl/rezepte/paczki). Gesty drożdży, nadzienia i tłuszczu: [technika pączków](/pl/blog/paczki-technika) — ten artykuł zostaje okazją i kulturą, nie ownerem gotowania.

## Smażenie spokojnie

Tłuszcz ogrzewamy stabilnie, nie na maksymalnej mocy. Zbyt chłodny da ciężkie, nasiąknięte sztuki, a zbyt gorący spali skórkę przed upieczeniem środka. My smażymy po kilka pączków, odsączamy je na papierze i nie zostawiamy garnka bez nadzoru. Dzieci trzymamy z dala od strefy gorącego tłuszczu. Szczegóły techniki bez kradzieży primary przepisu: [technika pączków](/pl/blog/paczki-technika).
...
${dopracujPrzewodnik("Tłusty czwartek")}`;

export const bodySonntagsessenPl = `Niedzielny obiad nie musi zaczynać się o siódmej rano, żeby był „prawdziwy”. Dla polskich rodzin w Niemczech najlepszy jest taki rytm, który zostawia czas na odpoczynek, spacer i wspólne siedzenie przy stole.
...
Obok schabowego warto spokojne mięso: [golonka](/pl/rezepte/golonka) duszona na kości (jasno ≠ panierka, ≠ żeberka, ≠ schab z pieca), [żeberka pieczone](/pl/rezepte/zeberka) z piekarnika (majeranek, musztarda), [schab pieczony](/pl/rezepte/schab-pieczony) jako pieczeń z pieca (bez panierki — jasno ≠ kotlet schabowy) albo [rolada śląska](/pl/rezepte/rolada-slaska) duszona — wyraźnie osobno od [zrazów](/pl/rezepte/zrazy) (inna logika farszu). To nie gulasz w garnku; owner kultury niedzieli zostaje tu, cook-primary na URL przepisów. Na szybszy garnek paprykowo-pomidorowy z kiełbasą (warzywa prowadzą, jasno ≠ gulasz wieprzowy) zobacz cook [leczo](/pl/rezepte/leczo) — primary zostaje tam. Composed talerz niedzielny: placki **z** gulaszem na wierzchu — [placek po węgiersku](/pl/rezepte/placek-po-wegiersku); primary tam, osobne URL placków i gulaszu zostają ownerami.

Szybka bagietka z pieczarkami i serem: [zapiekanka](/pl/rezepte/zapiekanka) — cook-primary tam; ten guide zostaje ownerem kultury.
...
Tak. My zapraszamy ludzi do stołu, nie do katalogu wnętrz.
${dopracujPrzewodnik("Niedzielny obiad")}`;

export const bodyKiszeniePl = `Kiszenie to nie trend, lecz praktyczna technika, która świetnie działa w niemieckim mieszkaniu, jeśli zachowamy czystość i proporcje. Daje nam kapustę, ogórki i dodatki o wyraźnym smaku bez ciągłych zakupów.
...
${dopracujPrzewodnik("Kiszenie")}`;

export const bodyFleischwolfPl = `Maszynka do mięsa ma sens, gdy regularnie robimy własny farsz do pierogów, kotlety albo mielimy mięso po rosole. Nie jest konieczna w każdym domu, ale dobra potrafi dać kontrolę nad strukturą i składem.
...
${dopracujZakup("Maszynka do mięsa")}`;

export const bodyDutchOvenPl = `Garnek typu Dutch oven jest przydatny nie dlatego, że wygląda dobrze na zdjęciu, lecz dlatego, że równo trzyma temperaturę. Dla [bigosu](/pl/rezepte/bigos), gulaszu, pieczeni i chleba może zastąpić kilka lżejszych garnków.
...
${dopracujZakup("Garnek Dutch oven")}`;

export const bodyGusseisenPl = `Żeliwo odwdzięcza się za regularność, nie za perfekcję. Dobra patelnia lub garnek potrafi służyć latami, jeśli wiemy, kiedy użyć tłuszczu, jak ją suszyć i czego nie robić po kwaśnym gotowaniu.
...
${dopracujZakup("Upgrade robota do ciasta")}`;
