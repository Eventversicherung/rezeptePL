...
export const W14_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-wuzetka": {
    ...
    originDe:
      "Wuzetka ist das Rezept für die klassische polnische Schoko-Sahne-Torte — hier als eine klare Hauslinie: Kakao-Biskuit, dicke geschlagene Sahne dazwischen, dunkle Schoko-Glasur oben. Der Schnitt zeigt dunkle Biskuitschichten und eine helle Sahnefüllung, oft als Rechteck vom Blech. Das ist weder Blätterteig mit Vanillecreme wie [Napoleonka](/de/rezepte/napoleonka) noch Quarkkuchen [Sernik](/de/rezepte/sernik) noch Apfelkuchen [Szarlotka](/de/rezepte/szarlotka) und auch kein flacher Osterbelag [Mazurek](/de/rezepte/mazurek). Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der Kaffee-Schluss sein — Hier bleiben Mengen und Schritte. In der Diaspora oft der Bäckerei-Klassiker, den man zu Hause nachbaut, wenn Kühlschrank und Ruhezeit zum Kühlen da sind.",
    originPl:
      "Wuzetka to przepis na klasyczny polski tort czekoladowo-śmietankowy — tu jedna linia domowa: biszkopt kakaowy, gęsta ubita śmietana w środku, ciemna polewa na wierzchu. Przekrój pokazuje ciemne warstwy biszkoptu i jasną śmietanę, często prostokąt z blachy. To ani ciasto francuskie z kremem waniliowym jak [napoleonka](/pl/rezepte/napoleonka), ani [sernik](/pl/rezepte/sernik), ani [szarlotka](/pl/rezepte/szarlotka), ani płaski [mazurek](/pl/rezepte/mazurek). Przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) bywa domknięciem przy kawie — Tu zostają ilości i kroki. W diasporze często klasyk cukierniczy, który w domu odtwarza się, gdy jest lodówka i czas na chłodzenie.",
    shopDe:
      "Kakao, Mehl, Eier, Zucker, Schlagsahne, dunkle Schokolade/Kuvertüre, Butter — Basis im Supermarkt; gutes Kakao und manchmal bessere Kuvertüre im [Polenladen](/de/blog/polenladen-einkaufen). Fehlt Sahne-Qualität oder Kakao: ehrlich laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de), ohne in Blätterteig-Charakter zu kippen. Kein Fertig-Blätterteig als Basis — sonst wird daraus [Napoleonka](/de/rezepte/napoleonka). Kein Quark und kein Apfelkern — sonst [Sernik](/de/rezepte/sernik) bzw. [Szarlotka](/de/rezepte/szarlotka).",
    shopPl:
      "Kakao, mąka, jajka, cukier, śmietanka, gorzka czekolada/couverture, masło — baza w markecie; dobre kakao i czasem lepsza couverture w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Brak jakości śmietanki lub kakao: uczciwie według [zamienników](/pl/blog/zamienniki-skladnikow), bez dryfu w francuskie. Bez gotowego ciasta francuskiego jako bazy — inaczej dryfuje w stronę [napoleonkę](/pl/rezepte/napoleonka). Bez twarogu i bez jabłka — inaczej [sernik](/pl/rezepte/sernik) lub [szarlotka](/pl/rezepte/szarlotka).",
    techniqueDe:
    ...
    mistakesDe:
      "Mit [Napoleonka](/de/rezepte/napoleonka) verwechseln (Blätterteig). Mit [Sernik](/de/rezepte/sernik) oder [Szarlotka](/de/rezepte/szarlotka) verwechseln. Sahne zu weich; Biskuit heiß schichten; zu kurz kühlen. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein, dort Kultur.",
    mistakesPl:
      "Mylenie z [napoleonką](/pl/rezepte/napoleonka) (francuskie). Mylenie z [sernikiem](/pl/rezepte/sernik) lub [szarlotką](/pl/rezepte/szarlotka). Za miękka śmietana; gorący biszkopt; za krótkie chłodzenie. Nie mieszać ilości i kroków z sąsiednim przepisem. nie.",
    variantsDe:
  ...
  "recipe-drozdzowka": {
    ...
    servePl:
      "W prostokątach, ciepłe lub letnie, do kawy. Miejsce w menu: [obiad niedzielny](/pl/blog/obiad-niedzielny). Warkocz: [chałka](/pl/rezepte/chalka); forma: [babka](/pl/rezepte/babka); smażone: [pączki](/pl/rezepte/paczki); patelnia: [racuchy](/pl/rezepte/racuchy-jablka). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności. Resztki szczelnie — tosty lub krótkie podgrzanie.",
    diasporaDe:
    ...
    mistakesDe:
      "Mit [Chałka](/de/rezepte/chalka) verwechseln (Zopf). Mit [Babka](/de/rezepte/babka) verwechseln (Form). Mit [Pączki](/de/rezepte/paczki) oder [Racuchy](/de/rezepte/racuchy-jablka) verwechseln. Zu heiße Milch; zu wenig Gehen; zu dünner Streusel. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein.",
    mistakesPl:
      "Mylenie z [chałką](/pl/rezepte/chalka) (warkocz). Mylenie z [babką](/pl/rezepte/babka) (forma). Mylenie z [pączkami](/pl/rezepte/paczki) lub [racuchami](/pl/rezepte/racuchy-jablka). Za gorące mleko; za krótkie wyrastanie; za cienka kruszonka. Nie mieszać ilości i kroków z sąsiednim przepisem. nie.",
    variantsDe:
