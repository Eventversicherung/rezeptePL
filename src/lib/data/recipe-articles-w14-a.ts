...
export const W14_FACTS_A: Record<string, ArticleFacts> = {
 ...
 servePl:
 "W prostokątach, ciepłe lub letnie, do kawy. Miejsce w menu: [obiad niedzielny](/pl/blog/obiad-niedzielny). Warkocz: [chałka](/pl/rezepte/chalka); forma: [babka](/pl/rezepte/babka); smażone: [pączki](/pl/rezepte/paczki); patelnia: [racuchy](/pl/rezepte/racuchy-jablka). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności. Resztki szczelnie — tosty lub krótkie podgrza",
 diasporaDe:
