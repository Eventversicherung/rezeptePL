...
export const W14_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-wuzetka": {
    ...
    originDe:
      "Wuzetka ist das Rezept für die klassische polnische Schoko-Sahne-Torte — hier als eine klare Hauslinie: Kakao-Biskuit, dicke geschlagene Sahne dazwischen, dunkle Schoko-Glasur oben. Der Schnitt zeigt dunkle Biskuitschichten und eine helle Sahnefüllung, oft als Rechteck vom Blech. Das ist weder Blätterteig mit Vanillecreme wie [Napoleonka](/de/rezepte/napoleonka) noch Quarkkuchen [Sernik](/de/rezepte/sernik) noch Apfelkuchen [Szarlotka](/de/rezepte/szarlotka) und auch kein flacher Osterbelag [Mazurek](/de/rezepte/mazurek). Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der Kaffee-Schluss sein — Kulturrahmen bleibt bei der Guide, Rezept diese URL. In der Diaspora oft der Bäckerei-Klassiker, den man zu Hause nachbaut, wenn Kühlschrank und Ruhezeit zum Kühlen da sind.",
    originPl:
      "Wuzetka to przepis: klasyczny polski tort czekoladowo-śmietankowy — tu jedna linia domowa: biszkopt kakaowy, gęsta ubita śmietana w środku, ciemna polewa na wierzchu. Przekrój pokazuje ciemne warstwy biszkoptu i jasną śmietanę, często prostokąt z blachy. To ani ciasto francuskie z kremem waniliowym jak [napoleonka](/pl/rezepte/napoleonka), ani [sernik](/pl/rezepte/sernik), ani [szarlotka](/pl/rezepte/szarlotka), ani płaski [mazurek](/pl/rezepte/mazurek). Przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) bywa domknięciem przy kawie — przewodnik kulturowy zostaje przy guide, Rezept przy tej URL. W diasporze często klasyk cukierniczy, który w domu odtwarza się, gdy jest lodówka i czas na chłodzenie.",
    shopDe:
    ...
    serveDe:
      "Kalt in Rechtecken, oft mit Sahnetupfer, zu Kaffee oder Tee. Als Sonntagsschluss unter [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Abgrenzung auf dem Tisch: Blätterteig-Creme = [Napoleonka](/de/rezepte/napoleonka); Quark = [Sernik](/de/rezepte/sernik); Apfelblech = [Szarlotka](/de/rezepte/szarlotka). Einkaufskontext: [Polenladen](/de/blog/polenladen-einkaufen). Hält gekühlt zwei bis drei Tage; Glasur vor dem Servieren ggf. glätten.",
    servePl:
