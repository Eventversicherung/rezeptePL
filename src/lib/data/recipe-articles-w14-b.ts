...
export const W14_FACTS_B: Record<string, ArticleFacts> = {
  ...
  "recipe-cwikla": {
    ...
    originDe:
      "Ćwikła ist das Rezept für den kalten Relish aus geriebener Roter Bete und Meerrettich — typisch Ostern und Aufschnitt, bewusst keine warme Beilage und keine Suppe. [Buraczki](/de/rezepte/buraczki) bleiben die Leitartikel der warmen Rote-Bete-Beilage (oft mit Zwiebel, heiß neben Fleisch). [Barszcz czerwony](/de/rezepte/barszcz-czerwony) bleibt die klare oder cremige Bete-Suppe; [Botwinka](/de/rezepte/botwinka) die junge-Bete-Suppe. [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa) ist der Mayo-Festsalat — anderer Charakter. Am [Wielkanoc Speiseplan](/de/blog/wielkanoc-speiseplan) steht Ćwikła oft neben Ei, Wurst und Brot — der Speiseplan bleibt Menü-Artikel, hier nur Mengen und Schritte. In der Diaspora ist Ćwikła der Moment, in dem geriebene Bete und Meerrettich im Glas oder in der Schüssel den scharfen Kontrast zur milden Platte liefern: kochen oder fertig nehmen, reiben, würzen, kalt ziehen. Keine Pfanne mit warmer Beilage, keine Brühe, keine Mayo-Gemüsewürfel. Eng bei „Ćwikła / Rote Bete Meerrettich“ bleiben. Einkauf und Meerrettich-Qualität: [Polenladen](/de/blog/polenladen-einkaufen); DE-Ersatzlogik: [Ersatzprodukte DE](/de/blog/ersatzprodukte-de).",
    originPl:
      "Ćwikła to przepis na zimny dodatek z tartego buraka i chrzanu — typowo wielkanocny i na zimną półkę, świadomie nie ciepły dodatek i nie zupa. [Buraczki](/pl/rezepte/buraczki) zostają przepisem na ciepłego dodatku z buraków (często z cebulą, gorące obok mięsa). [Barszcz czerwony](/pl/rezepte/barszcz-czerwony) zostaje zupą buraczaną; [botwinka](/pl/rezepte/botwinka) zupą z młodych buraków. [Sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa) to majonezowa sałatka — inny charakter. Przy [menu wielkanocnym](/pl/blog/menu-wielkanocne) ćwikła bywa obok jaj, kiełbasy i chleba — plan menu zostaje artykułem o okazji, tu tylko ilości i kroki. W diasporze ćwikła to moment, gdy tarty burak i chrzan w słoiku lub misce dają ostry kontrast do łagodnej półki: ugotować lub wziąć gotowe, zetrzeć, doprawić, schłodzić. Bez patelni z ciepłym dodatkiem, bez bulionu, bez majonezowych kostek. Trzymać wąsko „ćwikła / burak chrzan”. W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz specjalności; zamienniki znajdziesz w [zamienniki składników](/pl/blog/zamienniki-skladnikow).",
    shopDe:
