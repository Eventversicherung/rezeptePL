...
export const W14_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-jajka-faszerowane": {
    ...
    originPl:
      "Jajka faszerowane to strona przepisu Rezept na faszerowane jajka na twardo — tu w jasnej linii domu: żółtko z majonezem i szczypiorkiem, na zimno na półmisku. Świadomie nie majonezowa sałatka warzywna i nie sałatka ogórkowa. [Sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa) zostaje przepisem na świątecznej sałatki z ugotowanych warzyw i majonezu; [mizeria](/pl/rezepte/mizeria) zostaje przepisem na ogórka ze śmietaną i koperkiem. [Pasztet](/pl/rezepte/pasztet) zostaje pastą na zimnej półce — sąsiad, nie to samo danie. Przy [menu wielkanocnym](/pl/blog/menu-wielkanocne) jajka faszerowane bywają obok kiełbasy i chrzanu — plan menu zostaje przepisem na okazji, tu tylko ilości i kroki. W diasporze to moment, gdy twarde jajka i szybka masa żółtkowo-majonezowa wypełniają półmisek bufetowy bez mieszania całego garnka sałatki: ugotować, przekroić, nadziać, schłodzić. Bez kostek ziemniaka, bez plasterków ogórka jako fokus, bez masy pasztetowej w białku. Trzymać wąsko „jajka faszerowane” — bez generycznego „deviled eggs” bez polskiej nazwy. Kultura niedzieli pod [obiadem niedzielnym](/pl/blog/obiad-niedzielny); zakupy i jakość majonezu w [sklepie polskim](/pl/blog/sklep-polski-zakupy).",
    shopDe:
  ...
  "recipe-cwikla": {
    ...
    originPl:
      "Ćwikła to strona przepisu Rezept na zimny dodatek z tartego buraka i chrzanu — typowo wielkanocny i na zimną półkę, świadomie nie ciepły dodatek i nie zupa. [Buraczki](/pl/rezepte/buraczki) zostają przepisem na ciepłego dodatku z buraków (często z cebulą, gorące obok mięsa). [Barszcz czerwony](/pl/rezepte/barszcz-czerwony) zostaje zupą buraczaną; [botwinka](/pl/rezepte/botwinka) zupą z młodych buraków. [Sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa) to majonezowa sałatka — inny intent. Przy [menu wielkanocnym](/pl/blog/menu-wielkanocne) ćwikła bywa obok jaj, kiełbasy i chleba — plan menu zostaje przepisem na okazji, tu tylko ilości i kroki. W diasporze ćwikła to moment, gdy tarty burak i chrzan w słoiku lub misce dają ostry kontrast do łagodnej półki: ugotować lub wziąć gotowe, zetrzeć, doprawić, schłodzić. Bez patelni z ciepłym dodatkiem, bez bulionu, bez majonezowych kostek. Trzymać wąsko „ćwikła / burak chrzan”. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy); zamienniki: [zamienniki składników](/pl/blog/zamienniki-skladnikow).",
    shopDe:
