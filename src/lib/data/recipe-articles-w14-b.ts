...
export const W14_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-jajka-faszerowane": {
    ...
    originDe:
      "Jajka faszerowane sind die Cook-Intent-Money-Page für gefüllte hartgekochte Eier — hier in einer klaren Hauslinie: Eigelb mit Mayo und Schnittlauch, kalt auf der Platte. Das ist bewusst kein Mayo-Gemüsesalat und kein Gurkensalat. [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa) bleibt Owner des Festsalats aus gekochtem Gemüse und Mayo; [Mizeria](/de/rezepte/mizeria) bleibt Owner der Gurke mit Śmietana und Dill. [Pasztet](/de/rezepte/pasztet) bleibt die Pastete auf dem Aufschnitt — Nachbar auf der kalten Platte, nicht dasselbe Gericht. Am [Wielkanoc Speiseplan](/de/blog/wielkanoc-speiseplan) stehen gefüllte Eier oft neben Wurst und Meerrettich — der Speiseplan bleibt Anlass-Owner, hier nur Mengen und Schritte. In der Diaspora sind Jajka faszerowane der Moment, in dem harte Eier und eine schnelle Eigelb-Mayo-Masse den Buffet-Teller füllen, ohne einen ganzen Salattopf zu rühren: kochen, halbieren, füllen, kühlen. Keine Kartoffelwürfel, keine Gurkenscheiben als Primary, keine Pastetenmasse im Eiweiß. Eng bei „Jajka faszerowane / gefüllte Eier polnisch“ bleiben — nicht generisches „Deviled Eggs SEO“ ohne polnischen Namen. Sonntagskultur descriptiv unter [Sonntagsessen](/de/blog/sonntagsessen-polnisch); Einkauf und Mayo-Qualität im [Polenladen](/de/blog/polenladen-einkaufen).",
    originPl:
      "Jajka faszerowane to money-page cook-intent na faszerowane jajka na twardo — tu w jasnej linii domu: żółtko z majonezem i szczypiorkiem, na zimno na półmisku. Świadomie nie majonezowa sałatka warzywna i nie sałatka ogórkowa. [Sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa) zostaje ownerem świątecznej sałatki z ugotowanych warzyw i majonezu; [mizeria](/pl/rezepte/mizeria) zostaje ownerem ogórka ze śmietaną i koperkiem. [Pasztet](/pl/rezepte/pasztet) zostaje pastą na zimnej półce — sąsiad, nie to samo danie. Przy [menu wielkanocnym](/pl/blog/menu-wielkanocne) jajka faszerowane bywają obok kiełbasy i chrzanu — plan menu zostaje ownerem okazji, tu tylko ilości i kroki. W diasporze to moment, gdy twarde jajka i szybka masa żółtkowo-majonezowa wypełniają półmisek bufetowy bez mieszania całego garnka sałatki: ugotować, przekroić, nadziać, schłodzić. Bez kostek ziemniaka, bez plasterków ogórka jako primary, bez masy pasztetowej w białku. Trzymać wąsko „jajka faszerowane” — bez generycznego SEO „deviled eggs” bez polskiej nazwy. Kultura niedzieli opisowo pod [obiadem niedzielnym](/pl/blog/obiad-niedzielny); zakupy i jakość majonezu w [sklepie polskim](/pl/blog/sklep-polski-zakupy).",
    shopDe:
  ...
  "recipe-cwikla": {
    ...
    originDe:
      "Ćwikła ist die Cook-Intent-Money-Page für den kalten Relish aus geriebener Roter Bete und Meerrettich — typisch Ostern und Aufschnitt, bewusst keine warme Beilage und keine Suppe. [Buraczki](/de/rezepte/buraczki) bleiben Owner der warmen Rote-Bete-Beilage (oft mit Zwiebel, heiß neben Fleisch). [Barszcz czerwony](/de/rezepte/barszcz-czerwony) bleibt die klare oder cremige Bete-Suppe; [Botwinka](/de/rezepte/botwinka) die junge-Bete-Suppe. [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa) ist der Mayo-Festsalat — anderer Intent. Am [Wielkanoc Speiseplan](/de/blog/wielkanoc-speiseplan) steht Ćwikła oft neben Ei, Wurst und Brot — der Speiseplan bleibt Anlass-Owner, hier nur Mengen und Schritte. In der Diaspora ist Ćwikła der Moment, in dem geriebene Bete und Meerrettich im Glas oder in der Schüssel den scharfen Kontrast zur milden Platte liefern: kochen oder fertig nehmen, reiben, würzen, kalt ziehen. Keine Pfanne mit warmer Beilage, keine Brühe, keine Mayo-Gemüsewürfel. Eng bei „Ćwikła / Rote Bete Meerrettich“ bleiben. Einkauf und Meerrettich-Qualität: [Polenladen](/de/blog/polenladen-einkaufen); DE-Ersatzlogik: [Ersatzprodukte DE](/de/blog/ersatzprodukte-de).",
    originPl:
      "Ćwikła to money-page cook-intent na zimny dodatek z tartego buraka i chrzanu — typowo wielkanocny i na zimną półkę, świadomie nie ciepły dodatek i nie zupa. [Buraczki](/pl/rezepte/buraczki) zostają ownerem ciepłego dodatku z buraków (często z cebulą, gorące obok mięsa). [Barszcz czerwony](/pl/rezepte/barszcz-czerwony) zostaje zupą buraczaną; [botwinka](/pl/rezepte/botwinka) zupą z młodych buraków. [Sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa) to majonezowa sałatka — inny intent. Przy [menu wielkanocnym](/pl/blog/menu-wielkanocne) ćwikła bywa obok jaj, kiełbasy i chleba — plan menu zostaje ownerem okazji, tu tylko ilości i kroki. W diasporze ćwikła to moment, gdy tarty burak i chrzan w słoiku lub misce dają ostry kontrast do łagodnej półki: ugotować lub wziąć gotowe, zetrzeć, doprawić, schłodzić. Bez patelni z ciepłym dodatkiem, bez bulionu, bez majonezowych kostek. Trzymać wąsko „ćwikła / burak chrzan”. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy); zamienniki: [zamienniki składników](/pl/blog/zamienniki-skladnikow).",
    shopDe:
      "Rote Bete (roh zum Kochen oder vakuumiert gekocht), geriebener Meerrettich (frisch oder Glas), Essig oder Zitrone, Zucker, Salz. Bete und oft besserer Meerrettich im [Polenladen](/de/blog/polenladen-einkaufen); Basis im Supermarkt. Wenn frischer Meerrettich fehlt: Glasware ehrlich laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de) — Schärfe nach Geschmack nachziehen. Keine warme Zwiebel-Pfanne als Primary: das wäre [Buraczki](/de/rezepte/buraczki). Kein Fond und keine junge Bete als Suppe: [Barszcz](/de/rezepte/barszcz-czerwony), [Botwinka](/de/rezepte/botwinka). Kein Mayo-Salat: [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa).",
    shopPl:
      "Buraki (surowe lub gotowane), starty chrzan (świeży lub ze słoika), ocet lub cytryna, cukier, sól. Buraki i często lepszy chrzan w [sklepie polskim](/pl/blog/sklep-polski-zakupy); baza w markecie. Gdy brak świeżego chrzanu: słoik uczciwie według [zamienników składników](/pl/blog/zamienniki-skladnikow) — ostrość według smaku. Bez ciepłej patelni z cebulą jako primary: to byłyby [buraczki](/pl/rezepte/buraczki). Bez wywaru i młodych buraków jako zupy: [barszcz](/pl/rezepte/barszcz-czerwony), [botwinka](/pl/rezepte/botwinka). Bez sałatki majonezowej: [sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa).",
    techniqueDe:
    ...
    techniquePl:
      "Buraki ugotować lub wziąć gotowe; obrać; zetrzeć — grubo/średnio, nie na pulpę. Wmieszać chrzan; octem/cytryną, cukrem i solą dojść do ostro-słodko-kwaśnego. Za dużo płynu = wodnisty relish; za mało kwasu = płasko. Chłodzić co najmniej godzinę–dwie, lepiej na noc — ostrość się układa. Świeżego chrzanu nie „wygotowywać”: ćwikła zostaje zimna. Rękawiczki przeciw plamom opcjonalnie. Trzymać jeden wariant domu: tarty burak + chrzan + ocet/cukier (bez ciepłego dodatku z cebulą i masłem jako primary).",
    serveDe:
      "Kalt in Schüssel oder Glas, zu [Biała kiełbasa](/de/rezepte/biala-kielbasa), [Pasztet](/de/rezepte/pasztet), Ei und Brot. Ostern descriptiv unter [Wielkanoc](/de/blog/wielkanoc-speiseplan). Abgrenzung: warm = [Buraczki](/de/rezepte/buraczki); Suppe = [Barszcz](/de/rezepte/barszcz-czerwony) / [Botwinka](/de/rezepte/botwinka); Mayo-Salat = [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa). Hält mehrere Tage gekühlt; vor dem Servieren umrühren und Schärfe prüfen.",
    servePl:
      "Na zimno w misce lub słoiku, do [białej kiełbasy](/pl/rezepte/biala-kielbasa), [pasztetu](/pl/rezepte/pasztet), jaj i chleba. Wielkanoc opisowo pod [menu wielkanocnym](/pl/blog/menu-wielkanocne). Na stole: ciepło = [buraczki](/pl/rezepte/buraczki); zupa = [barszcz](/pl/rezepte/barszcz-czerwony) / [botwinka](/pl/rezepte/botwinka); sałatka majonezowa = [sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa). Trzyma kilka dni w chłodzie; przed podaniem wymieszać i sprawdzić ostrość.",
    diasporaDe:
      "Ćwikła rettet in DE oft den scharfen Ostern-Kontrast, wenn Buraczki als warme Beilage schon am Sonntag stehen: ein Glas Relish, kalt, neben Wurst und Ei. Vakuum-Bete und Glas-Meerrettich sind diaspora-ehrlich. Kein Zwang zu frischem Reiben, wenn die Qualität stimmt — ehrlich benennen. Einkauf: [Polenladen](/de/blog/polenladen-einkaufen). Ersatz: [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Menü-Nachbar: [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    diasporaPl:
      "Ćwikła w DE często ratuje ostry kontrast wielkanocny, gdy buraczki jako ciepły dodatek już stoją w niedzielę: jeden słoik relishu, zimny, obok kiełbasy i jaj. Buraki próżniowe i chrzan ze słoika są uczciwe w diasporze. Bez przymusu świeżego tarcia, gdy jakość jest dobra — nazwać uczciwie. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy). Zamienniki: [zamienniki składników](/pl/blog/zamienniki-skladnikow). Sąsiad menu: [menu wielkanocne](/pl/blog/menu-wielkanocne).",
    mistakesDe:
    ...
    variantsDe:
      "Scharfer mit mehr Meerrettich; milder mit weniger und etwas mehr Zucker; mit Apfel gerieben als Hausvariante ehrlich benennen. Warm bleibt [Buraczki](/de/rezepte/buraczki). Suppen: [Barszcz](/de/rezepte/barszcz-czerwony), [Botwinka](/de/rezepte/botwinka). Festsalat: [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa). Teller-Nachbarn: [Biała kiełbasa](/de/rezepte/biala-kielbasa), [Pasztet](/de/rezepte/pasztet). Anlass: [Wielkanoc](/de/blog/wielkanoc-speiseplan). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    variantsPl:
      "Ostrzej z większą ilością chrzanu; łagodniej z mniejszą i odrobiną cukru; z tartym jabłkiem jako wariant domu — uczciwie nazwać. Ciepło: [buraczki](/pl/rezepte/buraczki). Zupy: [barszcz](/pl/rezepte/barszcz-czerwony), [botwinka](/pl/rezepte/botwinka). Sałatka: [sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa). Sąsiedzi: [biała kiełbasa](/pl/rezepte/biala-kielbasa), [pasztet](/pl/rezepte/pasztet). Okazja: [menu wielkanocne](/pl/blog/menu-wielkanocne). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow).",
  },
};
