...
export const W10_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-piernik": {
    ...
    mistakesDe:
      "Honig kochen bis bitter; zu heißer Ofen; Makowiec- oder Babka-Hitze, Feuchtigkeit oder Garzeit falsch einschätzen. zu früh schneiden; Gewürze alt und flach; Glasur auf heißem Kuchen. Speiseplan-Mengen hier duplizieren statt zu verlinken.",
    mistakesPl:
      "Gotowanie miodu do goryczy; zbyt gorący piec; kradzież fokus makowca lub babki (drożdże/mak w tytule); zbyt wczesne krojenie; stare, płaskie przyprawy; lukier na gorące. Duplikować menu zamiast linkować.",
    variantsDe:
  ...
  "recipe-zupa-pomidorowa": {
    ...
    originDe:
      "Zupa pomidorowa ist die polnische Tomatensuppe — typisch mit Reis oder kleinen Nudeln und einem Schuss Śmietana — und bewusst kein Festtags-[Barszcz](/de/rezepte/barszcz-czerwony), keine Kiszone-[Ogórkowa](/de/rezepte/ogorkowa) und kein klarer [Rosół](/de/rezepte/rosol) als Hauptgericht hier. Rosół liefert oft die Brühe-Basis; die Rezeptseite hier bleibt der Tomaten-Teller. Im Überblick [Polnische Suppen](/de/blog/polnische-suppen) gehört Pomidorowa zur Alltagslinie neben Rosół-Resten — der Pillar bleibt Überblicksseite, hier nur Rezept „Zupa pomidorowa“. Titel und Text bleiben beim konkreten Gericht. Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie leichter Starter sein; am Werktag oft der ganze Mittagsteller.",
    originPl:
      "Zupa pomidorowa to polska zupa z pomidorów — typowo z ryżem lub drobnym makaronem i śmietaną — świadomie nie świąteczny [barszcz](/pl/rezepte/barszcz-czerwony), nie kiszona [ogórkowa](/pl/rezepte/ogorkowa) i nie klarowny [rosół](/pl/rezepte/rosol) jako fokus. Rosół często daje bazę wywaru; Rezeptseite tu zostaje talerzem pomidorowym. W przeglądzie [polskie zupy](/pl/blog/polskie-zupy) należy do linii codziennej obok resztek rosołu — filar zostaje Überblicksseiteem, tu tylko Rezept „zupa pomidorowa”. Tytuł i tekst zostają przy konkretnym daniu. Przy [obiedzie niedzielnym](/pl/blog/obiad-niedzielny) bywa lekkim starterem; w tygodniu często całym obiadem.",
    shopDe:
    ...
    serveDe:
      "Heiß mit Dill oder Petersilie, oft mit extra Śmietana am Tisch. Als leichter Hauptgang oder Vorsuppe vor Fleisch — Menükultur unter [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Abgrenzung auf dem Tisch: klarer [Barszcz](/de/rezepte/barszcz-czerwony) zu Wigilia/Uszka; saure [Ogórkowa](/de/rezepte/ogorkowa) mit Kiszone; klare [Rosół](/de/rezepte/rosol)-Schale ohne Tomate. Reste gut gekühlt; beim Aufwärmen Śmietana nicht erneut hart kochen.",
    servePl:
    ...
    mistakesPl:
      "Mylenie z barszczem; kradzież intentu ogórkowej; śmietana do wrzątku; generyczne „najlepsza zupa pomidorowa”; rozgotowany ryż; kradzież fokus przeglądu polskie-zupy. Za mało doprawienia kwasu pomidorów.",
    variantsDe:
