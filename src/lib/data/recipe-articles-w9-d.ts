...
export const W9_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-kaszanka": {
    ...
    serveDe:
      "Klassisch mit Zwiebel und Brot oder Kartoffeln. Warme Beilage: [Kapusta zasmażana](/de/rezepte/kapusta-zasmażana). Als deftiger Teller im Rahmen des [polnischen Sonntagsessens](/de/blog/sonntagsessen-polnisch) — Kulturrahmen bleibt bei dort, hier nur das Gericht. Wer eher Schmor-Kohl mit Fleischlagen will: [Bigos](/de/rezepte/bigos) ist der Nachbar, nicht dieselbe Seite.",
    servePl:
      "Klasycznie z cebulą i chlebem lub ziemniakami. Ciepły dodatek: [kapusta zasmażana](/pl/rezepte/kapusta-zasmażana). Jako treściwy talerz w ramach [obiadu niedzielnego](/pl/blog/obiad-niedzielny) — przewodnik kulturowy zostaje tam, tu tylko danie. Kto chce duszoną kapustę z mięsem warstwami: [bigos](/pl/rezepte/bigos) jest sąsiadem, nie tą stroną.",
    diasporaDe:
