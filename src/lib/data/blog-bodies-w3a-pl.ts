/**
 * Batch W3a PL blog bodies (from content/batch-w3a).
 */
...
![Wędzony ser na desce](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-oscypek/3b3f26ff-eab8-45b5-92f8-3fa0adbc758b.webp "Formę i dym sprawdzamy. Etykieta sama nie zastępuje próby.")
...
1. Pokrój oscypek w plastry ok. 1 do 1,5 cm, zbyt cienko = szybkie rozpływanie; zbyt grubo = zimny środek przy spalonej skórce.
...
4. Smaż 2 do 4 minuty z każdej strony, aż powierzchnia będzie złocista, a środek lekko miękki.
...
![Oscypek na patelni, złocisty](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-cwikla/6ae28221-2f69-4a14-bf3f-8e83eac61d4c.webp "Dodatek trzymamy jasno: ćwikła albo ogórek, nie oba jako obowiązek.")
