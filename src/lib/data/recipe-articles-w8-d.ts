...
export const W8_FACTS_D: Record<string, ArticleFacts> = {
 ...
 shopDe:
 "Nimm mehlig kochende Kartoffeln, Mehl und Ei für den Teig sowie Pflaumen (frisch oder gut abgetropft aus dem Glas), Butter, Semmelbrösel, Zucker und Zimt. Saisonware im Supermarkt; Glasware und gute Brösel oft im [Polenladen](/de/blog/polenladen-einkaufen). Das sind keine [Pierogi](/de/rezepte/pierogi/ruskie) und keine [Leniwe](/de/rezepte/pierogi-leniwe) — hier umschließt Kartoffelteig die ganze Frucht.",
 shopPl:
 "Weź ziemniaki mączyste, mąkę i jajko na ciasto oraz śliwki (świeże lub dobrze odsączone ze słoika), masło, bułkę tartą, cukier i cynamon. Sezon w markecie; słoiki i dobra bułka często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). To nie [pierogi](/pl/rezepte/pierogi/ruskie) i nie [leniwe](/pl/rezepte/pierogi-leniwe) — tu ciasto ziemniaczane otula cały owoc.",
 techniqueDe:
