...
export const W10_FACTS_C: Record<string, W10ArticleFacts> = {
  ...
  "recipe-nalesniki-dzem": {
    ...
    originDe:
      "Naleśniki z dżemem sind dünne polnische Pfannkuchen mit Marmeladen- oder Powidła-Füllung — eigene Variante unter `/rezepte/nalesniki/dzem`, nicht die Quark-Variante unter [Naleśniki mit Twaróg](/de/rezepte/nalesniki/twarog). Technik erklärt der [Naleśniki-Guide](/de/blog/nalesniki-guide). Geschwister im Switcher: [Fleisch](/de/rezepte/nalesniki/fleisch) und [Spinat](/de/rezepte/nalesniki/szpinak). Zum Quark-Einkauf siehe den [Twaróg-Guide](/de/blog/twarog-deutschland); hier geht es um Dżem und Powidła.",
    originPl:
    ...
    shopDe:
      "Milch, Mehl, Eier, Butter; dicker Dżem oder Powidła (Polenladen oft besser), Puderzucker. Wenn Powidła fehlen: [Ersatzprodukte in DE](/de/blog/ersatzprodukte-de). Teig und Wenden: [Naleśniki-Guide](/de/blog/nalesniki-guide). Quark-Mengen gehören zur [Twaróg-Variante](/de/rezepte/nalesniki/twarog). Süßes Fettgebäck-Feeling: [Tłusty Czwartek](/de/blog/tlusty-czwartek).",
    shopPl:
