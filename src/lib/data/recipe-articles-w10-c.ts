...
export const W10_FACTS_C: Record<string, W10ArticleFacts> = {
 ...
 shopDe:
 "Für Teig und Füllung brauchst du Mehl (405 oder 550), Ei, Wasser und Öl sowie Heidelbeeren (frisch oder TK, gut abgetropft), Zucker, Speisestärke und Butter. Beeren findest du oft im Supermarkt; Teiggefühl erklärt der [Pierogi-Teig](/de/blog/pierogi-teig)-Guide. Ruskie bleiben bei [Pierogi ruskie](/de/rezepte/pierogi/ruskie); runde Obst-Knödel bei [Knedle](/de/rezepte/knedle-sliwki).",
 shopPl:
 "Na ciasto i farsz potrzebujesz mąki (405 lub 550), jajka, wody i oleju oraz jagód (świeżych lub mrożonych, dobrze odsączonych), cukru, skrobi i masła. Jagody często są w markecie; wyczucie ciasta daje [ciasto na pierogi](/pl/blog/ciasto-na-pierogi). Ruskie zostają przy [pierogach ruskich](/pl/rezepte/pierogi/ruskie); okrągłe knedle przy [knedlach](/pl/rezepte/knedle-sliwki).",
 techniqueDe:
