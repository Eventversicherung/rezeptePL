...
export const W9_FACTS_A: Record<string, W9ArticleFacts> = {
 ...
 shopDe:
 "Dünne Fleischscheiben zum Rollen (Rind oder Schwein), Speck, Zwiebel, Senf, Brühe, Lorbeer, sparsam [Majeranek](/de/blog/majeranek). Topf mit Deckel — Kaufkriterien im [Dutch-Oven-Guide](/de/blog/dutch-oven-kaufberatung). Beilage-Kartoffeln oder Stärke für Kluski separat einkaufen.",
 shopPl:
