...
export const W15_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-kaczka": {
    ...
    originDe:
      "Kaczka pieczona ist das Rezept für die klassische polnische Ofenente — hier als eine klare Hauslinie: ganze Ente mit Apfelvierteln in der Bauchhöhle, Majeranek, Salz und Pfeffer, langsam im Ofen bis die Haut knusprig und das Fleisch saftig ist. Das ist weder Ofenschweinebraten [Schab pieczony](/de/rezepte/schab-pieczony) noch geschmorte Haxe [Golonka](/de/rezepte/golonka) noch Ofenrippen [Żeberka pieczone](/de/rezepte/zeberka). Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der Festbraten sein — Hier bleiben Mengen und Schritte. Zum Gewürz hilft [Majeranek](/de/blog/majeranek). In der Diaspora oft der Sonntags- oder Feiertagsvogel, den man rare genug macht, um ihn richtig zu feiern.",
    originPl:
