...
export const W15_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-kaczka": {
    ...
    originDe:
      "Kaczka pieczona ist der Rezept für die klassische polnische Ofenente — hier als eine klare Hauslinie: ganze Ente mit Apfelvierteln in der Bauchhöhle, Majeranek, Salz und Pfeffer, langsam im Ofen bis die Haut knusprig und das Fleisch saftig ist. Das ist weder Ofenschweinebraten [Schab pieczony](/de/rezepte/schab-pieczony) noch geschmorte Haxe [Golonka](/de/rezepte/golonka) noch Ofenrippen [Żeberka pieczone](/de/rezepte/zeberka). Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der Festbraten sein — Kulturrahmen bleibt bei der Guide, Rezept diese URL. Gewürz-Nachbar descriptiv: [Majeranek](/de/blog/majeranek). In der Diaspora oft der Sonntags- oder Feiertagsvogel, den man rare genug macht, um ihn richtig zu feiern.",
    originPl:
      "Kaczka pieczona to przepis: klasyczna polska kaczka z pieca — tu jedna linia domowa: cała kaczka z jabłkiem w brzuchu, majeranek, sól i pieprz, wolno w piecu aż skóra chrupiąca, a mięso soczyste. To ani pieczeń wieprzowa [schab pieczony](/pl/rezepte/schab-pieczony), ani duszona [golonka](/pl/rezepte/golonka), ani [żeberka pieczone](/pl/rezepte/zeberka). Przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) bywa pieczeniem świątecznym — przewodnik kulturowy zostaje przy guide, Rezept przy tej URL. Przyprawa opisowo: [majeranek](/pl/blog/majeranek-leksykon). W diasporze często ptak niedzielny lub świąteczny, którego robi się rzadko i z szacunkiem.",
    shopDe:
    ...
    mistakesDe:
      "Mit [Schab pieczony](/de/rezepte/schab-pieczony) verwechseln. Mit [Golonka](/de/rezepte/golonka) oder [Żeberka](/de/rezepte/zeberka) verwechseln. Nasse Haut; zu heiß austrocknen; keine Ruhezeit. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein, dort Kultur. Majoran-Lexikon bleibt [Majeranek](/de/blog/majeranek).",
    mistakesPl:
  ...
  "recipe-pieczen-rzymska": {
    ...
    mistakesDe:
      "Mit [Kotlet mielony](/de/rezepte/kotlet-mielony) verwechseln (Pfanne). Mit [Pasztet](/de/rezepte/pasztet) verwechseln. Zu nasse Masse; Eier nicht mittig; zu kurz backen. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein. Panade-Fokus bleibt beim [Panieren-Guide](/de/blog/panieren-schabowy).",
    mistakesPl:
