...
export const W15_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-kaczka": {
    ...
    originDe:
      "Kaczka pieczona ist der Cook-Intent für die klassische polnische Ofenente — hier als eine klare Hauslinie: ganze Ente mit Apfelvierteln in der Bauchhöhle, Majeranek, Salz und Pfeffer, langsam im Ofen bis die Haut knusprig und das Fleisch saftig ist. Das ist weder Ofenschweinebraten [Schab pieczony](/de/rezepte/schab-pieczony) noch geschmorte Haxe [Golonka](/de/rezepte/golonka) noch Ofenrippen [Żeberka pieczone](/de/rezepte/zeberka). Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der Festbraten sein — Kultur-Owner bleibt der Guide, Cook-Primary diese URL. Gewürz-Nachbar descriptiv: [Majeranek](/de/blog/majeranek). In der Diaspora oft der Sonntags- oder Feiertagsvogel, den man rare genug macht, um ihn richtig zu feiern.",
    originPl:
      "Kaczka pieczona to intent cook: klasyczna polska kaczka z pieca — tu jedna linia domowa: cała kaczka z jabłkiem w brzuchu, majeranek, sól i pieprz, wolno w piecu aż skóra chrupiąca, a mięso soczyste. To ani pieczeń wieprzowa [schab pieczony](/pl/rezepte/schab-pieczony), ani duszona [golonka](/pl/rezepte/golonka), ani [żeberka pieczone](/pl/rezepte/zeberka). Przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) bywa pieczeniem świątecznym — owner kultury zostaje przy guide, cook-primary przy tej URL. Przyprawa opisowo: [majeranek](/pl/blog/majeranek-leksykon). W diasporze często ptak niedzielny lub świąteczny, którego robi się rzadko i z szacunkiem.",
    shopDe:
      "Ganze Ente (frisch oder tiefgekühlt vollständig auftauen), säuerliche Äpfel, Majoran, Salz, Pfeffer, optional Zwiebel; etwas Flüssigkeit für die Form. Ente und gutes Majeranek oft im [Polenladen](/de/blog/polenladen-einkaufen). Fehlt frische Ente: tiefgekühlt ehrlich benennen; Qualität laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de) nur wo sinnvoll — nicht durch Schweinekamm ersetzen, sonst driftet der Intent zu [Schab pieczony](/de/rezepte/schab-pieczony). Keine Haxe und keine Rippen — sonst [Golonka](/de/rezepte/golonka) bzw. [Żeberka](/de/rezepte/zeberka).",
    shopPl:
      "Cała kaczka (świeża lub rozmrożona), jabłka kwaskowate, majeranek, sól, pieprz, opcjonalnie cebula; odrobina płynu do naczynia. Kaczka i dobry majeranek często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Brak świeżej: mrożona uczciwie; jakość według [zamienników](/pl/blog/zamienniki-skladnikow) tylko sensownie — nie zamieniać na schab, bo intent idzie w [schab pieczony](/pl/rezepte/schab-pieczony). Bez golonki i żeber — inaczej [golonka](/pl/rezepte/golonka) lub [żeberka](/pl/rezepte/zeberka).",
    techniqueDe:
      "Ente trocken tupfen — nasse Haut wird nicht knusprig. Würzen innen und außen; Apfel füllt und aromatisieren, ohne die Höhle zu stopfen. Heiß anbräunen, dann bei 180 °C weiter; regelmäßig begießen. Ruhezeit vor dem Tranchieren hält den Saft. Zu heiß austrocknet; zu wenig Zeit lässt die Haut weich. Das ist kein Schweinekamm wie [Schab](/de/rezepte/schab-pieczony) und keine Schmorhaxe wie [Golonka](/de/rezepte/golonka). Majoran-Feeling: [Majeranek](/de/blog/majeranek). Sonntagsrhythmus descriptiv: [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    techniquePl:
    ...
    serveDe:
      "Tranchiert mit knuspriger Haut, oft Kartoffeln und Rotkohl oder Beilage. Bratensaft abschmecken, Fett abschöpfen. Menüplatz descriptiv: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Abgrenzung auf dem Tisch: Schweinekamm = [Schab](/de/rezepte/schab-pieczony); Haxe = [Golonka](/de/rezepte/golonka); Rippen = [Żeberka](/de/rezepte/zeberka). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen). Reste kalt oder aufgewärmt — Haut separat knusprig halten.",
    servePl:
      "Porcjowana z chrupiącą skórą, często ziemniaki i czerwona kapusta. Sos dopraw, tłuszcz zbierz. Miejsce w menu: [obiad niedzielny](/pl/blog/obiad-niedzielny). Na stole: schab = [schab pieczony](/pl/rezepte/schab-pieczony); golonka = [golonka](/pl/rezepte/golonka); żebra = [żeberka](/pl/rezepte/zeberka). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy). Resztki zimne lub odgrzane — skórę osobno.",
    diasporaDe:
      "Ofenente ist diaspora-festlich: ein Vogel für Gäste, Apfel und Majoran aus dem Vorrat, Ofenzeit als Planungszeit. Selten genug, dass man sie richtig macht — nicht als Alltags-Hackbraten. Qualität vor drei Festbraten am selben Tag. Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de). Kultur ohne Primary-Diebstahl: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Nachbarn bleiben [Schab](/de/rezepte/schab-pieczony) und [Golonka](/de/rezepte/golonka).",
    diasporaPl:
      "Kaczka z pieca lubi diasporę świąteczną: jeden ptak dla gości, jabłko i majeranek ze spiżarni, czas pieca jako plan. Rzadko na tyle, by zrobić ją dobrze — nie jako codzienny hackbraten. Jakość przed trzema pieczeniami tego samego dnia. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow). Kultura bez kradzieży primary: [obiad niedzielny](/pl/blog/obiad-niedzielny). Sąsiedzi: [schab](/pl/rezepte/schab-pieczony), [golonka](/pl/rezepte/golonka).",
    mistakesDe:
      "Mit [Schab pieczony](/de/rezepte/schab-pieczony) verwechseln. Mit [Golonka](/de/rezepte/golonka) oder [Żeberka](/de/rezepte/zeberka) verwechseln. Nasse Haut; zu heiß austrocknen; keine Ruhezeit. Ownership vom [Sonntagsessen](/de/blog/sonntagsessen-polnisch) stehlen — nein, dort Kultur. Majoran-Lexikon bleibt [Majeranek](/de/blog/majeranek).",
    mistakesPl:
      "Mylenie z [schabem pieczonym](/pl/rezepte/schab-pieczony). Mylenie z [golonką](/pl/rezepte/golonka) lub [żeberkami](/pl/rezepte/zeberka). Mokra skóra; za mocne pieczenie; brak odpoczynku. Kradzież ownership z [obiadu niedzielnego](/pl/blog/obiad-niedzielny) — nie. Leksykon: [majeranek](/pl/blog/majeranek-leksykon).",
    variantsDe:
      "Mit mehr Apfel; mit getrockneten Pflaumen in der Füllung (ehrlich benennen); halbe Ente für kleinere Haushalte. Nachbarn: [Schab](/de/rezepte/schab-pieczony), [Golonka](/de/rezepte/golonka), [Żeberka](/de/rezepte/zeberka). Guides: [Sonntagsessen](/de/blog/sonntagsessen-polnisch), [Majeranek](/de/blog/majeranek), [Polenladen](/de/blog/polenladen-einkaufen).",
    variantsPl:
      "Z większą ilością jabłka; ze śliwką suszoną w farszu (nazwać uczciwie); pół kaczki dla mniejszego domu. Sąsiedzi: [schab](/pl/rezepte/schab-pieczony), [golonka](/pl/rezepte/golonka), [żeberka](/pl/rezepte/zeberka). Przewodniki: [obiad niedzielny](/pl/blog/obiad-niedzielny), [majeranek](/pl/blog/majeranek-leksykon), [sklep polski](/pl/blog/sklep-polski-zakupy).",
  },
  ...
  "recipe-pieczen-rzymska": {
    ...
    serveDe:
      "In Scheiben mit sichtbarem Ei-Kern, oft Kartoffeln, Surówka oder leichte Soße. Menü descriptiv: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Wer Pfannen-Kotlets will: [Kotlet mielony](/de/rezepte/kotlet-mielony); wer Pastete: [Pasztet](/de/rezepte/pasztet). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen). Ersatz: [Ersatzprodukte](/de/blog/ersatzprodukte-de). Hält gekühlt zwei bis drei Tage; kalt oder aufgewärmt.",
    servePl:
      "W plastrach z widocznym jajkiem, często ziemniaki, surówka lub lekki sos. Menu: [obiad niedzielny](/pl/blog/obiad-niedzielny). Kotlety z patelni: [kotlet mielony](/pl/rezepte/kotlet-mielony); pasztet: [pasztet](/pl/rezepte/pasztet). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy). Zamienniki: [zamienniki](/pl/blog/zamienniki-skladnikow). Trzyma 2–3 dni w chłodzie.",
    diasporaDe:
      "Pieczeń rzymska ist diaspora-freundlich: ein Laib, Hack aus der Theke oder dem Wolf, Eier aus dem Kühlschrank, Ofen statt Pfannenrunde. Samstag formen, Sonntag schneiden — entlastet den Morgen. Kinder dürfen Eier schälen; heißer Ofen bei Erwachsenen. Qualität vor drei Hack-Gerichten am selben Tag. Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de). Kultur: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Abgrenzung: [Kotlet mielony](/de/rezepte/kotlet-mielony).",
    diasporaPl:
      "Pieczeń rzymska lubi diasporę: jeden bochenek, mielone z lady lub wilka, jajka z lodówki, piec zamiast rundy na patelni. Sobota formowanie, niedziela krojenie. Dzieci obiorą jajka; gorący piec u dorosłych. Jakość przed trzema daniami z mielonego. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow). Kultura: [obiad niedzielny](/pl/blog/obiad-niedzielny). Granica: [kotlet mielony](/pl/rezepte/kotlet-mielony).",
    mistakesDe:
      "Mit [Kotlet mielony](/de/rezepte/kotlet-mielony) verwechseln (Pfanne). Mit [Pasztet](/de/rezepte/pasztet) verwechseln. Zu nasse Masse; Eier nicht mittig; zu kurz backen. Ownership vom [Sonntagsessen](/de/blog/sonntagsessen-polnisch) stehlen — nein. Panade-Primary bleibt beim [Panieren-Guide](/de/blog/panieren-schabowy).",
    mistakesPl:
      "Mylenie z [kotletem mielonym](/pl/rezepte/kotlet-mielony) (patelnia). Mylenie z [pasztetem](/pl/rezepte/pasztet). Za mokra masa; jajka nie na środku; za krótkie pieczenie. Kradzież ownership z [obiadu niedzielnego](/pl/blog/obiad-niedzielny) — nie. Panierka zostaje przy [panierowaniu](/pl/blog/panierowanie-kotlet).",
    variantsDe:
      "Mit Speckmantel; ohne Ei-Kern (ehrlich benennen — Intent bleibt Ofen-Laib); feinere Hackmischung. Nachbarn: [Kotlet mielony](/de/rezepte/kotlet-mielony), [Pasztet](/de/rezepte/pasztet). Guides: [Sonntagsessen](/de/blog/sonntagsessen-polnisch), [Fleischwolf](/de/blog/fleischwolf-kaufberatung), [Ersatzprodukte](/de/blog/ersatzprodukte-de), [Polenladen](/de/blog/polenladen-einkaufen).",
    variantsPl:
      "Z boczkiem; bez jajka w środku (nazwać uczciwie — intent zostaje bochenek z pieca); drobniejsze mielone. Sąsiedzi: [kotlet mielony](/pl/rezepte/kotlet-mielony), [pasztet](/pl/rezepte/pasztet). Przewodniki: [obiad niedzielny](/pl/blog/obiad-niedzielny), [wilk do mięsa](/pl/blog/wilk-do-miesa), [zamienniki](/pl/blog/zamienniki-skladnikow), [sklep polski](/pl/blog/sklep-polski-zakupy).",
  },
};
