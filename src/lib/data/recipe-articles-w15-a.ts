...
export const W15_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-kaczka": {
    ...
    serveDe:
      "Tranchiert mit knuspriger Haut, oft Kartoffeln und Rotkohl oder Beilage. Bratensaft abschmecken, Fett abschöpfen. Menüplatz descriptiv: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Abgrenzung auf dem Tisch: Schweinekamm = [Schab](/de/rezepte/schab-pieczony); Haxe = [Golonka](/de/rezepte/golonka); Rippen = [Żeberka](/de/rezepte/zeberka). Im [Polenladen](/de/blog/polenladen-einkaufen) findest du typische Spezialzutaten. Reste kalt oder aufgewärmt — Haut separat knusprig halten.",
    servePl:
  ...
  "recipe-pieczen-rzymska": {
    ...
    variantsDe:
      "Mit Speckmantel; ohne Ei-Kern (ehrlich benennen — Intent bleibt Ofen-Laib); feinere Hackmischung. Passende Nachbarn sind [Kotlet mielony](/de/rezepte/kotlet-mielony), [Pasztet](/de/rezepte/pasztet). Guides: [Sonntagsessen](/de/blog/sonntagsessen-polnisch), [Fleischwolf](/de/blog/fleischwolf-kaufberatung), [Ersatzprodukte](/de/blog/ersatzprodukte-de), [Polenladen](/de/blog/polenladen-einkaufen).",
    variantsPl:
      "Z boczkiem; bez jajka w środku (nazwać uczciwie — intent zostaje bochenek z pieca); drobniejsze mielone. Pasujący sąsiedzi to [kotlet mielony](/pl/rezepte/kotlet-mielony), [pasztet](/pl/rezepte/pasztet). Przewodniki: [obiad niedzielny](/pl/blog/obiad-niedzielny), [wilk do mięsa](/pl/blog/wilk-do-miesa), [zamienniki](/pl/blog/zamienniki-skladnikow), [sklep polski](/pl/blog/sklep-polski-zakupy).",
  },
};
