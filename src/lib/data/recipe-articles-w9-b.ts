...
export const W9_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-salatka-jarzynowa": {
    ...
    mistakesDe:
      "Heißes Gemüse mit Mayo mischen; zu große Würfel; Mizeria-Intent stehlen (Gurke/Śmietana als Primary); zu süße Mayo ohne Abschmecken; Salat stundenlang warm am Buffet. Zu viel Lake macht ihn scharf und wässrig.",
    mistakesPl:
  ...
  "recipe-botwinka": {
    ...
    serveDe:
      "Heiß als leichte Hauptsuppe oder Frühjahrsstarter, mit Dill und optional Ei. Nach Ostern oder an milden Sonntagen statt schwerem Barszcz — Speiseplan-Owner bleibt [Wielkanoc](/de/blog/wielkanoc-speiseplan) bzw. Kultur [Sonntagsessen](/de/blog/sonntagsessen-polnisch); hier nur das Gericht. Abgrenzung auf dem Tisch: klarer [Barszcz](/de/rezepte/barszcz-czerwony) zu Wigilia/Uszka, kalter [Chłodnik](/de/rezepte/chlodnik-litewski) im Hochsommer.",
    servePl:
    ...
    diasporaDe:
      "In deutschen Küchen ist frische Botwina saisonal — wer sie findet, kocht Botwinka; wer nicht, wartet oder benennt die Ersatzgrün-Variante. Ein Topf für zwei warme Mittage. Überblick und Einordnung ohne neuen Pillar: [Polnische Suppen](/de/blog/polnische-suppen).",
    diasporaPl:
    ...
    mistakesDe:
      "Mit Barszcz verwechseln und alles abseihen; kalt wie Chłodnik servieren; Blätter von Anfang an mitkochen bis grau; Śmietana kochend einrühren; Primary von Barszcz-Technik oder Ogórkowa stehlen.",
    mistakesPl:
