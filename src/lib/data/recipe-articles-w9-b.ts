...
export const W9_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-salatka-jarzynowa": {
    ...
    mistakesDe:
      "Heißes Gemüse mit Mayo mischen; zu große Würfel; Mizeria-Intent stehlen (Gurke/Śmietana als Hauptgericht hier); zu süße Mayo ohne Abschmecken; Salat stundenlang warm am Buffet. Zu viel Lake macht ihn scharf und wässrig.",
    mistakesPl:
      "Mieszanie gorących warzyw z majonezem; za duża kostka; kradzież intentu mizerii (ogórek/śmietana jako fokus); zbyt słodki majonez bez doprawienia; trzymanie sałatki godzinami w cieple na bufecie. Za dużo zalewy robi ją ostrą i wodnistą.",
    variantsDe:
  ...
  "recipe-botwinka": {
    ...
    mistakesDe:
      "Mit Barszcz verwechseln und alles abseihen; kalt wie Chłodnik servieren; Blätter von Anfang an mitkochen bis grau; Śmietana kochend einrühren; Hitze, Feuchtigkeit oder Garzeit falsch einschätzen.",
    mistakesPl:
      "Mylenie z barszczem i przecedzanie wszystkiego; podawanie zimne jak chłodnik; gotowanie liści od początku do szarości; śmietana do wrzątku; kradzież fokus techniki barszczu lub ogórkowej.",
    variantsDe:
