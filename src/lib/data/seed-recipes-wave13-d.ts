...
export const seedRecipesWave13D: Recipe[] = [
  {
    ...
    translations: {
      de: {
        ...
        slug: "biala-kielbasa",
        excerpt:
          "Helle frische Weißwurst schonend garen — Ostern-Teller mit Meerrettich/Senf oder Einlage für Żurek. Cook-Primary; Arten bleiben im Kiełbasa-Lexikon.",
        steps: [
          {
          ...
          {
            text: "Heiß mit Meerrettich, Senf und Brot servieren, oder in Scheiben zu [Żurek](/de/rezepte/zurek). Menü-Kontext Ostern: [Wielkanoc Speiseplan](/de/blog/wielkanoc-speiseplan) — Speiseplan bleibt Anlass-Owner.",
          },
        ],
        seoTitle: "Biała kiełbasa Rezept | Weiße Wurst polnisch | Alemniam",
        seoDescription:
          "Biała kiełbasa kochen oder backen — hell, schonend, bilingual. Cook-Intent neben dem Kiełbasa-Arten-Lexikon.",
      },
      pl: {
        title: "Biała kiełbasa",
        slug: "biala-kielbasa",
        excerpt:
          "Świeża biała kiełbasa delikatnie ugotowana — talerz wielkanocny z chrzanem/musztardą albo dodatek do żurku. Cook-primary; rodzaje zostają w leksykonie kiełbasy.",
        steps: [
          {
          ...
          {
            text: "Podawaj gorącą z chrzanem, musztardą i chlebem albo w plastrach do [żurku](/pl/rezepte/zurek). Kontekst świąt: [menu wielkanocne](/pl/blog/menu-wielkanocne) — plan menu zostaje ownerem okazji.",
          },
        ],
        seoTitle: "Biała kiełbasa przepis | Gotowanie i pieczenie | Alemniam",
        seoDescription:
          "Biała kiełbasa — gotowanie lub pieczenie, jasna i delikatna. Cook-intent obok leksykonu rodzajów kiełbasy.",
      },
    },
    ingredients: [
      {
