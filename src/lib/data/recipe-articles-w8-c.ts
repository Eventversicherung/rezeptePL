/**
 * Wave 8 Paket C — FACTS for recipe-paczki (Markdown inline links).
 * Integrator E merges `W8_FACTS_C` into recipe-articles.ts FACTS.
 */

export const W8_FACTS_C = {
 "recipe-paczki": {
 dishDe: "Pączki",
 dishPl: "Pączki",
 ...
 techniquePl:
 "Drożdże aktywować na letnio, ciasto elastycznie wyrabiać i wyrastać, nadzienie odsączone wkładać, brzegi mocno sklejać, drugie wyrastanie, smażyć w 170–180 °C na pływająco, posypać na ciepło. Szczegóły i błędy: [technika pączków](/pl/blog/paczki-technika). Chrupiąca alternatywa tego samego dnia: [technika faworków](/pl/blog/faworki-technika).",
 serveDe:
 "Noch warm mit Puderzucker oder leichter Glasur, Kaffee oder Tee. Am [Tłusty Czwartek](/de/blog/tlusty-czwartek) oft neben [Faworki](/de/rezepte/faworki) — eine Charge selbst, eine gekauft ist legitim. Hefe in der Pfanne statt Fettbad: [Racuchy](/de/rezepte/racuchy-jablka).",
 servePl:
 ...
 diasporaDe:
 "In Deutschland rettet ein früher Teigstart den Donnerstagmorgen. Gute Bäckerei-Pączki sind kein Scheitern — Selbstmachen bleibt Lernprojekt. Im [Polenladen](/de/blog/polenladen-einkaufen) findest du typische Füllungen; den Kulturrahmen ohne Rezept-Übernahme gibt [Tłusty Czwartek](/de/blog/tlusty-czwartek).",
 diasporaPl:
 "W Niemczech wcześniejszy start ciasta ratuje czwartkowy ranek. Dobre pączki z cukierni to nie porażka — robienie samemu zostaje projektem nauki. W [sklepie polskim](/pl/blog/sklep-polski-zakupy) kupisz typowe nadzienia; ramy kulturowe bez zastępowania przepisu daje [Tłusty Czwartek](/pl/blog/tlusty-czwartek-przepisy).",
 mistakesDe:
 "Zu kaltes Fett, zu nasse Füllung, zu viel Mehl, abgetötete Hefe und zu kurzes Gehen machen Pączki schwer oder rissig. Zu große Stücke braten ungleichmäßig — lieber kleinere formen und die Öltemperatur halten. Nicht mit [Faworki](/de/rezepte/faworki)-Technik verwechseln.",
 mistakesPl:
 "Za chłodny tłuszcz, za mokre nadzienie, za dużo mąki, zabite drożdże i za krótkie wyrastanie robią pączki ciężkie albo spękane. Za duże sztuki smażą się nierówno — lepiej formować mniejsze i trzymać temperaturę oleju. Nie mylić z techniką [faworków](/pl/rezepte/faworki).",
 variantsDe:
