...
export const W8_FACTS_B: Record<string, ArticleFacts> = {
 ...
 mistakesDe:
 "Zu nasses Kraut ohne Ausdrücken; zu wenig Raucharoma und dann Überwürzen; Kapuśniak wie Bigos stundenlang einkochen bis Paste; Zu starkes Kochen macht Kartoffeln matschig und die Suppe trüb-aggressiv.",
 mistakesPl:
