...
export const W15_FACTS_D: Record<string, ArticleFacts> = {
  ...
  "recipe-kisiel": {
    ...
    servePl:
      "Ciepły, letni lub zimny w szklance lub miseczce — do łyżki, półprzezroczysty, kolor owoców jasny. Opcjonalnie świeże owoce lub śmietana. Lekki finał obok [menu wigilijnego](/pl/blog/menu-wigilijne) — bez zastępowania ownera okazji. Napój z suszu: [kompot z suszu](/pl/rezepte/kompot-z-suszu); zboże+mak: [kutia](/pl/rezepte/kutia). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz specjalności; zamienniki znajdziesz w [zamienniki](/pl/blog/zamienniki-skladnikow).",
    diasporaDe:
    ...
    mistakesPl:
      "Mylenie z [kompotem z suszu](/pl/rezepte/kompot-z-suszu). Mylenie z [kutią](/pl/rezepte/kutia). Skrobia w grudkach. Zbyt długie gotowanie. Udawanie ownera menu zamiast przepisu — nie, okazja zostaje przy [menu wigilijnym](/pl/blog/menu-wigilijne). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności.",
    variantsDe:
