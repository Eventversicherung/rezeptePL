...
export const W15_FACTS_D: Record<string, ArticleFacts> = {
  ...
  "recipe-kisiel": {
    ...
    serveDe:
      "Warm, lauwarm oder kalt in Glas oder Schale — löffelbar, semi-transparent, Beerenfarbe klar. Optional frische Beeren oder Śmietana. Als leichter Abschluss neben dem [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan) — ohne den Menü-Artikel zu ersetzen. Wer dunkles Susz-Getränk will: [Kompot z suszu](/de/rezepte/kompot-z-suszu); wer Getreide+Mohn: [Kutia](/de/rezepte/kutia). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), Ersatz: [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    servePl:
