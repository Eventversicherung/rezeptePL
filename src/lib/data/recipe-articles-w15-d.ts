...
export const W15_FACTS_D: Record<string, ArticleFacts> = {
 ...
 serveDe:
 "Heiß, hell, mit Ei und Dill. Passt als ruhiger Starter oder leichter Mittag im Sinne von [polnischem Sonntagsessen](/de/blog/sonntagsessen-polnisch). Wer klare Brühe will: [Rosół](/de/rezepte/rosol); wer Sauerampfer: [Szczawiowa](/de/rezepte/szczawiowa); wer Gurkensäure: [Ogórkowa](/de/rezepte/ogorkowa); wer junge Bete: [Botwinka](/de/rezepte/botwinka). Landschaft: [Polnische Suppen](/de/blog/polnische-suppen). Im [Polenladen](/de/blog/polenladen-einkaufen) findest du typische Spezialzutaten.",
 servePl:
 "Gorąca, jasna, z jajkiem i koperkiem. Spokojny starter lub lekki obiad w duchu [obiadu niedzielnego](/pl/blog/obiad-niedzielny). Klarowny wywar: [rosół](/pl/rezepte/rosol); szczaw: [szczawiowa](/pl/rezepte/szczawiowa); kwas ogórkowy: [ogórkowa](/pl/rezepte/ogorkowa); młode buraki: [botwinka](/pl/rezepte/botwinka). Krajobraz: [polskie zupy](/pl/blog/polskie-zupy). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności.",
 diasporaDe:
 "Koperkowa ist Diaspora-freundlich: Dill und Kartoffeln aus dem Supermarkt, Śmietana aus dem Kühlregal, ein Topf für denselben Tag. Kinder dürfen Dill zupfen und Eier schälen; heißer Topf bei Erwachsenen. Fehlt frischer Dill: ehrlich laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de) und Qualität im [Polenladen](/de/blog/polenladen-einkaufen) prüfen. Speiseplan entlasten heißt: klare Rezeptseite, Kultur bleibt beim [Sonntagsessen](/de/blog/sonntagsessen-polnisch), Überblick bei [Polnische Suppen](/de/blog/polnische-suppen).",
 diasporaPl:
 "Koperkowa lubi diasporę: koperek i ziemniaki z marketu, śmietana z lodówki, jeden garnek na ten sam dzień. Dzieci oberwą koper i obiorą jajka; gorący garnek u dorosłych. Brak świeżego koperku: uczciwie według [zamienników](/pl/blog/zamienniki-skladnikow) i jakość w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Odciążenie menu: jasna strona przepisu, kultura zostaje w [obiadzie niedzielnym](/pl/blog/obiad-niedzielny), przegląd w [polskich zupach](/pl/blog/polskie-zupy).",
 mistakesDe:
 "Mit [Rosół](/de/rezepte/rosol) verwechseln (klare Brühe). Mit [Szczawiowa](/de/rezepte/szczawiowa) verwechseln (Sauerampfer). Mit [Ogórkowa](/de/rezepte/ogorkowa) verwechseln (Kiszone). Mit [Botwinka](/de/rezepte/botwinka) verwechseln (Bete). Dill zu spärlich oder zu früh mitkochen. Śmietana kochend einrühren. nein.",
 mistakesPl:
 "Mylenie z [rosołem](/pl/rezepte/rosol). Mylenie z [szczawiową](/pl/rezepte/szczawiowa). Mylenie z [ogórkową](/pl/rezepte/ogorkowa). Mylenie z [botwinką](/pl/rezepte/botwinka). Za mało koperku albo za wcześnie gotowany. Śmietana do wrzątku. Nie mieszać ilości i kroków z sąsiednim przepisem.",
 variantsDe:
 "Mit mehr Dill intensiver; mit weniger Śmietana leichter; vegetarisch auf Gemüsebrühe. Passende Nachbarn sind [Rosół](/de/rezepte/rosol), [Szczawiowa](/de/rezepte/szczawiowa), [Ogórkowa](/de/rezepte/ogorkowa), [Botwinka](/de/rezepte/botwinka). Guides: [Polnische Suppen](/de/blog/polnische-suppen), [Sonntagsessen](/de/blog/sonntagsessen-polnisch), [Śmietana/Schmand](/de/blog/smietana-schmand), [Polenladen](/de/blog/polenladen-einkaufen).",
 variantsPl:
 "Z większą ilością koperku intensywniej; z mniejszą śmietaną lżej; wege na warzywnym. Pasujący sąsiedzi to [rosół](/pl/rezepte/rosol), [szczawiowa](/pl/rezepte/szczawiowa), [ogórkowa](/pl/rezepte/ogorkowa), [botwinka](/pl/rezepte/botwinka). Przewodniki: [polskie zupy](/pl/blog/polskie-zupy), [obiad niedzielny](/pl/blog/obiad-niedzielny), [śmietana/Schmand](/pl/blog/smietana-czy-schmand), [sklep polski](/pl/blog/sklep-polski-zakupy).",
 },
 ...
 originDe:
 "Kisiel owocowy ist die polnische Fruchtcreme aus Fruchtsaft und Speisestärke — hier als Himbeer-Linie: Beeren auskochen, absieben, mit Stärke binden, bis der Topf dicklich-glänzend und halbtransparent ist. Das ist kein Trockenobstkompot mit ganzen Fruchtstücken wie [Kompot z suszu](/de/rezepte/kompot-z-suszu) und kein Weizen-Mohn-Dessert wie [Kutia](/de/rezepte/kutia). An Wigilia verankert ihn der [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan); Einkauf und Ersatzlogik klären [Polenladen](/de/blog/polenladen-einkaufen) und [Ersatzprodukte DE](/de/blog/ersatzprodukte-de).",
 originPl:
 "Kisiel owocowy to polski kisiel z soku owocowego i skrobi — tu linia malinowa: owoce wygotować, przecedzić, spiąć skrobią, aż masa będzie gęsta, błyszcząca i półprzezroczysta. To nie kompot z suszu z całymi owocami jak [kompot z suszu](/pl/rezepte/kompot-z-suszu) i nie deser pszenno-makowy jak [kutia](/pl/rezepte/kutia). Na Wigilii porządkuje go [menu wigilijne](/pl/blog/menu-wigilijne); zakupy i zamienniki: [sklep polski](/pl/blog/sklep-polski-zakupy) oraz [zamienniki](/pl/blog/zamienniki-skladnikow).",
 shopDe:
 "Himbeeren frisch oder TK — Supermarkt ganzjährig. Speisestärke (Kartoffelstärke klassisch) im Backregal oder [Polenladen](/de/blog/polenladen-einkaufen). Zucker, Zitrone, Wasser. Fehlt Himbeere: Johannisbeere oder Erdbeere ehrlich als andere Fruchtlinie laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Kein Susz-Mix und keine Weizenkörner — sonst wird daraus [Kompot z suszu](/de/rezepte/kompot-z-suszu) bzw. [Kutia](/de/rezepte/kutia). Anlass-Rahmen bleibt [Wigilia](/de/blog/wigilia-speiseplan).",
 shopPl:
 "Maliny świeże lub mrożone — market przez cały rok. Skrobia (klasycznie ziemniaczana) w dziale mąk lub [sklepie polskim](/pl/blog/sklep-polski-zakupy). Cukier, cytryna, woda. Brak malin: porzeczka lub truskawka uczciwie jako inna linia według [zamienników](/pl/blog/zamienniki-skladnikow). Bez mieszanki suszu i bez pszenicy — inaczej dryfuje w stronę [kompot z suszu](/pl/rezepte/kompot-z-suszu) lub [kutię](/pl/rezepte/kutia). Rama okazji: [menu wigilijne](/pl/blog/menu-wigilijne).",
 techniqueDe:
 ...
 serveDe:
 "Warm, lauwarm oder kalt in Glas oder Schale — löffelbar, semi-transparent, Beerenfarbe klar. Optional frische Beeren oder Śmietana. Als leichter Abschluss neben dem [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan) — ohne den Menü-Artikel zu ersetzen. Wer dunkles Susz-Getränk will: [Kompot z suszu](/de/rezepte/kompot-z-suszu); wer Getreide+Mohn: [Kutia](/de/rezepte/kutia). Im [Polenladen](/de/blog/polenladen-einkaufen) findest du Spezialzutaten; Alternativen stehen unter [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
 servePl:
 "Ciepły, letni lub zimny w szklance lub miseczce — do łyżki, półprzezroczysty, kolor owoców jasny. Opcjonalnie świeże owoce lub śmietana. Lekki finał obok [menu wigilijnego](/pl/blog/menu-wigilijne) — bez zastępowania artykułu o okazji. Napój z suszu: [kompot z suszu](/pl/rezepte/kompot-z-suszu); zboże+mak: [kutia](/pl/rezepte/kutia). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz specjalności; zamienniki znajdziesz w [zamienniki](/pl/blog/zamienniki-skladnikow).",
 diasporaDe:
 ...
 mistakesPl:
 "Mylenie z [kompotem z suszu](/pl/rezepte/kompot-z-suszu). Mylenie z [kutią](/pl/rezepte/kutia). Skrobia w grudkach. Zbyt długie gotowanie. Zastępowanie planu menu zamiast przepisu — nie, okazja zostaje przy [menu wigilijnym](/pl/blog/menu-wigilijne). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności.",
 variantsDe:
 "Johannisbeere säuerlicher; Erdbeere milder; gemischte Beeren. Dünner als Trink-Kisiel, dicker als Pudding. Passende Nachbarn sind [Kompot z suszu](/de/rezepte/kompot-z-suszu), [Kutia](/de/rezepte/kutia). Guides: [Wigilia](/de/blog/wigilia-speiseplan), [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
 variantsPl:
 "Porzeczka bardziej kwaskowa; truskawka łagodniejsza; mieszanka jagód. Rzadszy jak napój, gęstszy jak budyń. Pasujący sąsiedzi to [kompot z suszu](/pl/rezepte/kompot-z-suszu), [kutia](/pl/rezepte/kutia). Przewodniki: [menu wigilijne](/pl/blog/menu-wigilijne), [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow).",
 },
};
