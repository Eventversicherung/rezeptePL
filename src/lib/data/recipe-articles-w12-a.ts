...
export const W12_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-zupa-grzybowa": {
    ...
    serveDe:
      "Heiß in tiefen Tellern, mit Dill. Am Festtag neben Pierogi und Fisch — Menürahmen [Wigilia](/de/blog/wigilia-speiseplan). Wer Rote Bete will, bleibt bei [Barszcz](/de/rezepte/barszcz-czerwony); wer deftige Einlage mit Majeranek sucht, bei [Flaki](/de/rezepte/flaki). Alltagsnachbar descriptiv: [Zupa pomidorowa](/de/rezepte/zupa-pomidorowa). Übersicht der Familie: [Polnische Suppen](/de/blog/polnische-suppen).",
    servePl:
      "Gorąca w głębokich talerzach, z koperkiem. Święta: obok pierogów i ryby — rama [menu wigilijne](/pl/blog/menu-wigilijne). Buraki: [barszcz](/pl/rezepte/barszcz-czerwony); treściwe flaki z majerankiem: [flaki](/pl/rezepte/flaki). Sąsiad codzienny opisowo: [zupa pomidorowa](/pl/rezepte/zupa-pomidorowa). Przegląd: [polskie zupy](/pl/blog/polskie-zupy).",
    diasporaDe:
    ...
    mistakesDe:
      "Pilzflüssigkeit ungefiltert (Sand). Mit [Barszcz](/de/rezepte/barszcz-czerwony) oder [Flaki](/de/rezepte/flaki) verwechseln. Zu kurze Einweichzeit. Sahne kochend einrühren. Ownership vom [Suppen-Overview](/de/blog/polnische-suppen) oder [Wigilia-Plan](/de/blog/wigilia-speiseplan) stehlen — nein, dort Broad bzw. Anlass.",
    mistakesPl:
      "Płyn z moczenia bez przecedzenia (piasek). Mylenie z [barszczem](/pl/rezepte/barszcz-czerwony) lub [flakami](/pl/rezepte/flaki). Za krótkie moczenie. Śmietana do wrzątku. Kradzież ownership z [przeglądu zup](/pl/blog/polskie-zupy) lub [menu wigilijnego](/pl/blog/menu-wigilijne) — nie.",
    variantsDe:
      "Mit frischen Champignons ergänzt; mit Uszka-Nachbar descriptiv statt Nudeln; cremig nur im Alltag. Nachbarn: [Barszcz](/de/rezepte/barszcz-czerwony), [Ogórkowa](/de/rezepte/ogorkowa), [Flaki](/de/rezepte/flaki). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de), Anlass: [Wigilia](/de/blog/wigilia-speiseplan).",
    variantsPl:
      "Ze świeżymi pieczarkami; opisowo uszka zamiast makaronu; kremowo tylko na co dzień. Sąsiedzi: [barszcz](/pl/rezepte/barszcz-czerwony), [ogórkowa](/pl/rezepte/ogorkowa), [flaki](/pl/rezepte/flaki). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow), okazja: [menu wigilijne](/pl/blog/menu-wigilijne).",
  },
  ...
  "recipe-grochowka": {
    ...
    originDe:
      "Grochówka ist der Cook-Intent für die klassische polnische Erbsensuppe aus gelben Trockenerbsen — dick, mit Kartoffeln und oft geräucherter Kiełbasa oder Speck. Das ist weder Bohnenschmorgericht [Fasolka po bretonsku](/de/rezepte/fasolka-po-bretonsku) noch Sauerkrautsuppe [Kapuśniak](/de/rezepte/kapusniak) noch klare Brühe [Rosół](/de/rezepte/rosol). Der Overview [Polnische Suppen](/de/blog/polnische-suppen) ordnet die Landschaft; hier liegt der enge Erbsen-Primary. Menüplatz descriptiv beim [Sonntagsessen](/de/blog/sonntagsessen-polnisch) — Anlass- und Kultur-Owner bleiben die Guides, Cook-Primary dieses Rezept. Krupnik bleibt verwandte, spätere Linie — nicht parallel stehlen.",
    originPl:
      "Grochówka to intent cook: klasyczna zupa z żółtego grochu — gęsta, z ziemniakami i często wędzoną kiełbasą lub słoniną. To ani duszona [fasolka po bretonsku](/pl/rezepte/fasolka-po-bretonsku), ani [kapuśniak](/pl/rezepte/kapusniak), ani klarowny [rosół](/pl/rezepte/rosol). Przegląd [polskie zupy](/pl/blog/polskie-zupy) porządkuje krajobraz; tu wąski primary grochu. Miejsce w menu opisowo przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny). Krupnik zostaje spokrewnioną, późniejszą linią — nie kradnij równolegle.",
    shopDe:
    ...
    mistakesDe:
      "Mit [Fasolka](/de/rezepte/fasolka-po-bretonsku) verwechseln (Bohnen). Mit [Kapuśniak](/de/rezepte/kapusniak) verwechseln (Kraut). Zu wenig Garzeit. Wurst von Anfang an mitkochen bis fade. Ownership vom [Suppen-Overview](/de/blog/polnische-suppen) stehlen — nein. Krupnik-Primary vorbereiten, bevor gemessen — nein, später.",
    mistakesPl:
      "Mylenie z [fasolką](/pl/rezepte/fasolka-po-bretonsku). Mylenie z [kapuśniakiem](/pl/rezepte/kapusniak). Za krótko gotowane. Kiełbasa od początku do bladości. Kradzież ownership z [przeglądu zup](/pl/blog/polskie-zupy) — nie. Primary krupnika przed pomiarem — nie, później.",
    variantsDe:
