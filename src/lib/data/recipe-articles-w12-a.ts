...
export const W12_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-zupa-grzybowa": {
    ...
    mistakesDe:
      "Pilzflüssigkeit ungefiltert (Sand). Mit [Barszcz](/de/rezepte/barszcz-czerwony) oder [Flaki](/de/rezepte/flaki) verwechseln. Mit Gerstensuppe [Krupnik](/de/rezepte/krupnik) verwechseln. Zu kurze Einweichzeit. Sahne kochend einrühren. Ownership vom [Suppen-Overview](/de/blog/polnische-suppen) oder [Wigilia-Plan](/de/blog/wigilia-speiseplan) stehlen — nein, dort Broad bzw. Anlass.",
    mistakesPl:
      "Płyn z moczenia bez przecedzenia (piasek). Mylenie z [barszczem](/pl/rezepte/barszcz-czerwony) lub [flakami](/pl/rezepte/flaki). Mylenie z zupą jęczmienną [krupnik](/pl/rezepte/krupnik). Za krótkie moczenie. Śmietana do wrzątku. Kradzież ownership z [przeglądu zup](/pl/blog/polskie-zupy) lub [menu wigilijnego](/pl/blog/menu-wigilijne) — nie.",
    variantsDe:
      "Mit frischen Champignons ergänzt; mit Uszka-Nachbar descriptiv statt Nudeln; cremig nur im Alltag. Nachbarn: [Barszcz](/de/rezepte/barszcz-czerwony), [Ogórkowa](/de/rezepte/ogorkowa), [Flaki](/de/rezepte/flaki), [Krupnik](/de/rezepte/krupnik). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de), Anlass: [Wigilia](/de/blog/wigilia-speiseplan).",
    variantsPl:
  ...
  "recipe-grochowka": {
    ...
    mistakesDe:
      "Mit [Fasolka](/de/rezepte/fasolka-po-bretonsku) verwechseln (Bohnen). Mit [Kapuśniak](/de/rezepte/kapusniak) verwechseln (Kraut). Mit [Krupnik](/de/rezepte/krupnik) verwechseln (Gerste). Zu wenig Garzeit. Wurst von Anfang an mitkochen bis fade. Ownership vom [Suppen-Overview](/de/blog/polnische-suppen) stehlen — nein.",
    mistakesPl:
      "Mylenie z [fasolką](/pl/rezepte/fasolka-po-bretonsku). Mylenie z [kapuśniakiem](/pl/rezepte/kapusniak). Mylenie z [krupnikiem](/pl/rezepte/krupnik). Za krótko gotowane. Kiełbasa od początku do bladości. Kradzież ownership z [przeglądu zup](/pl/blog/polskie-zupy) — nie.",
    variantsDe:
