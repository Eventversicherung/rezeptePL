...
export const W12_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-zupa-grzybowa": {
    ...
    mistakesDe:
      "Pilzflüssigkeit ungefiltert (Sand). Mit [Barszcz](/de/rezepte/barszcz-czerwony) oder [Flaki](/de/rezepte/flaki) verwechseln. Mit Gerstensuppe [Krupnik](/de/rezepte/krupnik) verwechseln. Zu kurze Einweichzeit. Sahne kochend einrühren. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein, dort Überblick bzw. Anlass.",
    mistakesPl:
