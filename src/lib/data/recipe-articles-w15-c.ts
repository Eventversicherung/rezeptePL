...
export const W15_FACTS_C: Record<string, ArticleFacts> = {
  "recipe-marchewka-groszek": {
    ...
    originDe:
      "Marchewka z groszkiem ist der Cook-Intent für die warme Möhren-Erbsen-Beilage der polnischen Haus- und Sonntagsküche: gewürfelt oder in Scheiben, in Butter glasig geschwenkt, oft mit Dill — heiß neben Fleisch und Kartoffeln. Das ist weder der kalte Gurkensalat [Mizeria](/de/rezepte/mizeria) noch die warme Rote-Bete-Beilage [Buraczki](/de/rezepte/buraczki) noch ein Rohkost-Salat. Menürahmen bleibt im [Sonntagsessen-Guide](/de/blog/sonntagsessen-polnisch); hier liegt der enge Beilagen-Primary. Klassischer Teller-Nachbar: [Kotlet schabowy](/de/rezepte/kotlet-schabowy). Einkaufspraxis: [Polenladen](/de/blog/polenladen-einkaufen).",
    originPl:
      "Marchewka z groszkiem to intent cook ciepłego dodatku z marchewki i groszku w polskiej kuchni domowej i niedzielnej: kostka lub plasterki, zeszkliwione na maśle, często z koprem — gorące obok mięsa i ziemniaków. To ani zimna [mizeria](/pl/rezepte/mizeria), ani ciepłe [buraczki](/pl/rezepte/buraczki), ani surowa surówka. Rama menu zostaje w [obiadzie niedzielnym](/pl/blog/obiad-niedzielny); tu wąski primary dodatku. Klasyczny sąsiad: [kotlet schabowy](/pl/rezepte/kotlet-schabowy). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy).",
    shopDe:
    ...
    mistakesDe:
      "Roh servieren oder als Surówka verkaufen → Clash mit Rohkost-Intent. Mit [Mizeria](/de/rezepte/mizeria) (Gurke/Śmietana) oder [Buraczki](/de/rezepte/buraczki) (Rote Bete) verwechseln. Zu lange kochen bis Brei. Speiseplan-Ownership stehlen statt [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Zu wenig Butter — dann kein Glanz und kein Beilagen-Charakter.",
    mistakesPl:
      "Podawanie na surowo / jako surówka. Mylenie z [mizerią](/pl/rezepte/mizeria) lub [buraczkami](/pl/rezepte/buraczki). Rozgotowanie na papkę. Kradzież ownership menu zamiast [obiadu niedzielnego](/pl/blog/obiad-niedzielny). Za mało masła — brak połysku i charakteru dodatku.",
    variantsDe:
  ...
  "recipe-fasolka-szparagowa": {
    ...
    originDe:
      "Fasolka szparagowa po polsku ist der Cook-Intent für grüne Stangenbohnen als warme Beilage: bissfest gegart, in Butter (± Semmelbrösel/bułka tarta) geschwenkt — neben Fleisch am Sonntagstisch. Das ist **nicht** der Tomaten-Wurst-Eintopf mit weißen Bohnen [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku); Broad und Einkaufs-Pillar dazu bleiben beim [Fasolka-Guide](/de/blog/fasolka-po-bretonsku) — hier nur descriptive Abgrenzung Beilage ≠ Eintopf. Menü: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen). Teller-Nachbar oft [Kotlet schabowy](/de/rezepte/kotlet-schabowy).",
    originPl:
      "Fasolka szparagowa po polsku to intent cook zielonych strąków jako ciepłego dodatku: ugotowana al dente, zeszkliwiona na maśle (± bułka tarta) — obok mięsa w niedzielę. To **nie** pomidorowo-kiełbasiany gulasz z białą fasolą [fasolka po bretońsku](/pl/rezepte/fasolka-po-bretonsku); broad i zakupy zostają przy [przewodniku fasolki](/pl/blog/fasolka-po-bretonsku) — tu tylko opisowe: dodatek ≠ gulasz. Menu: [obiad niedzielny](/pl/blog/obiad-niedzielny). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy). Sąsiad: [kotlet schabowy](/pl/rezepte/kotlet-schabowy).",
    shopDe:
      "Grüne Stangenbohnen (frisch oder TK), Butter, bułka tarta, optional Zwiebel/Knoblauch, Dill — Supermarkt; gute Brösel und Kräuter im [Polenladen](/de/blog/polenladen-einkaufen). **Nicht** weiße Bohnen aus Glas/Dose für diesen Primary — das gehört zu [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku) und dem [Fasolka-Guide](/de/blog/fasolka-po-bretonsku). Menü descriptiv: [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    shopPl:
      "Fasolka szparagowa (świeża lub mrożona), masło, bułka tarta, opcjonalnie cebula/czosnek, koper — supermarket; bułka i zioła w [sklepie polskim](/pl/blog/sklep-polski-zakupy). **Nie** biała fasola ze słoika do tego primary — to [fasolka po bretońsku](/pl/rezepte/fasolka-po-bretonsku) i [przewodnik](/pl/blog/fasolka-po-bretonsku). Menu: [obiad niedzielny](/pl/blog/obiad-niedzielny).",
    techniqueDe:
      "Enden abschneiden, bissfest kochen, gut abtropfen. Butter heiß, Brösel goldbraun — dann Bohnen unterheben. Zu lange Garzeit = matschig und grau. Keine Tomatenmark-Kiełbasa-Basis: das stiehlt den Eintopf-Primary von [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku). Ohne Brösel nur Butter ist ok — ehrlich benennen. Parallel zu [Schabowy](/de/rezepte/kotlet-schabowy) timingbar.",
    techniquePl:
      "Obciąć końce, ugotować al dente, dobrze odsączyć. Gorące masło, bułka na złoto — potem fasolka. Za długie gotowanie = papka i szarość. Bez bazy pomidor-kiełbasa: to kradnie primary [fasolki po bretońsku](/pl/rezepte/fasolka-po-bretonsku). Bez bułki tylko masło — nazwać uczciwie. Timing z [schabowym](/pl/rezepte/kotlet-schabowy).",
    serveDe:
      "Heiß als Beilage neben [Kotlet schabowy](/de/rezepte/kotlet-schabowy), Braten oder Kasza — nie als sättigender Eintopf mit Brot wie [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku). Menü: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Guide nur descriptiv (Intent-Trennung): [Fasolka-Guide](/de/blog/fasolka-po-bretonsku). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen).",
    servePl:
    ...
    mistakesDe:
      "Weiße Bohnen + Tomate + Kiełbasa kochen → Clash mit [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku) und Steal am [Fasolka-Guide](/de/blog/fasolka-po-bretonsku). Bohnen zu weich. Brösel verbrennen. Als Hauptgericht-Eintopf verkaufen statt Beilage. Sonntags-Ownership stehlen statt [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    mistakesPl:
      "Biała fasola + pomidor + kiełbasa → clash z [fasolką po bretońsku](/pl/rezepte/fasolka-po-bretonsku) i kradzież [przewodnika](/pl/blog/fasolka-po-bretonsku). Za miękka fasolka. Spalona bułka. Sprzedaż jako gulasz zamiast dodatku. Kradzież ownership niedzieli zamiast [obiadu niedzielnego](/pl/blog/obiad-niedzielny).",
    variantsDe:
      "Nur Butter ohne Brösel; mit Knoblauch; mit Dill. Eintopf-Nachbar (anderer Primary): [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku) + [Fasolka-Guide](/de/blog/fasolka-po-bretonsku). Andere Beilagen: [Marchewka z groszkiem](/de/rezepte/marchewka-groszek), [Mizeria](/de/rezepte/mizeria), [Buraczki](/de/rezepte/buraczki). Guides: [Sonntagsessen](/de/blog/sonntagsessen-polnisch), [Polenladen](/de/blog/polenladen-einkaufen).",
    variantsPl:
      "Tylko masło bez bułki; z czosnkiem; z koprem. Sąsiad-gulasz (inny primary): [fasolka po bretońsku](/pl/rezepte/fasolka-po-bretonsku) + [przewodnik](/pl/blog/fasolka-po-bretonsku). Inne dodatki: [marchewka z groszkiem](/pl/rezepte/marchewka-groszek), [mizeria](/pl/rezepte/mizeria), [buraczki](/pl/rezepte/buraczki). Przewodniki: [obiad niedzielny](/pl/blog/obiad-niedzielny), [sklep polski](/pl/blog/sklep-polski-zakupy).",
  },
};
