...
export const W15_FACTS_C: Record<string, ArticleFacts> = {
  "recipe-marchewka-groszek": {
    ...
    originPl:
      "Marchewka z groszkiem to ciepłego dodatku z marchewki i groszku w polskiej kuchni domowej i niedzielnej: kostka lub plasterki, zeszkliwione na maśle, często z koprem — gorące obok mięsa i ziemniaków. To ani zimna [mizeria](/pl/rezepte/mizeria), ani ciepłe [buraczki](/pl/rezepte/buraczki), ani surowa surówka. Rama menu zostaje w [obiadzie niedzielnym](/pl/blog/obiad-niedzielny); tu wąski fokus dodatku. Klasyczny sąsiad: [kotlet schabowy](/pl/rezepte/kotlet-schabowy). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności.",
    shopDe:
      "Möhren, Erbsen (frisch oder TK), Butter, optional Zucker, Dill oder Petersilie, Salz, Pfeffer — alles im deutschen Supermarkt; frischer Dill oft im [Polenladen](/de/blog/polenladen-einkaufen). Butter-/Kräuterersatz ehrlich: [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Wer Gurke/Śmietana will: [Mizeria](/de/rezepte/mizeria). Wer Rote Bete warm: [Buraczki](/de/rezepte/buraczki). Zum Menü passt [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    shopPl:
      "Marchewka, groszek (świeży lub mrożony), masło, opcjonalnie cukier, koper lub pietruszka, sól, pieprz — supermarket; świeży koper często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Zamienniki znajdziesz w [zamienniki składników](/pl/blog/zamienniki-skladnikow). Ogórek/śmietana: [mizeria](/pl/rezepte/mizeria). Ciepłe buraki: [buraczki](/pl/rezepte/buraczki). Do menu pasuje [obiad niedzielny](/pl/blog/obiad-niedzielny).",
    techniqueDe:
    ...
    servePl:
      "Gorące w misce lub obok [schabowego](/pl/rezepte/kotlet-schabowy), ziemniaków, kaszy. Menu opisowo: [obiad niedzielny](/pl/blog/obiad-niedzielny). Nie mylić z [buraczkami](/pl/rezepte/buraczki) ani [mizerią](/pl/rezepte/mizeria) — inny kolor, temperatura, intent. W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności.",
    diasporaDe:
  ...
  "recipe-fasolka-szparagowa": {
    ...
    shopPl:
      "Fasolka szparagowa (świeża lub mrożona), masło, bułka tarta, opcjonalnie cebula/czosnek, koper — supermarket; bułka i zioła w [sklepie polskim](/pl/blog/sklep-polski-zakupy). **Nie** biała fasola ze słoika do tego fokus — to [fasolka po bretońsku](/pl/rezepte/fasolka-po-bretonsku) i [przewodnik](/pl/blog/fasolka-po-bretonsku). Do menu pasuje [obiad niedzielny](/pl/blog/obiad-niedzielny).",
    techniqueDe:
    ...
    serveDe:
      "Heiß als Beilage neben [Kotlet schabowy](/de/rezepte/kotlet-schabowy), Braten oder Kasza — nie als sättigender Eintopf mit Brot wie [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku). Zum Menü passt [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Der Überblick bleibt bei [Fasolka-Guide](/de/blog/fasolka-po-bretonsku). Im [Polenladen](/de/blog/polenladen-einkaufen) findest du typische Spezialzutaten.",
    servePl:
      "Gorące jako dodatek obok [schabowego](/pl/rezepte/kotlet-schabowy), pieczenia lub kaszy — nie jako sycący gulasz z chlebem jak [fasolka po bretońsku](/pl/rezepte/fasolka-po-bretonsku). Do menu pasuje [obiad niedzielny](/pl/blog/obiad-niedzielny). Przewodnik tylko opisowo: [fasolka guide](/pl/blog/fasolka-po-bretonsku). W [sklep polski](/pl/blog/sklep-polski-zakupy) kupisz typowe specjalności.",
    diasporaDe:
