...
export const seedFamilyVariantRecipes: Recipe[] = [
  {
    ...
    translations: {
      de: {
        ...
        steps: [
          {
            text: "Würfle eine Zwiebel fein und dünste sie in Butter glasig, ohne sie braun werden zu lassen.",
          ...
          pierogiDoughStepDe,
          {
            text: "Rolle den Teig dünn aus, steche Kreise aus, fülle sie, verschließe die Ränder fest und gare die Pierogi in leicht siedendem Salzwasser, bis sie aufschwimmen.",
            tip: "Koche nur kleine Chargen gleichzeitig, sonst kleben die Pierogi aneinander und die Nähte öffnen sich beim Rühren.",
          },
          {
            text: "Serviere die Pierogi heiß mit goldener Butterzwiebel.",
...
Wechsle oben zu [Ruskie](/de/rezepte/pierogi/ruskie), [Kraut-Pilze](/de/rezepte/pierogi/kraut-pilze) oder [Heidelbeeren](/de/rezepte/pierogi/jagody). Mehr zur Technik im Guide zu [Pierogi-Teig](/de/blog/pierogi-teig) und zur [Teigmaschine](/de/blog/teigmaschine-pierogi).`,
      ...
      pl: {
        ...
        steps: [
          ...
          pierogiDoughStepPl,
          {
            text: "Rozwałkuj ciasto cienko, wykrawaj kółka, nadziewaj, szczelnie sklejaj brzegi i gotuj w lekko wrzącej, osolonej wodzie, aż wypłyną.",
            tip: "Gotuj tylko małe partie naraz, inaczej pierogi się kleją i szwy się otwierają podczas mieszania.",
          },
          {
            text: "Podawaj pierogi gorące ze złotą cebulką na maśle.",
    ...
    translations: {
      de: {
        ...
        steps: [
          ...
          {
            text: "Lasse das Sauerkraut gut abtropfen, dünste es mit einer Zwiebel und den Pilzen und schmecke es mit etwas Pilzsud ab. Die Füllung muss fest und kühl sein.",
            tip: "Ist das Kraut sehr sauer, spüle es vorher kurz mit Wasser ab, damit die Füllung nicht zu scharf wird.",
          },
          pierogiDoughStepDe,
          {
            text: "Rolle den Teig dünn aus, fülle die Kreise, verschließe sie fest und gare die Pierogi in leicht siedendem Salzwasser.",
...
Wechsle oben zu [Ruskie](/de/rezepte/pierogi/ruskie), [Fleisch](/de/rezepte/pierogi/fleisch) oder [Heidelbeeren](/de/rezepte/pierogi/jagody). Den ganzen Rahmen liefert der [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan), zur Technik hilft der Guide zu [Teig](/de/techniken/teig).`,
      ...
      pl: {
        ...
        steps: [
          ...
          {
            text: "Odsącz kapustę, duś ją razem z cebulą i grzybami, a na koniec dopraw odłożonym wywarem. Farsz ma być zbity i chłodny.",
            tip: "Jeśli kapusta jest bardzo kwaśna, przepłucz ją krótko wodą, żeby farsz nie wyszedł za ostry.",
          },
          pierogiDoughStepPl,
          {
            text: "Rozwałkuj ciasto cienko, nadziewaj kółka, szczelnie je sklejaj i gotuj pierogi w lekko wrzącej, osolonej wodzie.",
...
Przełącz u góry na [ruskie](/pl/rezepte/pierogi/ruskie), [mięso](/pl/rezepte/pierogi/mieso) albo [jagody](/pl/rezepte/pierogi/jagody). Cały kontekst daje [menu wigilijne](/pl/blog/menu-wigilijne), do techniki pomaga przewodnik o [cieście](/pl/techniken/ciasto).`,
    ...
    ingredients: [
      ...
      {
        id: "pc-filling-oil",
        name: { de: "Öl zum Dünsten", pl: "Olej do duszenia" },
        amount: 2,
        unit: { de: "EL", pl: "łyżki" },
        group: "pantry",
        section: "filling",
