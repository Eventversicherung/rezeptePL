...
export const seedFamilyVariantRecipes: Recipe[] = [
  {
    ...
    status: "published",
    coverImage:
      "https://images.unsplash.com/photo-1766309498484-a781ddb7e74c?w=1600&q=80",
    prepMinutes: 50,
    cookMinutes: 25,
    servings: 4,
    ...
    variantImage:
      "https://images.unsplash.com/photo-1766309498484-a781ddb7e74c?w=400&q=80",
    regionIds: [],
    occasionIds: ["occasion-niedziela"],
    techniqueIds: ["technique-teig", "technique-freezer"],
...
Przełącz u góry na [ruskie](/pl/rezepte/pierogi/ruskie), [kapustę z grzybami](/pl/rezepte/pierogi/kapusta-grzyby) albo [jagody](/pl/rezepte/pierogi/jagody). Technika: [ciasto](/pl/techniken/ciasto). Guide: [ciasto na pierogi](/pl/blog/ciasto-na-pierogi) · [robot do ciasta](/pl/blog/robot-do-ciasta-pierogi).`,
  ...
  },
  {
    ...
    status: "published",
    coverImage:
      "https://images.unsplash.com/photo-1766309416197-5982d32f4ce0?w=1600&q=80",
    prepMinutes: 55,
    cookMinutes: 25,
    servings: 4,
    familyId: "family-pierogi",
    ...
    variantImage:
      "https://images.unsplash.com/photo-1766309416197-5982d32f4ce0?w=400&q=80",
    regionIds: [],
...
[Ruskie](/pl/rezepte/pierogi/ruskie) · [mięso](/pl/rezepte/pierogi/mieso) · [jagody](/pl/rezepte/pierogi/jagody) · [menu wigilijne](/pl/blog/menu-wigilijne) · [ciasto](/pl/techniken/ciasto)`,
  ...
  },
  {
    ...
    status: "published",
    coverImage:
      "https://images.unsplash.com/photo-1607095591644-9f97a2099c92?w=1600&q=80",
    prepMinutes: 25,
    cookMinutes: 25,
    servings: 4,
    ...
    variantImage:
      "https://images.unsplash.com/photo-1607095591644-9f97a2099c92?w=400&q=80",
    regionIds: [],
    occasionIds: ["occasion-niedziela"],
    techniqueIds: ["technique-panieren"],
    categoryIds: [
...
Przełącz u góry: [ziemniaczane](/pl/rezepte/placki/ziemniaczane), [ser](/pl/rezepte/placki/ser), [jabłka](/pl/rezepte/placki/jablka). [Przewodnik placki](/pl/blog/placki-przewodnik).`,
  ...
  },
  {
    ...
    status: "published",
    coverImage:
      "https://images.unsplash.com/photo-1678684277271-aa9fc6d3bca0?w=1600&q=80",
    prepMinutes: 25,
    cookMinutes: 25,
    servings: 4,
    familyId: "family-placki",
    ...
    variantImage:
      "https://images.unsplash.com/photo-1678684277271-aa9fc6d3bca0?w=400&q=80",
    regionIds: [],
    occasionIds: ["occasion-niedziela"],
    techniqueIds: ["technique-panieren"],
...
[Ziemniaczane](/pl/rezepte/placki/ziemniaczane) · [cukinia](/pl/rezepte/placki/cukinia) · [jabłka](/pl/rezepte/placki/jablka).`,
  ...
  },
  {
    ...
    status: "published",
    coverImage:
      "https://images.unsplash.com/photo-1476877249698-58c37406aa43?w=1600&q=80",
    prepMinutes: 25,
    cookMinutes: 20,
    servings: 4,
    familyId: "family-placki",
    ...
    variantImage:
      "https://images.unsplash.com/photo-1476877249698-58c37406aa43?w=400&q=80",
    regionIds: [],
    occasionIds: [],
    techniqueIds: ["technique-panieren"],
    categoryIds: [
...
[Ziemniaczane](/pl/rezepte/placki/ziemniaczane) · [cukinia](/pl/rezepte/placki/cukinia) · [ser](/pl/rezepte/placki/ser).`,
  ...
  },
  {
    ...
    status: "published",
    coverImage:
      "https://images.unsplash.com/photo-1761095596614-31172e9822e0?w=1600&q=80",
    prepMinutes: 35,
    cookMinutes: 30,
    servings: 4,
    ...
    variantLabel: { de: "Fleisch", pl: "z mięsem" },
    variantImage:
      "https://images.unsplash.com/photo-1761095596614-31172e9822e0?w=400&q=80",
    regionIds: [],
    occasionIds: ["occasion-niedziela"],
    techniqueIds: ["technique-teig", "technique-freezer"],
    categoryIds: ["category-hauptgerichte"],
...
Przełącz na [twaróg](/pl/rezepte/nalesniki/twarog), [szpinak](/pl/rezepte/nalesniki/szpinak) albo [dżem](/pl/rezepte/nalesniki/dzem).`,
  ...
  },
  {
    ...
    status: "published",
    coverImage:
      "https://images.unsplash.com/photo-1677844592730-ce9c936d8f1a?w=1600&q=80",
    prepMinutes: 25,
    cookMinutes: 25,
    servings: 4,
    familyId: "family-nalesniki",
    ...
    variantImage:
      "https://images.unsplash.com/photo-1677844592730-ce9c936d8f1a?w=400&q=80",
    regionIds: [],
    occasionIds: [],
