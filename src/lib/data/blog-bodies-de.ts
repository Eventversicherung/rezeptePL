...
Für 1–1,5 kg Mehl eher 5–6 Liter nutzbar, nicht nur Nennmaß. Teig braucht Raum. Zwei Chargen in einer mittelgroßen Schüssel sind besser als eine überfüllte. Plant die Menge über den [Wigilia Speiseplan](/de/blog/wigilia-speiseplan) und knetet portionsweise. So bleibt der Motor kühl und der Teig gleichmäßig. Parallel Füllungen vorbereiten, damit die Formstation fließt.
...
9. [Kutia](/de/rezepte/kutia) — Weizenkörner+Mohn+Honig (≠ Nudeln/[Makaron z makiem](/de/rezepte/makaron-z-makiem); Speiseplan bleibt Anlass-Owner)
