...
export const W13_FACTS_C: Record<string, ArticleFacts> = {
  "recipe-chalka": {
    ...
    diasporaDe:
      "In DE oft Samstag backen, Sonntag nur schneiden — entlastet den Ostermorgen. Kinder dürfen Stränge rollen; heißer Ofen bei Erwachsenen. Ein Laib reicht für viele Gäste; Qualität vor drei verschiedenen Hefegebäcken. Einkauf früh im [Polenladen](/de/blog/polenladen-einkaufen). Speiseplan nicht als Rezeptseite beanspruchen — [Wielkanoc](/de/blog/wielkanoc-speiseplan) bleibt Anlass.",
    diasporaPl:
      "W DE często piecz sobotę, niedzielę tylko kroić — odciąża poranek. Dzieci uwałkują wałki; gorący piec u dorosłych. Jeden bochenek wystarczy dla gości; jakość przed trzema wypiekami drożdżowymi. Zakupy wcześniej w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Nie rość o rozróżnienie menu — [menu wielkanocne](/pl/blog/menu-wielkanocne) zostaje okazją.",
    mistakesDe:
      "Zu heiße Milch (Hefe tot). Gugelhupf-Form statt Zopf → Clash mit [Babka](/de/rezepte/babka). Mit [Pączki](/de/rezepte/paczki) oder [Racuchy](/de/rezepte/racuchy-jablka) verwechseln. Zu kurzes Gehen. Speiseplan-Abgrenzung beanspruchen statt [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    mistakesPl:
  ...
  "recipe-pasztet": {
    ...
    serveDe:
      "Kalt in Scheiben auf Platte mit Brot, Meerrettich, Senf, optional Gurke. Festbuffet neben [Wielkanoc](/de/blog/wielkanoc-speiseplan); Alltag: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Nicht mit [Kaszanka](/de/rezepte/kaszanka) mischen — anderer Intent. Reste luftdicht kühlen, zeitnah verbrauchen.",
    servePl:
