...
export const W13_FACTS_C: Record<string, ArticleFacts> = {
 ...
 shopDe:
 "Nimm Geflügelleber (frisch oder TK), Zwiebel, Karotte, Butter, Eier, altes Brötchen und Majeranek — Leber und Majeranek oft im [Polenladen](/de/blog/polenladen-einkaufen). Meerrettich oder Senf zum Servieren. Wer Blutwurst sucht, bleibt bei [Kaszanka](/de/rezepte/kaszanka); wer paniertes Hack will: [Kotlet mielony](/de/rezepte/kotlet-mielony). Aufschnitt-Kontext: [Kiełbasa-Arten](/de/blog/kielbasa-arten).",
 shopPl:
 "Weź wątróbkę drobiową (świeżą lub mrożoną), cebulę, marchew, masło, jajka, czerstwą bułkę i majeranek — wątróbkę i majeranek często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Chrzan lub musztarda do podania. Kto szuka kaszanki, zostaje przy [kaszance](/pl/rezepte/kaszanka); kto panierowane mielone — przy [kotlecie mielonym](/pl/rezepte/kotlet-mielony). Kontekst wędlin: [rodzaje kiełbasy](/pl/blog/rodzaje-kielbasy).",
 techniqueDe:
 ...
 mistakesPl:
 "Wygotowana wątróbka robi się sucha i gorzka. Mylenie z [kaszanką](/pl/rezepte/kaszanka) lub [kotletem mielonym](/pl/rezepte/kotlet-mielony) gubi formę. Krojenie na ciepło kruszy plaster. Rodzaje kiełbasy opisuje osobny [przewodnik](/pl/blog/rodzaje-kielbasy); menu wielkanocne zostaje przy [menu wielkanocnym](/pl/blog/menu-wielkanocne).",
 variantsDe:
