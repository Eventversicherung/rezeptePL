...
export const W13_FACTS_C: Record<string, ArticleFacts> = {
  ...
  "recipe-pasztet": {
    ...
    mistakesDe:
      "Leber verkochen (trocken/bitter). Mit [Kaszanka](/de/rezepte/kaszanka) oder [Kotlet mielony](/de/rezepte/kotlet-mielony) verwechseln. Warm schneiden. Kiełbasa-Arten-Hitze, Feuchtigkeit oder Garzeit falsch einschätzen. Den Speiseplan hier nicht ersetzen — dafür gibt es [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    mistakesPl:
