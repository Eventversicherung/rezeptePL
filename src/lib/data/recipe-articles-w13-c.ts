...
export const W13_FACTS_C: Record<string, ArticleFacts> = {
  "recipe-chalka": {
    ...
    shopPl:
      "Mąka, mleko, drożdże, cukier, jajka, masło, sól, opcjonalnie sezam — sezam i dobre drożdże często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Brak: uczciwa zamiana według [zamienników](/pl/blog/zamienniki-skladnikow). Wyczucie drożdży opisowo: [technika makowca](/pl/blog/makowiec-technika), bez kradzieży primary makowca/babki. Forma: blacha i warkocz — nie forma babkowa jak [babka](/pl/rezepte/babka).",
    techniqueDe:
    ...
    serveDe:
      "In Scheiben mit Butter, Konfitüre oder zum Ostertisch neben Eiern und Wurst. Menüplatz descriptiv: [Wielkanoc](/de/blog/wielkanoc-speiseplan) oder [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Wer Formkuchen will: [Babka](/de/rezepte/babka). Wer frittierte Krapfen: [Pączki](/de/rezepte/paczki). Reste luftdicht — toasten am Folgetag.",
    servePl:
      "W kromki z masłem, konfiturą albo przy stole obok jaj i wędlin. Miejsce w menu opisowo: [menu wielkanocne](/pl/blog/menu-wielkanocne) lub [obiad niedzielny](/pl/blog/obiad-niedzielny). Forma: [babka](/pl/rezepte/babka). Smażone: [pączki](/pl/rezepte/paczki). Resztki szczelnie — nazajutrz tosty.",
    diasporaDe:
      "In DE oft Samstag backen, Sonntag nur schneiden — entlastet den Ostermorgen. Kinder dürfen Stränge rollen; heißer Ofen bei Erwachsenen. Ein Laib reicht für viele Gäste; Qualität vor drei verschiedenen Hefegebäcken. Einkauf früh im [Polenladen](/de/blog/polenladen-einkaufen). Speiseplan nicht als Cook-Owner beanspruchen — [Wielkanoc](/de/blog/wielkanoc-speiseplan) bleibt Anlass.",
    diasporaPl:
      "W DE często piecz sobotę, niedzielę tylko kroić — odciąża poranek. Dzieci uwałkują wałki; gorący piec u dorosłych. Jeden bochenek wystarczy dla gości; jakość przed trzema wypiekami drożdżowymi. Zakupy wcześniej w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Nie rość o ownership menu — [menu wielkanocne](/pl/blog/menu-wielkanocne) zostaje okazją.",
    mistakesDe:
      "Zu heiße Milch (Hefe tot). Gugelhupf-Form statt Zopf → Clash mit [Babka](/de/rezepte/babka). Mit [Pączki](/de/rezepte/paczki) oder [Racuchy](/de/rezepte/racuchy-jablka) verwechseln. Zu kurzes Gehen. Speiseplan-Ownership beanspruchen statt [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    mistakesPl:
      "Za gorące mleko (zabite drożdże). Forma babkowa zamiast warkocza → clash z [babką](/pl/rezepte/babka). Mylenie z [pączkami](/pl/rezepte/paczki) lub [racuchami](/pl/rezepte/racuchy-jablka). Za krótkie wyrastanie. Roszczenie ownership menu zamiast [menu wielkanocnego](/pl/blog/menu-wielkanocne).",
    variantsDe:
  ...
  "recipe-pasztet": {
    ...
    originDe:
      "Pasztet ist der Cook-Intent für die gebackene Haus-Pastete der polnischen Fest- und Sonntagsküche — hier die klare Linie drobiowy: Geflügelleber mit Zwiebel, Karotte, Ei und Brötchen, im Kasten gebacken, kalt angeschnitten. Das ist weder die gebratene Blutwurst [Kaszanka](/de/rezepte/kaszanka) noch der panierte [Kotlet mielony](/de/rezepte/kotlet-mielony) noch Kugeln in Soße ([Klopsy](/de/rezepte/klopsy)). Arten und Qualitätslesen von Wurst bleiben im [Kiełbasa-Arten-Lexikon](/de/blog/kielbasa-arten) — hier nur der Pasteten-Cook. Menüplatz descriptiv: [Sonntagsessen](/de/blog/sonntagsessen-polnisch) oder [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    originPl:
      "Pasztet to intent cook: pieczona pasteta domowa kuchni świątecznej i niedzielnej — tu jasna linia drobiowa: wątróbka z cebulą, marchewką, jajkiem i bułką, w keksówce, zimna pokrojona. To ani smażona [kaszanka](/pl/rezepte/kaszanka), ani panierowany [kotlet mielony](/pl/rezepte/kotlet-mielony), ani kulki w sosie ([klopsy](/pl/rezepte/klopsy)). Typy i jakość wędlin zostają w [leksykonie rodzajów kiełbasy](/pl/blog/rodzaje-kielbasy) — tu tylko cook pasztetu. Miejsce w menu opisowo: [obiad niedzielny](/pl/blog/obiad-niedzielny) lub [menu wielkanocne](/pl/blog/menu-wielkanocne).",
    shopDe:
      "Geflügelleber frisch oder TK, Zwiebel, Karotte, Butter, Eier, altes Brötchen, Majeranek — Leber und Majeranek oft im [Polenladen](/de/blog/polenladen-einkaufen). Meerrettich/Senf zum Servieren. Wer Blutwurst sucht, bleibt bei [Kaszanka](/de/rezepte/kaszanka). Wer paniertes Hack will: [Kotlet mielony](/de/rezepte/kotlet-mielony). Aufschnitt-Kontext ohne Primary-Steal: [Kiełbasa-Arten](/de/blog/kielbasa-arten).",
    shopPl:
      "Wątróbka drobiowa świeża lub mrożona, cebula, marchew, masło, jajka, czerstwa bułka, majeranek — wątróbka i majeranek często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Chrzan/musztarda do podania. Kto szuka kaszanki: [kaszanka](/pl/rezepte/kaszanka). Panierowane mielone: [kotlet mielony](/pl/rezepte/kotlet-mielony). Kontekst wędlin bez kradzieży primary: [rodzaje kiełbasy](/pl/blog/rodzaje-kielbasy).",
    techniqueDe:
    ...
    serveDe:
      "Kalt in Scheiben auf Platte mit Brot, Meerrettich, Senf, optional Gurke. Festbuffet descriptiv neben [Wielkanoc](/de/blog/wielkanoc-speiseplan); Alltag: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Nicht mit [Kaszanka](/de/rezepte/kaszanka) mischen — anderer Intent. Reste luftdicht kühlen, zeitnah verbrauchen.",
    servePl:
      "Zimny w plasterkach na półmisku z chlebem, chrzanem, musztardą, opcjonalnie ogórkiem. Bufet opisowo obok [menu wielkanocnego](/pl/blog/menu-wielkanocne); codzienność: [obiad niedzielny](/pl/blog/obiad-niedzielny). Nie mieszać z [kaszanką](/pl/rezepte/kaszanka). Resztki szczelnie w lodówce, zużyć szybko.",
    diasporaDe:
    ...
    mistakesDe:
      "Leber verkochen (trocken/bitter). Mit [Kaszanka](/de/rezepte/kaszanka) oder [Kotlet mielony](/de/rezepte/kotlet-mielony) verwechseln. Warm schneiden. Kiełbasa-Arten-Primary stehlen statt descriptiv [Kiełbasa-Arten](/de/blog/kielbasa-arten). Speiseplan-Ownership beanspruchen statt [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    mistakesPl:
      "Wygotowana wątróbka (sucha/gorzka). Mylenie z [kaszanką](/pl/rezepte/kaszanka) lub [kotletem mielonym](/pl/rezepte/kotlet-mielony). Krojenie na ciepło. Kradzież primary rodzajów kiełbasy zamiast opisowo [rodzaje kiełbasy](/pl/blog/rodzaje-kielbasy). Roszczenie menu zamiast [menu wielkanocnego](/pl/blog/menu-wielkanocne).",
    variantsDe:
