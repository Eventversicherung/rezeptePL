...
export const W15_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-galareta": {
    ...
    diasporaDe:
      "In DE retten nóźki aus dem Polenladen oft den Kollagen-Job, wenn Supermarkt-Haxe allein zu mager ist. Lange Kochzeit am Vortag, Kühlschrank über Nacht — der Festtag selbst bleibt ruhig. Kein Affiliate-Zwang: Topf, Sieb, Formen reichen. Einkauf: [Polenladen](/de/blog/polenladen-einkaufen). Ersatz: [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Kultur-Nachbarn: [Wielkanoc](/de/blog/wielkanoc-speiseplan), [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    diasporaPl:
      "W DE nóżki ze sklepu polskiego często ratują kolagen, gdy sama golonka z marketu jest zbyt chuda. Długie gotowanie dzień wcześniej, lodówka na noc — sam dzień świąt zostaje spokojny. Bez affiliate: garnek, sito, foremki wystarczą. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy). Zamienniki: [zamienniki składników](/pl/blog/zamienniki-skladnikow). Sąsiedzi kultury: [menu wielkanocne](/pl/blog/menu-wielkanocne), [obiad niedzielny](/pl/blog/obiad-niedzielny).",
    mistakesDe:
    ...
    variantsDe:
      "Mehr Knoblauch schärfer; mit Karottenscheiben in der Form; milder mit weniger Piment. Pastete bleibt [Pasztet](/de/rezepte/pasztet). Festsalat: [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa). Buffet-Nachbar: [Jajka faszerowane](/de/rezepte/jajka-faszerowane). Anlass: [Wielkanoc](/de/blog/wielkanoc-speiseplan), [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    variantsPl:
  ...
  "recipe-salatka-sledziowa": {
    ...
    diasporaDe:
      "In DE rettet der Mayo-Heringssalat oft den Buffet-Slot, wenn Öl-Hering schon auf dem Tisch steht — zwei Intents, ein Fisch. Matjes aus dem Glas und gute Supermarkt-Mayo sind diaspora-ehrlich. Einkauf: [Polenladen](/de/blog/polenladen-einkaufen). Ersatz: [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Menü-Nachbar: [Wigilia](/de/blog/wigilia-speiseplan).",
    diasporaPl:
      "W DE majonezowa sałatka śledziowa często ratuje slot bufetowy, gdy śledź w oleju już stoi na stole — dwa intent, jedna ryba. Matjasy ze słoika i dobry majonez z marketu są uczciwe w diasporze. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy). Zamienniki: [zamienniki składników](/pl/blog/zamienniki-skladnikow). Sąsiad menu: [menu wigilijne](/pl/blog/menu-wigilijne).",
    mistakesDe:
    ...
    variantsDe:
      "Mehr Apfel süßer; mehr Gurke säuerlicher; mit Śmietana leichter. Öl-Linie: [Śledź](/de/rezepte/sledz). Festgemüse: [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa). Anlass: [Wigilia](/de/blog/wigilia-speiseplan). Alltag: [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    variantsPl:
      "Z większą ilością jabłka słodziej; z większą ilością ogórka kwaśniej; ze śmietaną lżej. Linia oleju: [śledź](/pl/rezepte/sledz). Warzywa: [sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa). Okazja: [menu wigilijne](/pl/blog/menu-wigilijne). Dzień: [obiad niedzielny](/pl/blog/obiad-niedzielny). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow).",
  },
};
