...
export const W10_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-makaron-z-serem": {
    ...
    mistakesDe:
      "Zu nasser Quark (Brei). Frischkäse als 1:1-Ersatz. Mit Leniwe verwechseln (Teig kochen statt Pasta). Mit Łazanki verwechseln (Kapusta). Zu viel Nudelwasser → Suppe. Zucker vor dem Binden in großen Mengen — schwer zu korrigieren. Abgrenzung stehlen vom [Twaróg-Guide](/de/blog/twarog-deutschland) — nein, dort bleibt Zutaten-Guide.",
    mistakesPl:
      "Za mokry twaróg (papka). Serek kremowy 1:1. Mylenie z leniwymi (ciasto zamiast makaronu). Mylenie z łazankami (kapusta). Za dużo wody → zupa. Dużo cukru przed związaniem — trudno cofnąć. Nie mieszać ilości i kroków z sąsiednim przepisem. nie, tam zostaje przewodnikiem po składniku.",
    variantsDe:
