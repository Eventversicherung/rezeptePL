...
export const W10_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-makaron-z-serem": {
    ...
    mistakesDe:
      "Zu nasser Quark (Brei). Frischkäse als 1:1-Ersatz. Mit Leniwe verwechseln (Teig kochen statt Pasta). Mit Łazanki verwechseln (Kapusta). Zu viel Nudelwasser wird zur Suppe. Zucker vor dem Binden in großen Mengen — schwer zu korrigieren. Den Überblick nicht ersetzen vom [Twaróg-Guide](/de/blog/twarog-deutschland) — nein, dort bleibt Zutaten-Guide.",
    mistakesPl:
      "Za mokry twaróg (papka). Serek kremowy 1:1. Mylenie z leniwymi (ciasto zamiast makaronu). Mylenie z łazankami (kapusta). Za dużo wody robi się zupa. Dużo cukru przed związaniem — trudno cofnąć. Nie mieszać ilości i kroków z sąsiednim przepisem. nie, tam zostaje przewodnikiem po składniku.",
    variantsDe:
      "Süß klassisch; salzig mit Dill; mit gerösteten Bröseln; mit einem Klecks Śmietana am Rand ( Fokus bleibt Pasta+Quark). Teig-Nachbar: [Pierogi leniwe](/de/rezepte/pierogi-leniwe). Herzhafter Pasta-Nachbar mit Kraut: [Łazanki](/de/rezepte/lazanki). Beilage-Kartoffel-Teig: [Kopytka](/de/rezepte/kopytka). Wigilia-Mohn-Pasta (≠ Twaróg): [Makaron z makiem](/de/rezepte/makaron-z-makiem). Im [Polenladen](/de/blog/polenladen-einkaufen) und unter [Ersatzprodukte](/de/blog/ersatzprodukte-de) findest du Einkaufshilfen.",
    variantsPl:
      "Słodko klasycznie; wytrawnie z koperkiem; z bułką na maśle; z łyżką śmietany z boku (tu zostaje makaron+twaróg). Sąsiad ciasta: [pierogi leniwe](/pl/rezepte/pierogi-leniwe). Makaron z kapustą: [łazanki](/pl/rezepte/lazanki). Kluski ziemniaczane: [kopytka](/pl/rezepte/kopytka). Wigilijny makaron z makiem (≠ twaróg): [makaron z makiem](/pl/rezepte/makaron-z-makiem). W [sklep polski](/pl/blog/sklep-polski-zakupy) i pod [zamienniki](/pl/blog/zamienniki-skladnikow) znajdziesz wskazówki zakupowe.",
  },
};
