...
export const W10_FACTS_D: Record<string, ArticleFacts> = {
 ...
 mistakesDe:
 "Zu nasser Quark (Brei). Frischkäse als 1:1-Ersatz. Mit Leniwe verwechseln (Teig kochen statt Pasta). Mit Łazanki verwechseln (Kapusta). Zu viel Nudelwasser wird zur Suppe. Zucker vor dem Binden in großen Mengen — schwer zu korrigieren. Den Überblick nicht ersetzen vom [Twaróg-Guide](/de/blog/twarog-deutschland) —",
 mistakesPl:
