...
export const W10_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-makaron-z-serem": {
    ...
    variantsDe:
      "Süß klassisch; salzig mit Dill; mit gerösteten Bröseln; mit einem Klecks Śmietana am Rand (descriptiv, Primary bleibt Pasta+Quark). Teig-Nachbar: [Pierogi leniwe](/de/rezepte/pierogi-leniwe). Herzhafter Pasta-Nachbar mit Kraut: [Łazanki](/de/rezepte/lazanki). Beilage-Kartoffel-Teig: [Kopytka](/de/rezepte/kopytka). Wigilia-Mohn-Pasta (≠ Twaróg): [Makaron z makiem](/de/rezepte/makaron-z-makiem). Einkauf und Ersatz: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    variantsPl:
