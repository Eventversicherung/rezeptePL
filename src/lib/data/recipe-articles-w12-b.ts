...
export const W12_FACTS_B: Record<string, ArticleFacts> = {
 ...
 originDe:
 "Makaron z makiem ist gekochte Nudeln mit Mohnmasse — Butter, Zucker, oft Rosinen — und bewusst keine gerollte Hefe-Mohnrolle. [Makowiec](/de/rezepte/makowiec) bleibt die Mohnrolle und das Wigilia-Backprojekt; Technik erklärt [Makowiec-Technik](/de/blog/makowiec-technik). Parallel klar getrennt von [Makaron z serem](/de/rezepte/makaron-z-serem): dort Twaróg, hier gemahlener Mohn. Am [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan) ist das oft die machbare Mohnspeise, wenn niemand noch eine Rolle führen will. In der Diaspora ist es der Mohn-Teller unter einer Stunde: Nudeln kochen, Masse binden, vermengen.",
 originPl:
 "Makaron z makiem to ugotowany makaron z masą makową — masło, cukier, często rodzynki — świadomie nie zwijana rolada drożdżowa. [Makowiec](/pl/rezepte/makowiec) zostaje rolką i projektem wigilijnym; technikę opisuje [technika makowca](/pl/blog/makowiec-technika). Równolegle osobno od [makaronu z serem](/pl/rezepte/makaron-z-serem): tam twaróg, tu mielony mak. W [menu wigilijnym](/pl/blog/menu-wigilijne) bywa wykonalną mąką, gdy nikt nie chce już rolki. W diasporze to talerz makowy poniżej godziny: ugotować makaron, spiąć masę, wymieszać.",
 shopDe:
 ...
 originDe:
 "Szarlotka ist der polnische Apfelkuchen — typisch Mürbeteig vom Blech oder aus der Form, saftige Äpfel, oft mit Streusel oder Deckel — und bewusst kein Hefe-Pfannkuchen. [Racuchy z jabłkami](/de/rezepte/racuchy-jablka) bleiben Apfel-Hefe in der Pfanne; [Piernik](/de/rezepte/piernik) der Honig-Gewürz-Lebkuchen; [Sernik](/de/rezepte/sernik) der Käsekuchen; [Babka](/de/rezepte/babka) der Hefegugelhupf. Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der ruhige Kaffee-Schluss sein. Eng bei Szarlotka bleiben, nicht bei generischem Apfelkuchen.",
 originPl:
 "Szarlotka to polskie ciasto jabłkowe — typowo kruche z blachy lub formy, soczyste jabłka, często z kruszonką lub pokrywą — świadomie nie drożdżowy placek z patelni. [Racuchy z jabłkami](/pl/rezepte/racuchy-jablka) zostają jabłkami na drożdżach na patelni; [piernik](/pl/rezepte/piernik) piernikiem; [sernik](/pl/rezepte/sernik) sernikiem; [babka](/pl/rezepte/babka) babką drożdżową. Przy [obiedzie niedzielnym](/pl/blog/obiad-niedzielny) bywa spokojnym domknięciem przy kawie. Trzymaj się szarlotki, nie generycznego ciasta jabłkowego.",
 shopDe:
 "Für den Boden brauchst du Mehl (405/550), kalte Butter, Zucker und Ei; für die Füllung säuerliche Äpfel, Zimt und Zitrone — optional Semmelbrösel gegen Saft. Basis im Supermarkt; Zimt und manchmal bessere Äpfel findest du im [Polenladen](/de/blog/polenladen-einkaufen). Hefe-Pfannkuchen mit Apfel bleiben bei [Racuchy](/de/rezepte/racuchy-jablka); Honig-Gewürz bei [Piernik](/de/rezepte/piernik).",
 shopPl:
 "Na spód potrzebujesz mąki (405/550), zimnego masła, cukru i jajka; na farsz kwaskowych jabłek, cynamonu i cytryny — opcjonalnie bułka tarta na sok. Baza w markecie; cynamon i czasem lepsze jabłka w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Placki drożdżowe z jabłkiem zostają przy [racuchach](/pl/rezepte/racuchy-jablka); miód i przyprawy przy [pierniku](/pl/rezepte/piernik).",
 techniqueDe:
 ...
 mistakesPl:
 "Mylenie z racuchami (patelnia i drożdże) gubi formę. Zbyt ciepłe wyrabianie masła; zbyt słodkie jabłka bez kwasu; mokry spód od soku; zbyt wczesne krojenie. Generyczny apple pie zamiast szarlotki też mija cel.",
 variantsDe:
