...
export const W12_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-makaron-z-makiem": {
    ...
    originDe:
      "Makaron z makiem ist die Cook-Intent-Money-Page für gekochte Nudeln mit Mohnmasse — Butter, Zucker, oft Rosinen — und bewusst keine gerollte Hefe-Mohnrolle. [Makowiec](/de/rezepte/makowiec) bleibt Owner der Spirale und des Wigilia-Backprojekts; der Technik-Pillar bleibt [Makowiec-Technik](/de/blog/makowiec-technik). Parallel klar getrennt von [Makaron z serem](/de/rezepte/makaron-z-serem): dort Twaróg und Butter/Zucker als Pasta+Quark-Linie, hier trägt gemahlener Mohn den Charakter. Am [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan) steht Makaron z makiem oft als machbare Mohnspeise, wenn niemand noch eine Rolle führen will — der Speiseplan bleibt Anlass-Owner, hier nur Mengen und Schritte. In der Diaspora ist das der Mohn-Teller, der in unter einer Stunde fertig ist: Nudeln kochen, Masse binden, vermengen. Kein Hefeteig, kein Rollen, kein Ofengeduld-Marathon.",
    originPl:
      "Makaron z makiem to money-page cook-intent: ugotowany makaron z masą makową — masło, cukier, często rodzynki — świadomie nie zwijana rolada drożdżowa. [Makowiec](/pl/rezepte/makowiec) zostaje ownerem spirali i projektu pieczenia; filar techniki zostaje przy [technice makowca](/pl/blog/makowiec-technika). Równolegle jasno osobno od [makaronu z serem](/pl/rezepte/makaron-z-serem): tam twaróg i masło/cukier jako linia pasta+twaróg, tu charakter niesie mielony mak. Przy [menu wigilijnym](/pl/blog/menu-wigilijne) bywa wykonalną potrawą makową, gdy nikt nie chce już prowadzić rolady — artykuł menu zostaje ownerem okazji, tu tylko ilości i kroki. W diasporze to talerz maku gotowy poniżej godziny: ugotować makaron, związać masę, wymieszać. Bez drożdży, bez zwijania, bez maratonu pieca.",
    shopDe:
    ...
    techniqueDe:
      "Nudeln al dente, Mohn mit heißer Flüssigkeit aufquellen, abtropfen, mit Zucker und Butter zu einer streichfähigen Masse binden — nicht tropfen, nicht sandig-trocken. Heiß vermengen; Nudelwasser nur sparsam. Bitterkeit kommt oft von altem Mohn oder zu starkem Rösten — frische Samen prüfen. Masse-Logik darf descriptiv an [Makowiec-Technik](/de/blog/makowiec-technik) anknüpfen, ohne Primary „Mohnkuchen backen“ zu stehlen. Kein Rollen, kein Ofenschritt: fertig im Topf.",
    techniquePl:
      "Makaron al dente, mak zalać gorącym płynem, odsączyć, związać cukrem i masłem do masy smarownej — nie cieknie, nie jest sucha jak piasek. Mieszać na gorąco; wody z gotowania tylko odrobinę. Gorycz często ze starego maku lub zbyt mocnego prażenia — sprawdź świeżość. Logika masy może opisowo nawiązać do [techniki makowca](/pl/blog/makowiec-technika), bez kradzieży primary „pieczenia ciasta makowego”. Bez zwijania i pieca: gotowe w garnku.",
    serveDe:
      "Warm auf Tellern, oft mit Puderzucker, als süßer Gang oder Mohnspeise am [Wigilia](/de/blog/wigilia-speiseplan)-Tisch neben Kompot und Fisch — Menü-Owner bleibt der Speiseplan. Abgrenzung klar: Scheiben mit Spirale = [Makowiec](/de/rezepte/makowiec); cremige Pasta mit Quark = [Makaron z serem](/de/rezepte/makaron-z-serem). Reste kalt oder kurz in Butter in der Pfanne; nicht erneut hart kochen.",
    servePl:
      "Ciepło na talerzach, często z cukrem pudrem, jako słodki element lub potrawa makowa przy [menu wigilijnym](/pl/blog/menu-wigilijne) obok kompotu i ryby — owner menu zostaje przy artykule. Na stole: plastry ze spiralą = [makowiec](/pl/rezepte/makowiec); kremowy makaron z twarogiem = [makaron z serem](/pl/rezepte/makaron-z-serem). Resztki na zimno albo krótko na maśle; nie gotować ponownie na twardo.",
    diasporaDe:
      "In deutschen Küchen rettet Makaron z makiem oft den 24. Dezember, wenn der Ofen schon voll ist und niemand Hefe führen will: ein Topf Nudeln, eine Schüssel Masse, fertig. Mohn aus dem Polenladen halten; Kinder dürfen streuen und rühren — heißer Topf bei Erwachsenen. Kein Affiliate-Zwang: gute Standardnudeln und frischer Mohn reichen. Technik-Nachbar descriptiv: [Makowiec-Technik](/de/blog/makowiec-technik).",
    diasporaPl:
      "W niemieckich kuchniach makaron z makiem często ratuje 24 grudnia, gdy piec jest zajęty i nikt nie chce prowadzić drożdży: jeden garnek makaronu, jedna miska masy, gotowe. Mak ze sklepu polskiego; dzieci mogą sypać i mieszać — gorący garnek u dorosłych. Bez affiliate: dobry zwykły makaron i świeży mak wystarczą. Sąsiad techniki opisowo: [technika makowca](/pl/blog/makowiec-technika).",
    mistakesDe:
      "Mit Makowiec verwechseln (Rolle statt Pasta). Mit Makaron z serem verwechseln (Quark statt Mohn). Zu trockene, sandige Masse; bitterer alter Mohn; zu viel Nudelwasser → Suppe; Speiseplan-Mengen hier duplizieren statt zu verlinken. Hefe oder Ofenschritt als Primary erfinden.",
    mistakesPl:
  ...
  "recipe-szarlotka": {
    ...
    originDe:
      "Szarlotka ist der polnische Apfelkuchen — typisch Mürbeteig vom Blech oder aus der Form, saftige Äpfel, oft mit Streusel oder Deckel — und bewusst kein Hefe-Pfannkuchen. [Racuchy z jabłkami](/de/rezepte/racuchy-jablka) bleiben Owner der Apfel-Hefe in der Pfanne; [Piernik](/de/rezepte/piernik) dem Honig-Gewürz-Lebkuchen; [Sernik](/de/rezepte/sernik) dem Käsekuchen; [Babka](/de/rezepte/babka) dem Hefegugelhupf. Hier tragen Apfel und kurzer Teig den Intent „polnischer Apfelkuchen / Szarlotka“. Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der ruhige Kaffee-Schluss sein — Kultur-Owner bleibt der Guide, Cook-Primary diese URL. Kein generisches „beste Apple Pie“-SEO: eng bei Szarlotka bleiben.",
    originPl:
      "Szarlotka to polskie ciasto jabłkowe — typowo kruche z blachy lub formy, soczyste jabłka, często z kruszonką lub pokrywą — świadomie nie drożdżowy placek z patelni. [Racuchy z jabłkami](/pl/rezepte/racuchy-jablka) zostają ownerem jabłka na drożdżach na patelni; [piernik](/pl/rezepte/piernik) piernika miodowo-korzennego; [sernik](/pl/rezepte/sernik) sernika; [babka](/pl/rezepte/babka) babki drożdżowej. Tu jabłko i krótkie ciasto niosą intent „szarlotka / polskie ciasto jabłkowe”. Przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) bywa spokojnym domknięciem przy kawie — owner kultury zostaje przy guide, cook-primary przy tej URL. Bez generycznego SEO „best apple pie”: wąsko przy szarlotce.",
    shopDe:
    ...
    serveDe:
      "In Stücken, oft mit Puderzucker, zu Tee oder Kaffee. Als Sonntagsschluss descriptiv unter [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Abgrenzung auf dem Tisch: Apfel in der Pfanne = [Racuchy](/de/rezepte/racuchy-jablka); Gewürz-Honig = [Piernik](/de/rezepte/piernik); Quarkkuchen = [Sernik](/de/rezepte/sernik). Hält ein bis zwei Tage gut abgedeckt; Freezer möglich in Stücken.",
    servePl:
