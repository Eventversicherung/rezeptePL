...
![Złocisty kotlet schabowy z chrupiącą panierką](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-schabowy/c2614c7e-bc01-4c37-a0b8-45b4c581ec92.webp "Panierka chroni sok. Temperatura i odpoczynek decydują mocniej niż sam przepis.")

## Przygotowanie mięsa: rozbicie, grubość, sól

**Wybór mięsa:** Schab bez kości, równy placek, w DE często „Schweineschnitzel natur” albo „Schweinerücken“. Grubość przed rozbiciem ok. 1 do 1,5 cm; po rozbiciu ok. 4 do 6 mm. Za gruby środek = surowy rdzeń przy zbyt krótkim smażeniu. Za cienki = suszone płaty.
...
**Odpoczynek:** Mięso po doprawieniu 10 do 15 minut w lodówce, sól wchodzi, skrócony czas na patelni. Nie godziny, zbyt długo = za dużo wody na powierzchni.
...
**Ogień:** Średnio-wysoki na start, złota skorupa, potem **średni** do środka. Schab 4 do 6 mm: ok. 3 do 4 min z każdej strony, zależnie od pieca. Nie przesuwamy kotleta co chwilę, dajemy panierce skarmelizować. Drugi raz krócej od drugiej strony, jeśli pierwsza już mocno brązowa.
...
**Odpoczynek po patelni:** 2 do 3 minuty na kratce lub talerzu, soki się rozchodzą, panierka „setuje”. Krojenie od razu = wyciek i miękkie dno panierki.
...
**Suche mięso w środku:** Przegotowane po złotej skórce, schab cienki, więc minuty mają znaczenie. Termometr w diasporze nie jest obowiązkowy, ale 63 do 65 °C w środku schabu to bezpieczna orientacja ([was-wir-essen.de](https://www.was-wir-essen.de), higiena mięsa).
...
![Panierowany drób, pokrewny trzystopniową panierką](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-de-volaille/87147728-879d-49aa-9871-0e1a78285f4b.webp "Ta sama logika co przy schabowym: mąka, jajko, bułka, potem spokojne ciepło.")
...
Obtoczone kotlety 2 do 3 godziny w lodówce, ok, lekko przykryte. Dłużej, panierka mięknie. Nie mrożymy surowych obtoczonych bez testu, często pęka po rozmrożeniu.
...
- [Zamienniki składników w Niemczech](/pl/blog/zamienniki-skladnikow)
`;
