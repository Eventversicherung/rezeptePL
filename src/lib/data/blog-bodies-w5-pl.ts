...
Tłuszcz do smażenia albo smalec z głębokością, by faworki pływały. Temperatura około 170 do 180 °C, bez termometru: resztka ciasta ma od razu syczeć, nie tonąć. Za chłodno = tłuste i ciężkie. Za gorąco = zewnątrz ciemne, w środku ciastowate. Partie małe; po każdej chwilę poczekać, aż żar wróci.
...
Fasola z puszki, kupiona kiełbasa i zwykły garnek są w diasporze w porządku. Bohaterstwo z moczeniem po zmianie nie jest zyskiem zwyczaju. Wcześniej wybieramy linię fasoli, bierzemy majeranek na serio, prowadzimy garnek dzień wcześniej. Fasolka w Niemczech staje się powtarzalna, gdy jej na to pozwolimy.
`;
...
![Schab pieczony z pieca, z majerankiem na skórce](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-schab-pieczony/9bc66840-1648-4957-ad82-67989c692788.webp "Pieczeń z pieca to nie panierka. Majeranek niesie zapach.")
...
![Gołąbki w garnku, przykryte sosem](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-golabki/56ae4f6d-22d3-4bcd-9886-e71c4cba3244.webp "Majeranek w farszu, sos na wierzchu. Garnek może poczekać.")
