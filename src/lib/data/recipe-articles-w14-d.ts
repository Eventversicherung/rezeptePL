...
export const W14_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-leczo": {
    ...
    originDe:
      "Leczo ist der polnische (und mitteleuropäische) Paprika-Tomaten-Eintopf: Zwiebel, Paprika, Tomate, oft Kiełbasa in Scheiben — Gemüse-dominant, Pfannen- oder Topfgericht für den Alltag. Das ist kein [Gulasz wieprzowy](/de/rezepte/gulasz-wieprzowy): dort führt langes Schmoren von Schweinewürfeln in Paprikasoße als Fleisch-Primary; hier entscheiden weiche Paprikastreifen und Tomatensauce. Auch kein [Bigos](/de/rezepte/bigos) (Kraut und Fleischschichten) und keine [Fasolka po bretońsku](/de/rezepte/fasolka-po-bretonsku) (Bohnen-Eintopf). Kultur-Rahmen optional beim [Sonntagsessen](/de/blog/sonntagsessen-polnisch) — Anlass-/Kultur-Owner bleibt dort; diese Money Page owns nur den Cook-Intent Leczo / Paprikagemüse.",
    originPl:
      "Leczo to polski (i środkowoeuropejski) gulasz warzywny z papryką i pomidorem: cebula, papryka, pomidor, często kiełbasa w plasterkach — warzywa prowadzą, danie na patelnię lub garnek na co dzień. To nie [gulasz wieprzowy](/pl/rezepte/gulasz-wieprzowy): tam primary to długie duszenie kostki wieprzowiny w sosie paprykowym; tu miękkie paski papryki i sos pomidorowy. To też nie [bigos](/pl/rezepte/bigos) (kapusta i warstwy mięsa) ani [fasolka po bretońsku](/pl/rezepte/fasolka-po-bretonsku) (fasola). Rama kulturowa opcjonalnie przy [obiedzie niedzielnym](/pl/blog/obiad-niedzielny) — owner okazji/kultury zostaje tam; ta money page owns tylko cook-intent leczo / paprykowe warzywa.",
    shopDe:
    ...
    diasporaDe:
      "In DE oft der schnelle Topf nach der Schicht: Paprika aus dem Supermarkt, Wurst aus dem [Polenladen](/de/blog/polenladen-einkaufen). Kinder mögen die Süße der Paprika; Schärfe optional weglassen. Wer Typen von Wurst klären will, bleibt beim [Kiełbasa-Arten](/de/blog/kielbasa-arten)-Lexikon — hier nur der Eintopf-Cook. Wochenend-Kontext descriptiv: [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    diasporaPl:
      "W DE często szybki garnek po zmianie: papryka z marketu, kiełbasa ze [sklepu polskiego](/pl/blog/sklep-polski-zakupy). Dzieci lubią słodycz papryki; ostrość opcjonalnie odpuścić. Typy kiełbasy zostają w [leksykonie rodzajów](/pl/blog/rodzaje-kielbasy) — tu tylko cook gulaszu warzywnego. Weekend opisowo: [obiad niedzielny](/pl/blog/obiad-niedzielny).",
    mistakesDe:
      "Mit [Gulasz wieprzowy](/de/rezepte/gulasz-wieprzowy) verwechseln und Würfelfleisch 90 Minuten schmoren — falscher Primary. Paprika roh-knackig lassen (zu kurz). Zu wenig Tomate (trocken). Dunkle Grillwurst allein ohne Gemüse-Dominanz. Ownership von [Bigos](/de/rezepte/bigos) oder [Fasolka](/de/rezepte/fasolka-po-bretonsku) stehlen — nein. Kultur-Guide [Sonntagsessen](/de/blog/sonntagsessen-polnisch) nicht überschreiben.",
    mistakesPl:
      "Mylenie z [gulaszem wieprzowym](/pl/rezepte/gulasz-wieprzowy) i 90 minut kostki mięsa — złe primary. Papryka surowa (za krótko). Za mało pomidora (sucho). Sama ciemna grillowa bez dominacji warzyw. Kradzież ownership [bigosu](/pl/rezepte/bigos) lub [fasolki](/pl/rezepte/fasolka-po-bretonsku) — nie. Nie nadpisywać [obiadu niedzielnego](/pl/blog/obiad-niedzielny).",
    variantsDe:
