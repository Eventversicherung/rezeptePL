...
export const W14_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-leczo": {
    ...
    mistakesDe:
      "Mit [Gulasz wieprzowy](/de/rezepte/gulasz-wieprzowy) verwechseln und Würfelfleisch 90 Minuten schmoren — falscher Fokus. Paprika roh-knackig lassen (zu kurz). Zu wenig Tomate (trocken). Dunkle Grillwurst allein ohne Gemüse-Dominanz. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein. Kultur-Guide [Sonntagsessen](/de/blog/sonntagsessen-polnisch) nicht überschreiben.",
    mistakesPl:
