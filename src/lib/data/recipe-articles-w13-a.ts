...
export const W13_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-krupnik": {
    ...
    mistakesDe:
      "Mit [Grochówka](/de/rezepte/grochowka) verwechseln (Erbsen). Mit [Zupa grzybowa](/de/rezepte/zupa-grzybowa) verwechseln (Pilz). Zu stark pürieren bis Brei. Gerste ungewaschen. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein, dort Broad bzw. Kultur.",
    mistakesPl:
