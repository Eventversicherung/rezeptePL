...
export const W13_FACTS_A: Record<string, ArticleFacts> = {
  "recipe-krupnik": {
    ...
    originDe:
      "Krupnik ist der Cook-Intent für die klassische polnische Gerstensuppe — hier als Hausvariante mit Perlgerste (kasza jęczmienna), Wurzelgemüse und optional Hühnerfleisch. Der Topf bindet leicht durch die Gerste, bleibt aber klar als Suppe mit sichtbaren Körnern — nicht als dickes Erbsenpüree. Das ist weder [Grochówka](/de/rezepte/grochowka) (gelbe Trockenerbsen, oft Rauchwurst) noch [Zupa grzybowa](/de/rezepte/zupa-grzybowa) (Trockenpilz-Fond) noch Sauerkrautsuppe [Kapuśniak](/de/rezepte/kapusniak). Der Overview [Polnische Suppen](/de/blog/polnische-suppen) bleibt Broad-Owner der Landschaft; hier liegt nur der enge Gersten-Primary. Menüplatz descriptiv beim [Sonntagsessen](/de/blog/sonntagsessen-polnisch) — Kultur-Owner bleibt der Guide, Cook-Primary dieses Rezept.",
    originPl:
      "Krupnik to intent cook: klasyczna polska zupa z kaszy jęczmiennej — tu linia domowa z pęczakiem, warzywami korzeniowymi i opcjonalnie kurczakiem. Garnek lekko gęstnieje od kaszy, ale zostaje zupą z widocznymi ziarnami — nie papką z grochu. To ani [grochówka](/pl/rezepte/grochowka), ani [zupa grzybowa](/pl/rezepte/zupa-grzybowa), ani [kapuśniak](/pl/rezepte/kapusniak). Przegląd [polskie zupy](/pl/blog/polskie-zupy) zostaje broad-ownerem; tu tylko wąski primary jęczmienia. Miejsce w menu opisowo przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) — owner kultury zostaje przy guide, cook-primary przy tym przepisie.",
    shopDe:
      "Perlgerste ist der Charakterträger — oft im [Polenladen](/de/blog/polenladen-einkaufen) oder im Supermarkt-Getreideregal. Wurzelgemüse, Zwiebel, Lorbeer und Dill aus dem Markt. Optional Huhn aus dem Kühlregal. Fehlt eine Sorte Gerste: ehrlich laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de) benennen, ohne in Erbsen-Intent zu kippen. Keine Trockenerbsen und kein Trockenpilz-Batch als Basis — sonst driftet der Intent zu [Grochówka](/de/rezepte/grochowka) oder [Zupa grzybowa](/de/rezepte/zupa-grzybowa). Brühe-Qualität descriptiv über [Rosół-Technik](/de/blog/rosol-technik).",
    shopPl:
      "Kasza jęczmienna niesie charakter — często w [sklepie polskim](/pl/blog/sklep-polski-zakupy) lub w markecie. Warzywa korzeniowe, cebula, liść laurowy, koperek z marketu. Opcjonalnie kurczak. Brak sorty kaszy: uczciwie według [zamienników](/pl/blog/zamienniki-skladnikow), bez dryfu w groch. Bez suchego grochu i bez suszonych grzybów jako bazy — inaczej intent idzie w [grochówkę](/pl/rezepte/grochowka) lub [zupę grzybową](/pl/rezepte/zupa-grzybowa). Jakość bulionu opisowo: [jak ugotować rosół](/pl/blog/jak-ugotowac-rosol).",
    techniqueDe:
    ...
    servePl:
      "Gorąca z koperkiem, chleb obok. Starter lub obiad w duchu [obiadu niedzielnego](/pl/blog/obiad-niedzielny). Groch: [grochówka](/pl/rezepte/grochowka); grzyby: [zupa grzybowa](/pl/rezepte/zupa-grzybowa); klarowny wywar: [rosół](/pl/rezepte/rosol). Krajobraz: [polskie zupy](/pl/blog/polskie-zupy). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy).",
    diasporaDe:
    ...
    mistakesDe:
      "Mit [Grochówka](/de/rezepte/grochowka) verwechseln (Erbsen). Mit [Zupa grzybowa](/de/rezepte/zupa-grzybowa) verwechseln (Pilz). Zu stark pürieren bis Brei. Gerste ungewaschen. Ownership vom [Suppen-Overview](/de/blog/polnische-suppen) oder [Sonntagsessen](/de/blog/sonntagsessen-polnisch) stehlen — nein, dort Broad bzw. Kultur.",
    mistakesPl:
      "Mylenie z [grochówką](/pl/rezepte/grochowka). Mylenie z [zupą grzybową](/pl/rezepte/zupa-grzybowa). Zbyt mocne blendowanie. Kasza bez płukania. Kradzież ownership z [przeglądu zup](/pl/blog/polskie-zupy) lub [obiadu niedzielnego](/pl/blog/obiad-niedzielny) — nie.",
    variantsDe:
      "Mit mehr Huhn sättigender; vegetarisch ehrlich ohne Fleisch; mit getrockneten Pilzen nur als Beinote — Primary bleibt Gerste, nicht [Zupa grzybowa](/de/rezepte/zupa-grzybowa). Nachbarn: [Grochówka](/de/rezepte/grochowka), [Kapuśniak](/de/rezepte/kapusniak), [Rosół](/de/rezepte/rosol). Guides: [Polnische Suppen](/de/blog/polnische-suppen), [Sonntagsessen](/de/blog/sonntagsessen-polnisch), [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    variantsPl:
      "Z większą ilością kurczaka sycący; wege uczciwie bez mięsa; z suszonymi grzybami tylko jako dopisek — primary zostaje kasza, nie [zupa grzybowa](/pl/rezepte/zupa-grzybowa). Sąsiedzi: [grochówka](/pl/rezepte/grochowka), [kapuśniak](/pl/rezepte/kapusniak), [rosół](/pl/rezepte/rosol). Przewodniki: [polskie zupy](/pl/blog/polskie-zupy), [obiad niedzielny](/pl/blog/obiad-niedzielny), [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow).",
  },
  ...
  "recipe-szczawiowa": {
    ...
    originDe:
      "Zupa szczawiowa ist der Cook-Intent für die klassische polnische Sauerampfersuppe — hier als eine klare Hauslinie: frischer Szczaw, Kartoffeln, temperierte Śmietana und hartgekochtes Ei. Die Farbe bleibt grün und der Geschmack säuerlich-pflanzlich. Das ist weder warme junge Rote-Bete-Suppe [Botwinka](/de/rezepte/botwinka) noch Kiszone-Gurkensuppe [Ogórkowa](/de/rezepte/ogorkowa) noch kalter, oft rosa [Chłodnik](/de/rezepte/chlodnik-litewski) und auch kein Zakwas-[Żurek](/de/rezepte/zurek). Der Overview [Polnische Suppen](/de/blog/polnische-suppen) ordnet die Landschaft; hier liegt der enge Sauerampfer-Primary. Śmietana-Technik descriptiv im [Śmietana/Schmand](/de/blog/smietana-schmand)-Guide — Zutaten-Owner bleibt dort, Cook-Primary dieses Rezept.",
    originPl:
      "Zupa szczawiowa to intent cook: klasyczna zupa ze szczawiu — tu jedna linia domowa: świeży szczaw, ziemniaki, zahartowana śmietana i jajko na twardo. Kolor zostaje zielony, smak kwaskowato-roślinny. To ani ciepła [botwinka](/pl/rezepte/botwinka), ani [ogórkowa](/pl/rezepte/ogorkowa), ani zimny [chłodnik](/pl/rezepte/chlodnik-litewski), ani zakwasowy [żurek](/pl/rezepte/zurek). Przegląd [polskie zupy](/pl/blog/polskie-zupy) porządkuje krajobraz; tu wąski primary szczawiu. Technika śmietany opisowo w [śmietana/Schmand](/pl/blog/smietana-czy-schmand) — owner składnika zostaje tam, cook-primary przy tym przepisie.",
    shopDe:
      "Frischer Sauerampfer ist saisonal — Markt, Garten oder [Polenladen](/de/blog/polenladen-einkaufen); gefroren ehrlich benennen laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Kartoffeln, Eier, Dill aus dem Supermarkt. Śmietana/Schmand-Wahl im [Śmietana-Guide](/de/blog/smietana-schmand). Keine jungen Rote-Bete-Blätter als „Ersatz“ ohne Hinweis — sonst driftet der Intent zu [Botwinka](/de/rezepte/botwinka). Kein Gurkenglas und kein Kefir-Kühlbecher als Basis — sonst [Ogórkowa](/de/rezepte/ogorkowa) bzw. [Chłodnik](/de/rezepte/chlodnik-litewski).",
    shopPl:
      "Świeży szczaw jest sezonowy — targ, ogród lub [sklep polski](/pl/blog/sklep-polski-zakupy); mrożony uczciwie według [zamienników](/pl/blog/zamienniki-skladnikow). Ziemniaki, jajka, koperek z marketu. Wybór śmietany w [przewodniku](/pl/blog/smietana-czy-schmand). Bez młodej botwiny jako „zamiennika” bez dopisku — inaczej intent idzie w [botwinkę](/pl/rezepte/botwinka). Bez słoika ogórków i bez kefiru jako bazy — inaczej [ogórkowa](/pl/rezepte/ogorkowa) lub [chłodnik](/pl/rezepte/chlodnik-litewski).",
    techniqueDe:
      "Kartoffelbasis weich kochen, Sauerampfer spät und kurz — lange Hitze macht Oliv und Bitterkeit. Śmietana immer temperieren, nie in den kochenden Topf. Ei separat hart kochen und erst im Teller. Abschmecken: Salz, etwas Pfeffer, Dill; Zucker selten nötig. Das ist kein Kiszone-Topf wie [Ogórkowa](/de/rezepte/ogorkowa) und kein kalter Kefirbecher wie [Chłodnik](/de/rezepte/chlodnik-litewski). Bete-Nachbar descriptiv: [Botwinka](/de/rezepte/botwinka).",
    techniquePl:
      "Bazę ziemniaczaną dogotuj, szczaw późno i krótko — długi ogień daje oliwkowy kolor i gorycz. Śmietanę zawsze zahartuj. Jajko osobno na twardo, do talerza. Dopraw: sól, pieprz, koperek; cukier rzadko. To nie garnek kiszony jak [ogórkowa](/pl/rezepte/ogorkowa) i nie zimny kefir jak [chłodnik](/pl/rezepte/chlodnik-litewski). Sąsiad buraczany opisowo: [botwinka](/pl/rezepte/botwinka).",
    serveDe:
    ...
    diasporaDe:
      "In DE ist frischer Sauerampfer das Nadelöhr — wer ihn findet, kocht; wer nicht, wartet auf die Saison oder nennt den gefrorenen Vorrat ehrlich. Ein Topf für den gleichen Tag, Farbe frisch halten. Kinder dürfen Eier schälen; heißer Topf und scharfe Messer bei Erwachsenen. Einkaufshilfe: [Ersatzprodukte DE](/de/blog/ersatzprodukte-de) und [Polenladen](/de/blog/polenladen-einkaufen). Overview ohne Primary-Diebstahl: [Polnische Suppen](/de/blog/polnische-suppen).",
    diasporaPl:
      "W DE świeży szczaw to wąskie gardło — kto znajdzie, gotuje; kto nie, czeka na sezon albo nazywa mrożonkę uczciwie. Jeden garnek na ten sam dzień, kolor świeży. Dzieci obiorą jajka; gorący garnek u dorosłych. Zakupy: [zamienniki](/pl/blog/zamienniki-skladnikow) i [sklep polski](/pl/blog/sklep-polski-zakupy). Przegląd bez kradzieży primary: [polskie zupy](/pl/blog/polskie-zupy).",
    mistakesDe:
      "Mit [Botwinka](/de/rezepte/botwinka) verwechseln (Bete). Mit [Ogórkowa](/de/rezepte/ogorkowa) verwechseln (Gurke). Mit [Chłodnik](/de/rezepte/chlodnik-litewski) verwechseln (kalt). Sauerampfer zu lange kochen. Śmietana kochend einrühren. Ownership vom [Suppen-Overview](/de/blog/polnische-suppen) stehlen — nein.",
    mistakesPl:
      "Mylenie z [botwinką](/pl/rezepte/botwinka). Mylenie z [ogórkową](/pl/rezepte/ogorkowa). Mylenie z [chłodnikiem](/pl/rezepte/chlodnik-litewski). Zbyt długie gotowanie szczawiu. Śmietana do wrzątku. Kradzież ownership z [przeglądu zup](/pl/blog/polskie-zupy) — nie.",
    variantsDe:
      "Mit mehr Dill frischer; mit weniger Śmietana säuerlicher; vegetarisch auf Gemüsebrühe. Nachbarn: [Botwinka](/de/rezepte/botwinka), [Ogórkowa](/de/rezepte/ogorkowa), [Chłodnik](/de/rezepte/chlodnik-litewski). Guides: [Polnische Suppen](/de/blog/polnische-suppen), [Śmietana/Schmand](/de/blog/smietana-schmand), [Ersatzprodukte](/de/blog/ersatzprodukte-de), [Polenladen](/de/blog/polenladen-einkaufen).",
    variantsPl:
      "Z większą ilością koperku świeższa; z mniejszą śmietaną bardziej kwaskowa; wege na warzywnym. Sąsiedzi: [botwinka](/pl/rezepte/botwinka), [ogórkowa](/pl/rezepte/ogorkowa), [chłodnik](/pl/rezepte/chlodnik-litewski). Przewodniki: [polskie zupy](/pl/blog/polskie-zupy), [śmietana/Schmand](/pl/blog/smietana-czy-schmand), [zamienniki](/pl/blog/zamienniki-skladnikow), [sklep polski](/pl/blog/sklep-polski-zakupy).",
  },
};
