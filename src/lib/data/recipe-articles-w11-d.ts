...
export const W11_FACTS_D: Record<string, ArticleFacts> = {
  ...
  "recipe-golonka": {
    ...
    originPl:
      "Golonka to przepis: wieprzowina na kości — długo duszona, opcjonalnie chrupiąca z pieca, z musztardą, chrzanem lub kapustą. To ani panierowany [schabowy](/pl/rezepte/kotlet-schabowy), ani [schab pieczony](/pl/rezepte/schab-pieczony), ani [żeberka](/pl/rezepte/zeberka). Kulturę i wybór menu zostawiamy w [obiadzie niedzielnym](/pl/blog/obiad-niedzielny); tu wąski fokus przepisu. W diasporze często danie, na które świadomie blokujemy czas — nie szybka patelnia.",
    shopDe:
  ...
  "recipe-kompot-z-suszu": {
    ...
    originPl:
      "Kompot z suszu to przepis: klasyczny kompot z suszonych owoców — śliwka, jabłko, gruszka, morela, często z cynamonem i goździkiem — jako napój i owocowy finał. Na Wigilii w [menu](/pl/blog/menu-wigilijne), ale tu zostaje ten przepis: ilości, czas, słodycz. Nie miesza się z filarem menu ani z rybami [karpia](/pl/rezepte/karp) lub [ryby po grecku](/pl/rezepte/ryba-po-grecku). Jasno osobno od owocowego [kisielu](/pl/rezepte/kisiel) (bez kawałków suszu, wiązanie skrobią). W diasporze często najspokojniejszy element: jeden garnek, mało pracy, duży smak.",
    shopDe:
