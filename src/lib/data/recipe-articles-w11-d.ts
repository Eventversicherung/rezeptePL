...
export const W11_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-ryba-po-grecku": {
    ...
    servePl:
      "Na zimno lub letnio z naczynia, z cytryną i koperkiem. Pasuje po [barszczu](/pl/rezepte/barszcz-czerwony) lub w bufecie obok [śledzia](/pl/rezepte/sledz). Przy stole wigilijnym w menu; fokus zostaje ten przepis. Resztki w lodówce — często lepsze nazajutrz.",
    diasporaDe:
