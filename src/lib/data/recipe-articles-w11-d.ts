...
export const W11_FACTS_D: Record<string, ArticleFacts> = {
 ...
 mistakesDe:
 "Zu heiß und zu kurz. Mit Schabowy/Schab/Żeberka verwechseln. Majoran wie Oregano kippen. Haut von Anfang an knusprig wollen und Fleisch austrocknen. Zu wenig Flüssigkeit. nein.",
 mistakesPl:
 "Za ostro i za krótko. Mylenie ze schabowym/schabem/żeberkami. Za dużo majeranku. Skórka od początku i suche mięso. Za mało płynu. Nie mieszać ilości i kroków z sąsiednim przepisem.",
 variantsDe:
