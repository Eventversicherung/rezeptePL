...
export const W11_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-ryba-po-grecku": {
    ...
    originDe:
      "Ryba po grecku ist der Cook-Intent für gebratenen Weißfisch unter einer dicken Sauce aus Karotte, Zwiebel, Wurzelgemüse und Tomate — klassisch kalt serviert, oft schon am Vortag gezogen. Der Name meint die polnische Hausküche-Linie „griechische Art“, nicht ein griechisches Restaurantgericht. Klar getrennt vom ganzen Ofkarpfen: [Karp](/de/rezepte/karp) bleibt die Knochen-/Ofen-Fischlinie der Wigilia; hier arbeiten Filet und Gemüsesauce. Menürahmen und Timeline bleiben im [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan) — dort Anlass-Owner, hier der enge Cook-Primary. Als kalte Vorspeise oder Buffetstück trägt das Gericht auch außerhalb der Feiertage.",
    originPl:
      "Ryba po grecku to intent cook: smażony biały filet pod gęstym sosem z marchewki, cebuli, warzyw korzeniowych i pomidora — klasycznie na zimno, często zrobiony dzień wcześniej. Nazwa to polska linia domowa „po grecku”, nie grecka restauracja. Wyraźnie osobno od całego karpia z pieca: [karp](/pl/rezepte/karp) zostaje linią kości/pieca na Wigilię; tu filet i sos warzywny. Ramę menu zostawiamy w [menu wigilijnym](/pl/blog/menu-wigilijne) — tam owner okazji, tu wąski cook-primary. Jako zimna przystawka lub bufet działa też poza świętami.",
    shopDe:
      "Weißfischfilets aus der Frischtheke oder TK, Karotten, Zwiebeln, Tomatenmark. Petersilienwurzel oder Sellerie oft im [Polenladen](/de/blog/polenladen-einkaufen); fehlt sie, ehrlich mit mehr Karotte und Selleriestange arbeiten laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Lorbeer und Nelke aus dem Gewürzregal. Kein ganzer Karpfen nötig — das spart Grätenstress und hält den Intent klar neben [Karp](/de/rezepte/karp).",
    shopPl:
      "Filety białej ryby z lady lub mrożone, marchew, cebula, koncentrat. Pietruszka korzeniowa lub seler często w [sklepie polskim](/pl/blog/sklep-polski-zakupy); gdy brak — uczciwie więcej marchewki i łodyga według [zamienników](/pl/blog/zamienniki-skladnikow). Liść laurowy i goździk z przypraw. Cały karp nie jest potrzebny — mniej ości i czysty intent obok [karpia](/pl/rezepte/karp).",
    techniqueDe:
    ...
    serveDe:
      "Kalt oder lauwarm aus der Form, mit Zitrone und Dill. Passt nach [Barszcz](/de/rezepte/barszcz-czerwony) oder als Buffet neben [Śledź](/de/rezepte/sledz). Am Wigilia-Tisch descriptiv neben dem Speiseplan planen; Primary bleibt dieses Rezept. Reste halten sich im Kühlschrank und werden oft am zweiten Tag runder.",
    servePl:
      "Na zimno lub letnio z naczynia, z cytryną i koperkiem. Pasuje po [barszczu](/pl/rezepte/barszcz-czerwony) lub w bufecie obok [śledzia](/pl/rezepte/sledz). Przy stole wigilijnym opisowo w menu; primary zostaje ten przepis. Resztki w lodówce — często lepsze nazajutrz.",
    diasporaDe:
    ...
    mistakesDe:
      "Sauce zu wässrig. Gemüse verbrannt statt gedünstet. Mit [Karp](/de/rezepte/karp) verwechseln (ganzer Fisch/Ofen). Zu kurz ziehen. Zu viel Zucker — Fruchtigkeit der Karotte reicht oft. Ownership vom Speiseplan stehlen — nein, [Wigilia](/de/blog/wigilia-speiseplan) bleibt Anlass-Owner.",
    mistakesPl:
      "Za rzadki sos. Spalone warzywa zamiast duszenia. Mylenie z [karpem](/pl/rezepte/karp). Za krótki odpoczynek. Za dużo cukru. Kradzież ownership z [menu wigilijnego](/pl/blog/menu-wigilijne) — nie, tam zostaje owner okazji.",
    variantsDe:
      "Mit Sellerie statt Petersilienwurzel; ohne Nelke milder; etwas Paprika descriptiv. Warm nur kurz anwärmen, nicht neu braten. Nachbar-Fisch: [Karp](/de/rezepte/karp), [Śledź](/de/rezepte/sledz). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    variantsPl:
      "Z selerem zamiast pietruszki; bez goździka łagodniej; odrobina papryki opisowo. Na ciepło tylko krótko podgrzej. Sąsiedzi: [karp](/pl/rezepte/karp), [śledź](/pl/rezepte/sledz). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow).",
  },
  ...
  "recipe-golonka": {
    ...
    originDe:
      "Golonka ist der Cook-Intent für Schweinshaxe am Knochen — lange geschmort, optional knusprig nachgebräunt, mit Senf, Meerrettich oder Kapusta. Das ist weder panierter [Schabowy](/de/rezepte/kotlet-schabowy) noch Ofenschweinebraten [Schab pieczony](/de/rezepte/schab-pieczony) noch Ofenrippen [Żeberka](/de/rezepte/zeberka). Kultur und Menüwahl bleiben im [Sonntagsessen-Guide](/de/blog/sonntagsessen-polnisch); hier liegt der enge Rezept-Primary. In der Diaspora oft das Gericht, für das man bewusst Zeit blockt — nicht die schnelle Pfanne.",
    originPl:
      "Golonka to intent cook: wieprzowina na kości — długo duszona, opcjonalnie chrupiąca z pieca, z musztardą, chrzanem lub kapustą. To ani panierowany [schabowy](/pl/rezepte/kotlet-schabowy), ani [schab pieczony](/pl/rezepte/schab-pieczony), ani [żeberka](/pl/rezepte/zeberka). Kulturę i wybór menu zostawiamy w [obiadzie niedzielnym](/pl/blog/obiad-niedzielny); tu wąski primary przepisu. W diasporze często danie, na które świadomie blokujemy czas — nie szybka patelnia.",
    shopDe:
    ...
    mistakesDe:
      "Zu heiß und zu kurz. Mit Schabowy/Schab/Żeberka verwechseln. Majoran wie Oregano kippen. Haut von Anfang an knusprig wollen und Fleisch austrocknen. Zu wenig Flüssigkeit. Ownership vom [Sonntagsessen](/de/blog/sonntagsessen-polnisch) stehlen — nein.",
    mistakesPl:
      "Za ostro i za krótko. Mylenie ze schabowym/schabem/żeberkami. Za dużo majeranku. Skórka od początku i suche mięso. Za mało płynu. Kradzież ownership z [obiadu niedzielnego](/pl/blog/obiad-niedzielny) — nie.",
    variantsDe:
      "Bier oder Apfelsaft im Fond descriptiv; mit Kümmel; nur geschmort ohne Nachbräunen. Nachbarn: [Żeberka](/de/rezepte/zeberka), [Schab pieczony](/de/rezepte/schab-pieczony), [Schabowy](/de/rezepte/kotlet-schabowy). Gear: [Dutch Oven](/de/blog/dutch-oven-kaufberatung), Gewürz: [Majeranek](/de/blog/majeranek).",
    variantsPl:
      "Piwo lub sok jabłkowy w sosie opisowo; z kminkiem; tylko duszenie bez zapiekania. Sąsiedzi: [żeberka](/pl/rezepte/zeberka), [schab pieczony](/pl/rezepte/schab-pieczony), [schabowy](/pl/rezepte/kotlet-schabowy). Sprzęt: [garnek](/pl/blog/garnek-do-duszenia), przyprawa: [majeranek](/pl/blog/majeranek-leksykon).",
  },
  ...
  "recipe-kompot-z-suszu": {
    ...
    originDe:
      "Kompot z suszu ist der Cook-Intent für den klassischen Trockenobstkompot — Pflaume, Apfel, Birne, Aprikose, oft mit Zimt und Nelke — als Getränk und zugleich fruchtiger Abschluss. An Wigilia descriptiv im [Speiseplan](/de/blog/wigilia-speiseplan) verankert, aber Primary bleibt dieses Rezept: Mengen, Ziehzeit, Süße. Es stiehlt weder den Pillar noch den Fisch-Primary von [Karp](/de/rezepte/karp) oder [Ryba po grecku](/de/rezepte/ryba-po-grecku). In der Diaspora oft der ruhigste Gang: ein Topf, wenig Handarbeit, großer Geschmack.",
    originPl:
      "Kompot z suszu to intent cook: klasyczny kompot z suszonych owoców — śliwka, jabłko, gruszka, morela, często z cynamonem i goździkiem — jako napój i owocowy finał. Na Wigilii opisowo w [menu](/pl/blog/menu-wigilijne), ale primary zostaje ten przepis: ilości, czas, słodycz. Nie kradnie pillara ani primary ryb [karpia](/pl/rezepte/karp) lub [ryby po grecku](/pl/rezepte/ryba-po-grecku). W diasporze często najspokojniejszy element: jeden garnek, mało pracy, duży smak.",
    shopDe:
    ...
    serveDe:
      "Kalt in Karaffe mit Früchten oder abgeseiht. Am Tisch neben Barszcz und Fisch; Plan-Owner bleibt [Wigilia](/de/blog/wigilia-speiseplan). Passt zu [Makowiec](/de/rezepte/makowiec) am Folgetag. Nicht mit frischem Apfelkompot verwechseln — hier trägt Susz den Charakter.",
    servePl:
    ...
    mistakesDe:
      "Zu viel Zucker von Anfang an. Zu starkes Kochen (Brei). Frisches Obst 1:1 statt Susz — anderer Charakter. Als Speiseplan-Owner auftreten statt Rezept. Vergessen, Nelken zu entfernen. Links zum Anlass bleiben descriptiv zum [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan).",
    mistakesPl:
      "Za dużo cukru od razu. Zbyt mocne gotowanie. Świeże owoce 1:1 zamiast suszu. Udawanie ownera menu zamiast przepisu. Zostawione goździki. Linki do okazji opisowo do [menu wigilijnego](/pl/blog/menu-wigilijne).",
    variantsDe:
