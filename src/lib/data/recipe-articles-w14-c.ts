...
export const W14_FACTS_C: Record<string, ArticleFacts> = {
  "recipe-placek-po-wegiersku": {
    ...
    originDe:
      "Placek po węgiersku ist das Rezept für den **composed** Sonntagsteller: knusprige Kartoffelpuffer mit Schweinegulasch als Topping — oft mit geschmolzenem Käse. Das ist weder der Überblick-[Placki-Guide](/de/blog/placki-guide) noch die Einzeln-Cook-URL [Placki ziemniaczane](/de/rezepte/placki/ziemniaczane) (Puffer allein) noch [Gulasz wieprzowy](/de/rezepte/gulasz-wieprzowy) (Eintopf allein). Fokus hier: der komplette Teller „ungarischer Kartoffelpuffer“. Menürahmen [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Schmor-Gefäß [Dutch Oven](/de/blog/dutch-oven-kaufberatung). In der Diaspora oft der Moment, in dem man beide Klassiker am selben Tag verbinden will — ohne Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen.",
    originPl:
      "Placek po węgiersku to dla **composed** talerza niedzielnego: chrupiące placki ziemniaczane z gulaszem wieprzowym na wierzchu — często z roztopionym serem. To ani Überblick [przewodnik po plackach](/pl/blog/placki-przewodnik), ani osobny cook [placki ziemniaczane](/pl/rezepte/placki/ziemniaczane) (same placki), ani [gulasz wieprzowy](/pl/rezepte/gulasz-wieprzowy) (sam gulasz). Tu: cały talerz „placek po węgiersku”. Rama menu [obiad niedzielny](/pl/blog/obiad-niedzielny). Garnek [dutch oven](/pl/blog/garnek-do-duszenia). W diasporze często dzień, gdy łączy się dwa klasyki — bez mieszania osobnych dań.",
    shopDe:
    ...
    mistakesDe:
      "Nur nackte Placki fotografieren/kochen — verwechseln mit [Placki](/de/rezepte/placki/ziemniaczane). Nur Gulaschschüssel — verwechseln mit [Gulasz](/de/rezepte/gulasz-wieprzowy). den Überblick im [Placki-Guide](/de/blog/placki-guide) nicht hier nachbauen. Puffer unter Soße zu lange warten lassen. Den Speiseplan hier nicht ersetzen — dafür gibt es [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    mistakesPl:
      "Same gołe placki — mylenie z [plackami](/pl/rezepte/placki/ziemniaczane). Sama miska gulaszu — mylenie z [gulaszem](/pl/rezepte/gulasz-wieprzowy). Kradzież Überblick w [przewodniku](/pl/blog/placki-przewodnik). Placki za długo pod sosem. Roszczenie menu zamiast [obiadu niedzielnego](/pl/blog/obiad-niedzielny).",
    variantsDe:
  ...
  "recipe-zapiekanka": {
    ...
    originDe:
      "Zapiekanka ist das Rezept für das polnische Straßen-Baguette: längs aufgeschnitten, mit angebratenen Pilzen (± Schinken) und Käse überbacken, klassisch mit Ketchup. Das ist weder [Krokiety](/de/rezepte/krokiety) (gerollte, panierte Füllung) noch [Naleśniki](/de/rezepte/nalesniki/twarog) noch [Pierogi](/de/rezepte/pierogi/ruskie). Hier: Baguette-Form + Käse-Schmelz. Einkauf und Diaspora: [Polenladen](/de/blog/polenladen-einkaufen), Ersatz ehrlich [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Alltag/Menü [Sonntagsessen](/de/blog/sonntagsessen-polnisch) — Kulturrahmen bleibt bei dort; hier nur der Street-Cook.",
    originPl:
