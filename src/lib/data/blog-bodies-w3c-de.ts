/**
 * Batch W3c DE blog bodies (from content/batch-w3c).
 */
...
![Goldbrauner Kotlet schabowy mit knuspriger Panade](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-schabowy/c2614c7e-bc01-4c37-a0b8-45b4c581ec92.webp "Panade schützt den Saft. Hitze und Ruhe entscheiden mehr als das Rezept allein.")
...
**Schlag (klopfen):** Fleisch zwischen Folie oder in einem Beutel leicht plattieren, nicht zu dünn, sonst trocknet es beim Braten aus. Ziel: gleichmäßige Dicke, ca. 1 bis 1,5 cm, damit Mitte und Rand ähnlich schnell garen. Kanten mit dem Fleischklopfer glätten, damit sie nicht eingerollt verbrennen.
...
**Ruhe vor dem Braten:** Panierte Kotlets 5 bis 10 Minuten auf dem Gitter oder Brett, Panade setzt, Ei bindet. Direkt aus der Hand in heißes Öl: Panade quillt ab, wird weich statt knusprig.
...
**Ruhe nach dem Braten:** 2 bis 3 Minuten auf Gitter oder warmem Teller unter Folie, Saft verteilt sich, Panade bleibt knusprig. Sofort schneiden: Saft läuft raus, Kruste weicht.

**Mehrere Portionen:** Ofen auf 80 bis 100 °C, Gitter, fertige Kotlets kurz stellen, nicht stapeln, Feuchtigkeit macht die untere Schicht weich. Nächster Kotlet in dieselbe Pfanne: kurz Öl nachfüllen, kurz erhitzen, nicht auf kaltes Öl legen.
...
![Paniertes Geflügel, verwandt in der Dreifach-Panade](https://kdrbtwwhmzszzukcffsu.supabase.co/storage/v1/object/public/recipe-media/recipes/recipe-de-volaille/87147728-879d-49aa-9871-0e1a78285f4b.webp "Dieselbe Logik wie beim Schabowy: Mehl, Ei, Brösel, dann ruhige Hitze.")
...
Fertige Puffer, die einzeln ankommen, schlagen eine Schüssel, die unter Folie weich wird. Kauf-Śmietana und Supermarktkartoffeln sind in Ordnung, wenn die Pfanne ruhig bleibt. Heldentum, das alle erschöpft, ist kein Gewinn an Brauch. Vorher den Kühlschrank leeren, ein Blech fürs Warmhalten bereitlegen, das Öl nicht sparen und nicht recyceln, bis es dunkel ist. Logistik gehört zur Küche, nicht erst zur Nachsorge.
`;
