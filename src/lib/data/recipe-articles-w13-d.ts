...
export const W13_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-biala-kielbasa": {
    ...
    originPl:
      "Biała kiełbasa to przepis: jasna, świeża kiełbasa delikatnie gotowana lub lekko pieczona, często na Wielkanoc z chrzanem i musztardą. To nie wpis w [leksykonie rodzajów kiełbasy](/pl/blog/rodzaje-kielbasy) — tam zostają typy, jakość i szerokie zastosowanie. Tu ilości, ogień i podanie. To też nie [kaszanka](/pl/rezepte/kaszanka) (krew z kaszą na patelni) ani ciemna wędzona/grillowa. Jako dodatek do [żurku](/pl/rezepte/zurek) zupa zostaje fokus zupy; ta Rezeptseite owns danie z kiełbasy. Kultura menu: [menu wielkanocne](/pl/blog/menu-wielkanocne) — owner okazji zostaje tam.",
    shopDe:
    ...
    mistakesDe:
      "Dunkle Grillwurst als „biała“ verwenden. Stark sprudelnd kochen (platzt). Mit [Kaszanka](/de/rezepte/kaszanka) oder dem Arten-Übersicht des [Kiełbasa-Lexikons](/de/blog/kielbasa-arten) verwechseln. Mengen und Schritte nicht mit dem verlinkten Nachbarn vermischen. nein: hier die Wurst, dort Suppe bzw. Menü.",
    mistakesPl:
