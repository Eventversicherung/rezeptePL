...
export const W13_FACTS_D: Record<string, ArticleFacts> = {
  "recipe-biala-kielbasa": {
    ...
    originDe:
      "Biała kiełbasa ist der Cook-Intent für helle, frische Weißwurst: schonend garziehen oder leicht backen, oft zu Ostern mit Meerrettich und Senf. Das ist kein Eintrag im [Kiełbasa-Arten-Lexikon](/de/blog/kielbasa-arten) — dort bleiben Types, Qualität und Einsatz-Breite Owner. Hier liegen Mengen, Hitze und Anrichten. Sie ist auch keine [Kaszanka](/de/rezepte/kaszanka) (Blutwurst mit Grütze in der Pfanne) und keine dunkle Rauch-/Grillwurst. Als Einlage in [Żurek](/de/rezepte/zurek) bleibt die Suppe Suppen-Primary; diese Money Page owns das Wurst-Gericht. Menü-Kultur Ostern: [Wielkanoc Speiseplan](/de/blog/wielkanoc-speiseplan) — Anlass-Owner bleibt dort.",
    originPl:
      "Biała kiełbasa to intent cook: jasna, świeża kiełbasa delikatnie gotowana lub lekko pieczona, często na Wielkanoc z chrzanem i musztardą. To nie wpis w [leksykonie rodzajów kiełbasy](/pl/blog/rodzaje-kielbasy) — tam zostają typy, jakość i szerokie zastosowanie. Tu ilości, ogień i podanie. To też nie [kaszanka](/pl/rezepte/kaszanka) (krew z kaszą na patelni) ani ciemna wędzona/grillowa. Jako dodatek do [żurku](/pl/rezepte/zurek) zupa zostaje primary zupy; ta money page owns danie z kiełbasy. Kultura menu: [menu wielkanocne](/pl/blog/menu-wielkanocne) — owner okazji zostaje tam.",
    shopDe:
    ...
    serveDe:
      "Klassisch mit Meerrettich, Senf und Brot — oder in Scheiben im Teller [Żurek](/de/rezepte/zurek). Ostern-Buffet laut [Wielkanoc](/de/blog/wielkanoc-speiseplan): Speiseplan bleibt Menü-Owner, hier nur das Wurst-Cook. Nicht mit gebratener [Kaszanka](/de/rezepte/kaszanka) verwechseln. Reste kühlen, am nächsten Tag in der Suppe oder kurz erwärmt mit Brot.",
    servePl:
      "Klasycznie z chrzanem, musztardą i chlebem — albo w plastrach w [żurku](/pl/rezepte/zurek). Buffet wielkanocny według [menu](/pl/blog/menu-wielkanocne): plan zostaje ownerem menu, tu tylko cook kiełbasy. Nie mylić ze smażoną [kaszanką](/pl/rezepte/kaszanka). Resztki schłodzić; nazajutrz w zupie albo krótko podgrzane z chlebem.",
    diasporaDe:
    ...
    mistakesDe:
      "Dunkle Grillwurst als „biała“ verwenden. Stark sprudelnd kochen (platzt). Mit [Kaszanka](/de/rezepte/kaszanka) oder dem Arten-Primary des [Kiełbasa-Lexikons](/de/blog/kielbasa-arten) verwechseln. Ownership von [Żurek](/de/rezepte/zurek) oder [Wielkanoc](/de/blog/wielkanoc-speiseplan) stehlen — nein: hier Cook, dort Suppe bzw. Anlass.",
    mistakesPl:
      "Ciemna grillowa jako „biała”. Gwałtowne gotowanie (pęka). Mylenie z [kaszanką](/pl/rezepte/kaszanka) lub primary rodzajów z [leksykonu kiełbasy](/pl/blog/rodzaje-kielbasy). Kradzież ownership z [żurku](/pl/rezepte/zurek) lub [menu wielkanocnego](/pl/blog/menu-wielkanocne) — nie: tu cook, tam zupa lub okazja.",
    variantsDe:
      "Nur Topf, nur Ofen, oder beides: kurz garziehen und leicht nachbacken. Mit Zwiebeln im Ofen descriptiv. Einlage-Variante bleibt an [Żurek](/de/rezepte/zurek) gekoppelt. Nachbar-Cook Blutwurst: [Kaszanka](/de/rezepte/kaszanka). Types und Qualitätslesen: [Kiełbasa-Arten](/de/blog/kielbasa-arten). Anlass: [Wielkanoc](/de/blog/wielkanoc-speiseplan). Ansatz-Kontext: [Zakwas](/de/blog/zakwas-zurek).",
    variantsPl:
      "Tylko garnek, tylko piekarnik, albo jedno i drugie: krótko gotować i lekko dopiec. Z cebulą w piekarniku opisowo. Wariant dodatku zostaje przy [żurku](/pl/rezepte/zurek). Sąsiad cook: [kaszanka](/pl/rezepte/kaszanka). Typy i jakość: [rodzaje kiełbasy](/pl/blog/rodzaje-kielbasy). Okazja: [menu wielkanocne](/pl/blog/menu-wielkanocne). Zakwas: [zakwas na żur](/pl/blog/zakwas-na-zurek).",
  },
};
