...
export const W13_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-kutia": {
    ...
    serveDe:
      "In Schalen oder einer gemeinsamen Schüssel, oft kalt oder zimmerwarm, als süßer Gang am [Wigilia](/de/blog/wigilia-speiseplan)-Tisch neben Kompot und Fisch — Menü-Artikel bleibt der Speiseplan. Abgrenzung klar: Nudeln mit Mohn = [Makaron z makiem](/de/rezepte/makaron-z-makiem); Scheiben mit Spirale = [Makowiec](/de/rezepte/makowiec); Glas mit Trockenobst = [Kompot z suszu](/de/rezepte/kompot-z-suszu). Reste abgedeckt im Kühlschrank; vor dem Servieren umrühren, ggf. etwas Honig nachziehen.",
    servePl:
  ...
  "recipe-napoleonka": {
    ...
    originDe:
      "Napoleonka (auch Kremówka) ist der polnische Blätterteig-Schnitt mit Vanillecreme — millefeuille-ähnlich, oft mit Puderzucker — und bewusst kein Apfelkuchen und keine Schoko-Sahne-Torte. [Szarlotka](/de/rezepte/szarlotka) bleibt das passende Rezept des Apfelkuchens vom Blech; [Sernik](/de/rezepte/sernik) dem Käsekuchen; [Mazurek](/de/rezepte/mazurek) dem flachen Osterbelag. Wer Schoko-Sahne-Torte sucht: [Wuzetka](/de/rezepte/wuzetka) — anderer Rezept. Hier tragen Blätterteig und Vanillecreme den Intent „Napoleonka / Kremówka Rezept“: knusprige Platten, dicke Creme, kalter Rechteckschnitt. Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der ruhige Kaffee-Schluss sein — Kulturrahmen bleibt bei der Guide, Rezept diese URL. In der Diaspora ist das oft der Bäckerei-Klassiker, den man zu Hause mit Fertigteig nachbaut, wenn der Sonntagsnachmittag Zeit für Schichten und Kühlschrank hat. Kein generisches „beste Millefeuille“- ohne polnischen Namen: eng bei Napoleonka/Kremówka bleiben.",
    originPl:
      "Napoleonka (kremówka) to polski przekrój z ciasta francuskiego i kremu waniliowego — w stylu millefeuille, często z cukrem pudrem — świadomie nie jabłecznik i nie tort czekoladowo-śmietankowy. [Szarlotka](/pl/rezepte/szarlotka) zostaje przepisem na ciasta jabłkowego z blachy; [sernik](/pl/rezepte/sernik) sernika; [mazurek](/pl/rezepte/mazurek) płaskiego wielkanocnego. Kto szuka tortu czekoladowo-śmietankowego: [wuzetka](/pl/rezepte/wuzetka) — inny Rezept. Tu ciasto francuskie i krem waniliowy niosą intent „napoleonka / kremówka przepis”: chrupkie płaty, gęsty krem, zimny prostokątny przekrój. Przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) bywa spokojnym domknięciem przy kawie — przewodnik kulturowy zostaje przy guide, Rezept przy tej URL. W diasporze to często klasyk cukierniczy, który w domu odtwarza się z gotowym ciastem, gdy niedzielne popołudnie ma czas na warstwy i lodówkę. Bez generycznego „best millefeuille” bez polskiej nazwy: wąsko przy napoleonce/kremówce.",
    shopDe:
    ...
    mistakesDe:
      "Mit Szarlotka verwechseln (Apfel). Mit Sernik Hitze, Feuchtigkeit oder Garzeit falsch einschätzen. Mit [Wuzetka](/de/rezepte/wuzetka) verwechseln (Schoko-Sahne). Zu weicher Teig; zu flüssige Creme; zu früh schneiden; heiße Creme auf heißem Teig. Generisches Millefeuille- ohne Napoleonka/Kremówka.",
    mistakesPl:
