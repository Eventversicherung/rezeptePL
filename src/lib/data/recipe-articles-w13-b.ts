...
export const W13_FACTS_B: Record<string, ArticleFacts> = {
  ...
  "recipe-napoleonka": {
    ...
    mistakesDe:
      "Mit Szarlotka verwechseln (Apfel). Mit Sernik Primary stehlen. Mit [Wuzetka](/de/rezepte/wuzetka) verwechseln (Schoko-Sahne). Zu weicher Teig; zu flüssige Creme; zu früh schneiden; heiße Creme auf heißem Teig. Generisches Millefeuille-SEO ohne Napoleonka/Kremówka.",
    mistakesPl:
      "Mylenie z szarlotką (jabłko). Kradzież primary sernika. Mylenie z [wuzetką](/pl/rezepte/wuzetka) (czekolada+śmietana). Zbyt miękkie ciasto; za rzadki krem; zbyt wczesne krojenie; gorący krem na gorącym cieście. Generyczne SEO millefeuille bez napoleonki/kremówki.",
    variantsDe:
