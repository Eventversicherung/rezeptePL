 ...
 *   ≠ Szarlotka ≠ Sernik ≠ Mazurek ≠ Wuzetka (HOLD)
...
export const W13_FACTS_B: Record<string, ArticleFacts> = {
  "recipe-kutia": {
    ...
    originDe:
      "Kutia ist die Cook-Intent-Money-Page für das süße Getreide-Dessert aus Weizenkörnern, Mohn, Honig und Nüssen — typisch ostpolnisch und diaspora-stark zur Wigilia — und bewusst keine Nudelplatte. [Makaron z makiem](/de/rezepte/makaron-z-makiem) bleibt Owner der Pasta+Mohn-Linie; [Makowiec](/de/rezepte/makowiec) bleibt Owner der Hefe-Mohnrolle und des Backprojekts; der Technik-Pillar bleibt [Makowiec-Technik](/de/blog/makowiec-technik). Parallel klar getrennt von [Kompot z suszu](/de/rezepte/kompot-z-suszu): dort Getränk/Dessert-Kompot, hier die Schüssel mit gekochtem Weizen. Am [Wigilia-Speiseplan](/de/blog/wigilia-speiseplan) steht Kutia oft als regionales Getreide-Mohn-Gericht — der Speiseplan bleibt Anlass-Owner, hier nur Mengen und Schritte. In der Diaspora ist Kutia der Moment, in dem Körner, Mohn und Honig zusammenkommen, ohne Ofen und ohne Nudeltopf: Weizen garen, Masse binden, vermengen, kühlen. Keine Pasta, keine Spirale, kein Hefeteig.",
    originPl:
      "Kutia to money-page cook-intent na słodki deser zbożowy z ziaren pszenicy, maku, miodu i orzechów — typowo wschodniopolski i mocny w diasporze na Wigilię — świadomie nie talerz makaronu. [Makaron z makiem](/pl/rezepte/makaron-z-makiem) zostaje ownerem linii pasta+mak; [makowiec](/pl/rezepte/makowiec) zostaje ownerem drożdżowej rolady i projektu pieczenia; filar techniki zostaje przy [technice makowca](/pl/blog/makowiec-technika). Równolegle jasno osobno od [kompotu z suszu](/pl/rezepte/kompot-z-suszu): tam napój/kompot, tu miska ugotowanej pszenicy. Przy [menu wigilijnym](/pl/blog/menu-wigilijne) bywa regionalną potrawą zbożowo-makową — artykuł menu zostaje ownerem okazji, tu tylko ilości i kroki. W diasporze kutia to moment, gdy ziarna, mak i miód spotykają się bez pieca i bez garnka makaronu: ugotować pszenicę, związać masę, wymieszać, schłodzić. Bez makaronu, bez spirali, bez drożdży.",
    shopDe:
    ...
    techniqueDe:
      "Weizen weich, aber mit Biss kochen — zu hart bleibt sandig, zu zerkocht wird Brei. Mohn aufquellen, mahlen, mit Honig und Nüssen binden: streichfähig und glänzend, nicht tropfen, nicht mehlig-trocken. Heiß oder lauwarm vermengen, dann kühlen — Geschmack rundet sich. Bitterkeit kommt oft von altem Mohn; frische Samen prüfen. Masse-Logik darf descriptiv an [Makowiec-Technik](/de/blog/makowiec-technik) anknüpfen, ohne Primary „Mohnkuchen backen“ zu stehlen. Kein Nudelwasser, kein Ofenschritt: fertig in der Schüssel.",
    techniquePl:
      "Pszenicę ugotować miękko, ale z gryzieniem — za twarda zostaje piaszczysta, za rozgotowana robi kleik. Mak namoczyć, zmielić, związać miodem i orzechami: smarownie i z połyskiem, nie cieknie, nie jest sucha jak mąka. Mieszać ciepło lub letnio, potem chłodzić — smak się zbiera. Gorycz często ze starego maku; sprawdź świeżość. Logika masy może opisowo nawiązać do [techniki makowca](/pl/blog/makowiec-technika), bez kradzieży primary „pieczenia ciasta makowego”. Bez wody z makaronu i pieca: gotowe w misce.",
    serveDe:
      "In Schalen oder einer gemeinsamen Schüssel, oft kalt oder zimmerwarm, als süßer Gang am [Wigilia](/de/blog/wigilia-speiseplan)-Tisch neben Kompot und Fisch — Menü-Owner bleibt der Speiseplan. Abgrenzung klar: Nudeln mit Mohn = [Makaron z makiem](/de/rezepte/makaron-z-makiem); Scheiben mit Spirale = [Makowiec](/de/rezepte/makowiec); Glas mit Trockenobst = [Kompot z suszu](/de/rezepte/kompot-z-suszu). Reste abgedeckt im Kühlschrank; vor dem Servieren umrühren, ggf. etwas Honig nachziehen.",
    servePl:
      "W miseczkach lub jednej misce, często na zimno lub w temperaturze pokojowej, jako słodki element przy [menu wigilijnym](/pl/blog/menu-wigilijne) obok kompotu i ryby — owner menu zostaje przy artykule. Na stole: makaron z makiem = [makaron z makiem](/pl/rezepte/makaron-z-makiem); plastry ze spiralą = [makowiec](/pl/rezepte/makowiec); szklanka z suszem = [kompot z suszu](/pl/rezepte/kompot-z-suszu). Resztki przykryte w lodówce; przed podaniem wymieszać, ewentualnie dolać miodu.",
    diasporaDe:
      "In deutschen Küchen rettet Kutia oft den Mohn-Slot, wenn niemand Hefe führen und niemand noch Nudeln mit Masse rühren will: ein Topf Weizen, eine Schüssel Masse, Kühlschrank. Mohn und Weizen aus dem Polenladen halten; Kinder dürfen Nüsse streuen — heißer Topf bei Erwachsenen. Kein Affiliate-Zwang: gute Körner und frischer Mohn reichen. Technik-Nachbar descriptiv: [Makowiec-Technik](/de/blog/makowiec-technik). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen).",
    diasporaPl:
      "W niemieckich kuchniach kutia często ratuje slot makowy, gdy nikt nie chce prowadzić drożdży i nikt nie chce już mieszać makaronu z masą: jeden garnek pszenicy, jedna miska masy, lodówka. Mak i pszenica ze sklepu polskiego; dzieci mogą sypać orzechy — gorący garnek u dorosłych. Bez affiliate: dobre ziarna i świeży mak wystarczą. Sąsiad techniki opisowo: [technika makowca](/pl/blog/makowiec-technika). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy).",
    mistakesDe:
    ...
    variantsDe:
      "Mit mehr Honig runder; mit Orangenschale statt Zitrone; mit mehr Nüssen; kalt als Restespeise. Nudeln+Mohn bleibt [Makaron z makiem](/de/rezepte/makaron-z-makiem); Mohnrolle: [Makowiec](/de/rezepte/makowiec). Anlass: [Wigilia](/de/blog/wigilia-speiseplan). Technik-Feeling: [Makowiec-Technik](/de/blog/makowiec-technik). Einkauf: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    variantsPl:
      "Z większą ilością miodu łagodniej; ze skórką pomarańczy zamiast cytryny; z większą ilością orzechów; na zimno jako resztka. Makaron+mak: [makaron z makiem](/pl/rezepte/makaron-z-makiem); rolada: [makowiec](/pl/rezepte/makowiec). Okazja: [menu wigilijne](/pl/blog/menu-wigilijne). Technika: [makowiec-technika](/pl/blog/makowiec-technika). Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow).",
  },
  "recipe-napoleonka": {
    ...
    originDe:
      "Napoleonka (auch Kremówka) ist der polnische Blätterteig-Schnitt mit Vanillecreme — millefeuille-ähnlich, oft mit Puderzucker — und bewusst kein Apfelkuchen und keine Schoko-Sahne-Torte. [Szarlotka](/de/rezepte/szarlotka) bleibt Owner des Apfelkuchens vom Blech; [Sernik](/de/rezepte/sernik) dem Käsekuchen; [Mazurek](/de/rezepte/mazurek) dem flachen Osterbelag. Wuzetka (Schoko-Sahne) bleibt bewusst HOLD und bekommt hier keinen Primary — wer Schoko-Sahne sucht, findet hier bewusst keine Money Page. Hier tragen Blätterteig und Vanillecreme den Intent „Napoleonka / Kremówka Rezept“: knusprige Platten, dicke Creme, kalter Rechteckschnitt. Am [Sonntagsessen](/de/blog/sonntagsessen-polnisch) darf sie der ruhige Kaffee-Schluss sein — Kultur-Owner bleibt der Guide, Cook-Primary diese URL. In der Diaspora ist das oft der Bäckerei-Klassiker, den man zu Hause mit Fertigteig nachbaut, wenn der Sonntagsnachmittag Zeit für Schichten und Kühlschrank hat. Kein generisches „beste Millefeuille“-SEO ohne polnischen Namen: eng bei Napoleonka/Kremówka bleiben.",
    originPl:
      "Napoleonka (kremówka) to polski przekrój z ciasta francuskiego i kremu waniliowego — w stylu millefeuille, często z cukrem pudrem — świadomie nie jabłecznik i nie tort czekoladowo-śmietankowy. [Szarlotka](/pl/rezepte/szarlotka) zostaje ownerem ciasta jabłkowego z blachy; [sernik](/pl/rezepte/sernik) sernika; [mazurek](/pl/rezepte/mazurek) płaskiego wielkanocnego. Wuzetka (czekolada+śmietana) zostaje świadomie HOLD i nie dostaje tu primary — kto szuka czekolady ze śmietaną, nie znajdzie tu money page. Tu ciasto francuskie i krem waniliowy niosą intent „napoleonka / kremówka przepis”: chrupkie płaty, gęsty krem, zimny prostokątny przekrój. Przy [obiadzie niedzielnym](/pl/blog/obiad-niedzielny) bywa spokojnym domknięciem przy kawie — owner kultury zostaje przy guide, cook-primary przy tej URL. W diasporze to często klasyk cukierniczy, który w domu odtwarza się z gotowym ciastem, gdy niedzielne popołudnie ma czas na warstwy i lodówkę. Bez generycznego SEO „best millefeuille” bez polskiej nazwy: wąsko przy napoleonce/kremówce.",
    shopDe:
      "Blätterteig (fertig all-butter oder selbst), Milch, Eigelb, Zucker, Speisestärke oder Vanillepudding, Butter, Vanille, Puderzucker. Basis im Supermarkt; Vanille und manchmal bessere Puddingmischung im [Polenladen](/de/blog/polenladen-einkaufen). Wenn Butter oder Vanille knapp: ehrlich laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de) — keine Margarine-Show als „dasselbe“. Kein Apfelkern: das wäre [Szarlotka](/de/rezepte/szarlotka). Kein Quarkkern: das wäre [Sernik](/de/rezepte/sernik). Keine Schokocreme als Primary: Wuzetka bleibt HOLD.",
    shopPl:
      "Ciasto francuskie (gotowe maślane lub własne), mleko, żółtka, cukier, skrobia lub budyń waniliowy, masło, wanilia, cukier puder. Baza w markecie; wanilia i czasem lepszy budyń w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Gdy brak masła lub wanilii: uczciwie według [zamienników składników](/pl/blog/zamienniki-skladnikow) — bez show margaryny jako „to samo”. Bez jabłka: to byłaby [szarlotka](/pl/rezepte/szarlotka). Bez twarogu: to byłby [sernik](/pl/rezepte/sernik). Bez kremu czekoladowego jako primary: wuzetka zostaje HOLD.",
    techniqueDe:
      "Blätterteig dünn, gut einstechen, heiß und knusprig backen — zu weich trägt die Creme nicht; zu dunkel schmeckt bitter. Creme dicklich und abgekühlt binden; heiße Creme weicht den Teig sofort auf und macht den Schnitt matschig. Schichten ruhig und gleichmäßig; mindestens zwei bis drei Stunden kühlen, bis der Schnitt sauber ist. Zu flüssige Creme = Rutschen; zu trockene Creme = bröckelnde Füllung. Mit scharfem Messer und ruhigem Druck schneiden, nicht sägen. Eine Hausvariante festhalten: fertiger Blätterteig + Vanillecreme + Puderzucker (keine Schoko-Glasur als Primary, kein Apfelkern).",
    techniquePl:
      "Ciasto francuskie cienko, dobrze nakłuć, piec na chrupko — zbyt miękkie nie uniesie kremu; zbyt ciemne smakuje gorzko. Krem gęsty i ostudzony; gorący od razu rozmiękcza ciasto i psuje przekrój. Warstwy spokojnie i równo; chłodzić co najmniej dwie–trzy godziny aż krojenie jest czyste. Za rzadki krem = ślizganie; za suchy = krusząca się masa. Ostrym nożem i spokojnym naciskiem, bez piłowania. Trzymać jeden wariant domu: gotowe ciasto francuskie + krem waniliowy + cukier puder (bez lukru czekoladowego jako primary, bez jabłka).",
    serveDe:
      "In Rechtecken, kalt, oft mit Puderzucker, zu Tee oder Kaffee. Als Sonntagsschluss descriptiv unter [Sonntagsessen](/de/blog/sonntagsessen-polnisch). Abgrenzung auf dem Tisch: Apfelkuchen = [Szarlotka](/de/rezepte/szarlotka); Quarkkuchen = [Sernik](/de/rezepte/sernik); flacher Osterkuchen = [Mazurek](/de/rezepte/mazurek). Keine Schoko-Sahne-Präsentation als „dasselbe“. Hält ein bis zwei Tage gekühlt; Teig weicht allmählich — am besten am Backtag oder am Tag danach servieren.",
    servePl:
    ...
    diasporaDe:
      "Napoleonka ist der Bäckerei-Klassiker, den deutsche Gäste als „Creme-Schnitt“ verstehen und polnische Familien als Kremówka wiedererkennen, wenn der Teig knusprig und die Creme vanillig ist. Ein Blech für den Sonntag, Stücke für Gäste, Rest für den nächsten Morgen. Fertigteig ist diaspora-ehrlich und spart Zeit — die Creme bleibt der Charakterträger. Kein Zwang zu Schoko-Torten-Ästhetik — Puderzucker reicht. Einkauf und Ersatz: [Polenladen](/de/blog/polenladen-einkaufen), [Ersatzprodukte](/de/blog/ersatzprodukte-de).",
    diasporaPl:
      "Napoleonka to klasyk cukierniczy, który niemieccy goście rozumieją jako „przekrój z kremem”, a polskie rodziny rozpoznają jako kremówkę, gdy ciasto jest chrupkie, a krem waniliowy. Jedna blacha na niedzielę, kawałki dla gości, resztka na następny poranek. Gotowe ciasto jest uczciwe w diasporze i oszczędza czas — charakter niesie krem. Bez przymusu estetyki tortu czekoladowego — cukier puder wystarczy. Zakupy: [sklep polski](/pl/blog/sklep-polski-zakupy), [zamienniki](/pl/blog/zamienniki-skladnikow).",
    mistakesDe:
      "Mit Szarlotka verwechseln (Apfel). Mit Sernik Primary stehlen. Mit Wuzetka verwechseln (Schoko-Sahne). Zu weicher Teig; zu flüssige Creme; zu früh schneiden; heiße Creme auf heißem Teig. Generisches Millefeuille-SEO ohne Napoleonka/Kremówka.",
    mistakesPl:
      "Mylenie z szarlotką (jabłko). Kradzież primary sernika. Mylenie z wuzetką (czekolada+śmietana). Zbyt miękkie ciasto; za rzadki krem; zbyt wczesne krojenie; gorący krem na gorącym cieście. Generyczne SEO millefeuille bez napoleonki/kremówki.",
    variantsDe:
