...
export const W8_FACTS_A: Record<string, W8ArticleFacts> = {
 ...
 shopDe:
 "Feste Salat- oder Feldgurken, frischer Dill, und ein Milchprodukt mit klarer Rolle: Schmand oder saure Sahne statt „irgendeiner Sahne“. Welche Stufe wohin passt, erklärt der [Śmietana-und-Schmand-Guide](/de/blog/smietana-schmand) — dort findest du Alternativen; hier bleibt der Anwendungsfall Mizeria. Zucker und Pfeffer sparsam. Optional sehr feine Zwiebel. Einkaufstag und Spezialitäten: [Polenladen-Guide](/de/blog/polenladen-einkaufen).",
 shopPl:
