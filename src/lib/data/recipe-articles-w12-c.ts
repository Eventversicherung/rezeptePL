...
export const W12_FACTS_C: Record<string, ArticleFacts> = {
  "recipe-mazurek": {
    ...
    originDe:
      "Mazurek ist der Cook-Intent für den flachen polnischen Osterkuchen: dünner Mürbeteigboden, darauf eine dichte Masse oder ein Belag — hier die Hausvariante orzechowy mit Nüssen und Honig/Zucker. Das ist weder der hohe Hefegugelhupf [Babka](/de/rezepte/babka) noch der Quarkkuchen [Sernik](/de/rezepte/sernik) noch die Mohnrolle [Makowiec](/de/rezepte/makowiec) noch der Gewürz-Lebkuchen [Piernik](/de/rezepte/piernik). Menürahmen und Timeline bleiben im [Wielkanoc Speiseplan](/de/blog/wielkanoc-speiseplan) — dort Anlass-Owner, hier der enge Rezept-Primary. In der Diaspora oft der Kuchen, den man am Vortag backt und in Rauten schneidet: wenig Höhe, viel Belag, klarer Schnitt.",
    originPl:
      "Mazurek to intent cook: płaski polski placek wielkanocny — cienki kruchy spód i gęsty wierzch; tu wersja orzechowa z orzechami i miodem/cukrem. To ani wysoka drożdżowa [babka](/pl/rezepte/babka), ani [sernik](/pl/rezepte/sernik), ani rolada [makowiec](/pl/rezepte/makowiec), ani korzenny [piernik](/pl/rezepte/piernik). Ramę menu zostawiamy w [menu wielkanocnym](/pl/blog/menu-wielkanocne) — tam owner okazji, tu wąski primary przepisu. W diasporze często wypiek z dnia wcześniej, krojony w romby: mała wysokość, dużo wierzchu, czysty przekrój.",
    shopDe:
      "Mehl, kalte Butter, Zucker, Ei für den Boden; gemischte Nüsse und Honig für den Belag — Nüsse und guter Honig oft im [Polenladen](/de/blog/polenladen-einkaufen). Fehlt eine Nusssorte: ehrlich ersetzen laut [Ersatzprodukte DE](/de/blog/ersatzprodukte-de). Hefe braucht dieses Rezept nicht — wer Hefe-Feeling sucht, bleibt descriptiv bei [Makowiec-Technik](/de/blog/makowiec-technik), ohne den Makowiec-Primary zu stehlen. Form: flaches Blech, keine Gugelhupf-Form wie bei Babka.",
    shopPl:
      "Mąka, zimne masło, cukier, jajko na spód; mieszanka orzechów i miód na wierzch — orzechy i dobry miód często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Brak sorty: uczciwa zamiana według [zamienników](/pl/blog/zamienniki-skladnikow). Drożdże nie są potrzebne — kto chce wyczucie drożdży, opisowo [technika makowca](/pl/blog/makowiec-technika), bez kradzieży primary makowca. Forma: płaska blacha, nie babkowa.",
    techniqueDe:
    ...
    serveDe:
      "In Rauten oder Rechtecken auf Platte, optional getrocknete Früchte. Am Ostertisch descriptiv neben Żurek und Eiern; Primary bleibt dieses Rezept, Menü-Owner [Wielkanoc](/de/blog/wielkanoc-speiseplan). Wer Höhe und Hefe will: [Babka](/de/rezepte/babka). Wer Quark: [Sernik](/de/rezepte/sernik). Wer Mohnspirale: [Makowiec](/de/rezepte/makowiec). Reste luftdicht — Belag hält knusprig-nussig.",
    servePl:
      "W romby lub prostokąty na półmisek, opcjonalnie suszone owoce. Przy stole opisowo obok żurku i jaj; primary zostaje ten przepis, owner menu: [menu wielkanocne](/pl/blog/menu-wielkanocne). Kto chce wysokość i drożdże: [babka](/pl/rezepte/babka). Twaróg: [sernik](/pl/rezepte/sernik). Mak: [makowiec](/pl/rezepte/makowiec). Resztki szczelnie — wierzch zostaje chrupiący.",
    diasporaDe:
      "In DE oft Samstag backen, Sonntag nur anrichten — entlastet den Ostermorgen. Kinder dürfen Nüsse zählen und Rauten legen; heißer Ofen bei Erwachsenen. Ein Blech reicht für viele Gäste; Qualität vor drei verschiedenen Kuchen. Einkauf früh im [Polenladen](/de/blog/polenladen-einkaufen), bevor Nuss- und Honigregale leer sind. Speiseplan nicht als Cook-Owner beanspruchen — [Wielkanoc](/de/blog/wielkanoc-speiseplan) bleibt Anlass.",
    diasporaPl:
      "W DE często piecz sobotę, niedzielę tylko układaj — odciąża poranek. Dzieci policzą orzechy i ułożą romby; gorący piec u dorosłych. Jedna blacha wystarczy dla gości; jakość przed trzema wypiekami. Zakupy wcześniej w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Nie rość o ownership menu — [menu wielkanocne](/pl/blog/menu-wielkanocne) zostaje okazją.",
    mistakesDe:
      "Zu dicker Boden. Belag ohne Vorbacken (matschig). Mit [Babka](/de/rezepte/babka) oder [Sernik](/de/rezepte/sernik) verwechseln. Mohnrollen-Primary von [Makowiec](/de/rezepte/makowiec) stehlen. Heiß schneiden. Speiseplan-Ownership beanspruchen statt [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    mistakesPl:
      "Za gruby spód. Wierzch bez podpieczenia. Mylenie z [babką](/pl/rezepte/babka) lub [sernikiem](/pl/rezepte/sernik). Kradzież primary [makowca](/pl/rezepte/makowiec). Krojenie na gorąco. Roszczenie ownership menu zamiast [menu wielkanocnego](/pl/blog/menu-wielkanocne).",
    variantsDe:
  ...
  "recipe-buraczki": {
    ...
    originDe:
      "Buraczki sind der Cook-Intent für die warme Rote-Bete-Beilage der polnischen Sonntags- und Festküche: gekocht, geraspelt oder in Streifen, mit Zwiebel, oft Apfel und Meerrettich — heiß oder lauwarm neben Fleisch. Das ist weder die junge-Bete-Suppe [Botwinka](/de/rezepte/botwinka) noch die klare oder cremige Bete-Suppe [Barszcz czerwony](/de/rezepte/barszcz-czerwony) noch der kalte Mayo-Festsalat [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa). Menüwahl und Rhythmus bleiben im [Sonntagsessen-Guide](/de/blog/sonntagsessen-polnisch); hier liegt der enge Beilagen-Primary. Klassischer Nachbar auf dem Teller: [Kotlet schabowy](/de/rezepte/kotlet-schabowy).",
    originPl:
      "Buraczki to intent cook: ciepły dodatek z buraków w polskiej kuchni niedzielnej i świątecznej — ugotowane, tarte lub w paski, z cebulą, często jabłkiem i chrzanem — gorące lub letnie obok mięsa. To ani zupa z młodych buraków [botwinka](/pl/rezepte/botwinka), ani [barszcz czerwony](/pl/rezepte/barszcz-czerwony), ani zimna majonezowa [sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa). Wybór menu zostaje w [obiadzie niedzielnym](/pl/blog/obiad-niedzielny); tu wąski primary dodatku. Klasyczny sąsiad: [kotlet schabowy](/pl/rezepte/kotlet-schabowy).",
    shopDe:
    ...
    mistakesDe:
      "Zu viel Flüssigkeit (wird Suppe → Clash mit [Botwinka](/de/rezepte/botwinka)/[Barszcz](/de/rezepte/barszcz-czerwony)). Mit [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa) verwechseln. Meerrettich von Anfang an verkochen. Roh essen wollen ohne Garung. Sonntags-Ownership stehlen statt [Sonntagsessen](/de/blog/sonntagsessen-polnisch).",
    mistakesPl:
      "Za dużo płynu (robi się zupa → clash z [botwinką](/pl/rezepte/botwinka)/[barszczem](/pl/rezepte/barszcz-czerwony)). Mylenie z [sałatką jarzynową](/pl/rezepte/salatka-jarzynowa). Chrzan od początku wygotowany. Jedzenie na surowo bez ugotowania. Kradzież ownership niedzieli zamiast [obiadu niedzielnego](/pl/blog/obiad-niedzielny).",
    variantsDe:
      "Ohne Apfel nur Meerrettich; mit etwas Butter am Ende; milder für Kinder. Nachbarn: [Schabowy](/de/rezepte/kotlet-schabowy), [Botwinka](/de/rezepte/botwinka) (Suppe ≠ Beilage), [Barszcz](/de/rezepte/barszcz-czerwony), [Sałatka jarzynowa](/de/rezepte/salatka-jarzynowa). Guides: [Sonntagsessen](/de/blog/sonntagsessen-polnisch), [Panieren](/de/blog/panieren-schabowy), [Śmietana](/de/blog/smietana-schmand).",
    variantsPl:
      "Bez jabłka tylko chrzan; z odrobiną masła na końcu; łagodniej dla dzieci. Sąsiedzi: [schabowy](/pl/rezepte/kotlet-schabowy), [botwinka](/pl/rezepte/botwinka) (zupa ≠ dodatek), [barszcz](/pl/rezepte/barszcz-czerwony), [sałatka jarzynowa](/pl/rezepte/salatka-jarzynowa). Przewodniki: [obiad niedzielny](/pl/blog/obiad-niedzielny), [panierowanie](/pl/blog/panierowanie-kotlet), [śmietana](/pl/blog/smietana-czy-schmand).",
  },
};
