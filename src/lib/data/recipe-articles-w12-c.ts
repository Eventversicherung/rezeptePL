...
export const W12_FACTS_C: Record<string, ArticleFacts> = {
  "recipe-mazurek": {
    ...
    originPl:
      "Mazurek to przepis na płaski polski placek wielkanocny — cienki kruchy spód i gęsty wierzch; tu wersja orzechowa z orzechami i miodem/cukrem. To ani wysoka drożdżowa [babka](/pl/rezepte/babka), ani [sernik](/pl/rezepte/sernik), ani rolada [makowiec](/pl/rezepte/makowiec), ani korzenny [piernik](/pl/rezepte/piernik). Ramę menu zostawiamy w [menu wielkanocnym](/pl/blog/menu-wielkanocne) — tam owner okazji, tu wąski fokus przepisu. W diasporze często wypiek z dnia wcześniej, krojony w romby: mała wysokość, dużo wierzchu, czysty przekrój.",
    shopDe:
    ...
    diasporaDe:
      "In DE oft Samstag backen, Sonntag nur anrichten — entlastet den Ostermorgen. Kinder dürfen Nüsse zählen und Rauten legen; heißer Ofen bei Erwachsenen. Ein Blech reicht für viele Gäste; Qualität vor drei verschiedenen Kuchen. Einkauf früh im [Polenladen](/de/blog/polenladen-einkaufen), bevor Nuss- und Honigregale leer sind. Speiseplan nicht als Rezept ersetzen — [Wielkanoc](/de/blog/wielkanoc-speiseplan) bleibt Anlass.",
    diasporaPl:
      "W DE często piecz sobotę, niedzielę tylko układaj — odciąża poranek. Dzieci policzą orzechy i ułożą romby; gorący piec u dorosłych. Jedna blacha wystarczy dla gości; jakość przed trzema wypiekami. Zakupy wcześniej w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Nie kopiuj planu menu — [menu wielkanocne](/pl/blog/menu-wielkanocne) zostaje okazją.",
    mistakesDe:
      "Zu dicker Boden. Belag ohne Vorbacken (matschig). Mit [Babka](/de/rezepte/babka) oder [Sernik](/de/rezepte/sernik) verwechseln. Mohnrollen-Hitze, Feuchtigkeit oder Garzeit falsch einschätzen. Heiß schneiden. Den Speiseplan hier nicht ersetzen — dafür gibt es [Wielkanoc](/de/blog/wielkanoc-speiseplan).",
    mistakesPl:
    ...
    variantsPl:
      "Wierzch kajmakowy zamiast orzechów (zwyczaj domu, uczciwie w tytule); tylko włoskie; z morelami. Pasujący sąsiedzi to [babka](/pl/rezepte/babka), [sernik](/pl/rezepte/sernik), [makowiec](/pl/rezepte/makowiec), [piernik](/pl/rezepte/piernik). Do okazji pasuje [menu wielkanocne](/pl/blog/menu-wielkanocne). W [sklep polski](/pl/blog/sklep-polski-zakupy) i pod [zamienniki](/pl/blog/zamienniki-skladnikow) znajdziesz wskazówki zakupowe.",
  },
  ...
  "recipe-buraczki": {
    ...
    shopPl:
      "Buraki surowe lub gotowane, cebula, kwaśne jabłko, chrzan ze słoika lub świeży — często w [sklepie polskim](/pl/blog/sklep-polski-zakupy). Masło/olej, sól, pieprz, szczypta cukru. Śmietanę osobno: [śmietana/schmand](/pl/blog/smietana-czy-schmand). Kto szuka zupy z buraków: [botwinka](/pl/rezepte/botwinka) lub [barszcz](/pl/rezepte/barszcz-czerwony) — inny charakter, inne danie.",
    techniqueDe:
