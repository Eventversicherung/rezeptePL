  ...
  },
  {
    ...
    translations: {
      de: {
        ...
        slug: "bigos",
        excerpt:
          "Polnischer Krautschmortopf aus Sauerkraut, Weißkohl, Schwein, geräucherter Kiełbasa und Pflaumen, idealerweise einen Tag vorher gekocht und aufgewärmt, herzhafter als Kapusta zasmażana und ohne die Tomatenbasis eines Gulasz.",
        steps: [
          {
            text: "Getrocknete Pilze in heißem Wasser einweichen. Speck ausbraten, das Schweinefleisch darin scharf anbraten und beides beiseitestellen.",
            tip: "Die Röstaromen bleiben im Topf und geben später der ganzen Sauce mehr Tiefe. Ein [Dutch Oven](/de/blog/dutch-oven-kaufberatung) hält die Hitze gleichmäßig.",
          },
          {
            text: "Zwiebeln im Bratfett glasig dünsten, die abgetropften, grob gehackten Pilze kurz mitbraten. Sauerkraut und Weißkohl untermischen.",
            tip: "Das Einweichwasser der Pilze aufheben und später mitverwenden, es steckt voller Aroma. Mehr zur Fermentation im [Kiszenie-Guide](/de/blog/kiszenie-guide).",
          },
          {
            text: "Fleisch, in Scheiben geschnittene Kiełbasa, Pflaumen, Lorbeer, Piment, Majoran, Pfeffer, das Pilzwasser und so viel Brühe zugeben, dass alles gerade bedeckt ist. Zugedeckt 2 bis 2,5 Stunden bei niedriger Hitze schmoren, gelegentlich rühren.",
            tip: "Der Topf soll löffelfest bleiben, nicht wässrig. Tomatenmark ist eine Hausvariante, kein Muss. Technik und Zeit erklärt der [Bigos-Guide](/de/blog/bigos-guide).",
          },
          {
            text: "Abschmecken und heiß mit kräftigem Brot servieren. Am besten über Nacht kalt stellen und am nächsten Tag aufwärmen.",
            tip: "Ist er zu sauer, hilft frischer Weißkohl statt Zucker. Wurstarten zum Nachwürzen stehen im Guide zu [Kiełbasa-Arten](/de/blog/kielbasa-arten).",
          },
        ],
        seoTitle: "Bigos Rezept | Alemniam",
        seoDescription:
          "Klassischer Bigos mit Sauerkraut, Schwein, Kiełbasa und Pflaumen. 2,5 Stunden Schmorzeit, besser am zweiten Tag, mit Einkaufshilfe für Deutschland.",
      },
      pl: {
        title: "Bigos",
        slug: "bigos",
        excerpt:
          "Polski gulasz z kapusty kiszonej, kapusty świeżej, wieprzowiny, wędzonej kiełbasy i śliwek, najlepiej ugotowany dzień wcześniej i odgrzany, głębszy w smaku niż kapusta zasmażana i bez pomidorowej bazy gulaszu.",
        steps: [
          {
            text: "Namocz suszone grzyby w gorącej wodzie. Podsmaż boczek, mocno obsmaż w tym tłuszczu wieprzowinę i odłóż całość na bok.",
            tip: "Aromaty z obsmażania zostają na dnie garnka i później wzmacniają cały sos. [Garnek do duszenia](/pl/blog/garnek-do-duszenia) trzyma równomierne ciepło.",
          },
          {
            text: "Zeszklij cebulę na tym samym tłuszczu, krótko podsmaż odsączone, grubo posiekane grzyby. Wymieszaj z kapustą kiszoną i świeżą.",
            tip: "Wodę z namaczania grzybów zachowaj i dodaj później, ma mocny aromat. Więcej o kiszeniu w [przewodniku kiszenia](/pl/blog/kiszenie-w-domu).",
          },
          {
            text: "Dodaj mięso, pokrojoną kiełbasę, śliwki, liść laurowy, ziele angielskie, majeranek, pieprz, wodę z grzybów i tyle bulionu, żeby wszystko było ledwo przykryte. Duś pod przykryciem 2 do 2,5 godziny na małym ogniu, od czasu do czasu mieszając.",
            tip: "Bigos ma być gęsty, nie wodnisty. Koncentrat pomidorowy to wariant domu, nie obowiązek. Czas i technikę wyjaśnia [przewodnik po bigosie](/pl/blog/bigos-przewodnik).",
          },
          {
            text: "Dopraw do smaku i podawaj gorący z mocnym chlebem. Najlepiej odstawić na noc do lodówki i odgrzać następnego dnia.",
            tip: "Jeśli wyszedł zbyt kwaśny, dodaj świeżej kapusty zamiast cukru. Rodzaje kiełbas do doprawienia znajdziesz w [przewodniku po kiełbasach](/pl/blog/rodzaje-kielbasy).",
          },
        ],
        seoTitle: "Bigos przepis | Alemniam",
        seoDescription:
          "Klasyczny bigos z kapustą kiszoną, wieprzowiną, kiełbasą i śliwkami. 2,5 godziny duszenia, lepszy na drugi dzień, z listą zakupów w Niemczech.",
      },
    },
    ingredients: [
      {
        ...
        unit: { de: "g", pl: "g" },
        group: "polish",
        storeHintDe: "Sauerkraut / kiszona im Polenladen",
      },
      {
        id: "bi-2",
      ...
      {
        id: "bi-3",
        name: { de: "Schweinefleisch (Nacken oder Schulter)", pl: "Wieprzowina (karkówka lub łopatka)" },
        amount: 500,
        unit: { de: "g", pl: "g" },
        group: "other",
      },
      ...
      {
        id: "bi-7",
        name: { de: "Geräucherte Kiełbasa", pl: "Kiełbasa wędzona" },
        amount: 300,
        unit: { de: "g", pl: "g" },
        group: "polish",
        storeHintDe: "Polenladen, z. B. wiejska oder jałowcowa",
      },
      {
        id: "bi-8",
      ...
      {
        id: "bi-9",
        name: { de: "Getrocknete Pflaumen", pl: "Suszone śliwki" },
        amount: 80,
        unit: { de: "g", pl: "g" },
        group: "pantry",
        storeHintDe: "Entsteint, nicht kandiert",
      },
      {
        id: "bi-10",
        ...
        group: "pantry",
        substitute: {
          de: "Wasser plus das Einweichwasser der Pilze",
          pl: "Woda plus woda z namaczania grzybów",
        },
      },
      {
        id: "bi-6",
      ...
      {
        id: "bi-11",
        name: { de: "Piment", pl: "Ziele angielskie" },
        amount: 5,
        unit: { de: "Körner", pl: "ziarna" },
        group: "spices",
      },
      {
        id: "bi-12",
  ...
  },
  {
    ...
    translations: {
      de: {
        ...
        slug: "zurek",
        excerpt:
          "Kräftige Sauerteigsuppe aus fermentiertem Roggen mit biała kiełbasa, Kartoffeln und hartgekochtem Ei, säuerlicher und dichter als der klare Barszcz und herzhafter als die goldene Hühnerbrühe Rosół.",
        steps: [
          {
            text: "Brühe oder Wasser mit Lorbeer, Piment, Zwiebel, Kartoffelwürfeln und der rohen biała kiełbasa aufsetzen. Bei leichtem Köcheln garen, die Wurst nach etwa 20 Minuten herausnehmen und in Scheiben schneiden, die Kartoffeln weitergaren, bis sie weich sind.",
            tip: "Fertigen Żur-Ansatz und biała kiełbasa bekommst du im [Polenladen](/de/blog/polenladen-einkaufen). Die polnische Frischwurst ist keine Münchner Weißwurst, mehr dazu im Rezept zu [Biała kiełbasa](/de/rezepte/biala-kielbasa).",
          },
          {
            text: "Den Topf von der starken Hitze nehmen. Den Żur-Ansatz einrühren und nur noch kurz erwärmen, ohne ihn stark aufkochen zu lassen.",
            tip: "Zu heftiges Kochen nach dem Ansatz macht die Suppe flach und weniger sauer. Wer selbst ansetzt, folgt dem [Zakwas-Guide](/de/blog/zakwas-zurek).",
          },
          {
            text: "Mit zerdrücktem Knoblauch und Majoran abschmecken. Optional Meerrettich und ein wenig Śmietana, die zuvor mit etwas heißer Suppe verrührt wird.",
            tip: "Der Majoran macht die Suppe erst wirklich zum Żurek. Probiere am Ende noch einmal, denn die Säure verändert sich nach dem Einrühren des Ansatzes.",
          },
          {
            text: "Eier separat hart kochen, schälen und halbieren. Den Żurek heiß mit Wurstscheiben, Ei und kräftigem Brot servieren.",
            tip: "Das Ei gehört auf den Teller, nicht in den Topf. Die fleischlose Fastenversion ohne Wurst ist die Wigilia-Linie, dieser Topf ist die Osterversion laut [Wielkanoc-Speiseplan](/de/blog/wielkanoc-speiseplan).",
          },
        ],
        seoTitle: "Żurek Rezept | Alemniam",
        seoDescription:
          "Żurek zu Ostern: Sauerteigsuppe mit biała kiełbasa, Kartoffeln und hartgekochtem Ei. Zakwas erst am Ende, mit Einkaufshilfe für Deutschland.",
      },
      pl: {
        title: "Żurek",
        slug: "zurek",
        excerpt:
          "Gęsta zupa na żytnim zakwasie z białą kiełbasą, ziemniakami i jajkiem na twardo, kwaśniejsza i gęstsza niż klarowny barszcz i bardziej sycąca niż złoty rosół z kurczaka.",
        steps: [
          {
            text: "Bulion lub wodę zagotuj z liściem laurowym, zielem angielskim, cebulą, kostką ziemniaków i surową białą kiełbasą. Gotuj na lekkim ogniu, kiełbasę wyjmij po około 20 minutach i pokrój w plastry, ziemniaki gotuj dalej do miękkości.",
            tip: "Gotowy zakwas i białą kiełbasę kupisz w [sklepie polskim](/pl/blog/sklep-polski-zakupy). To nie monachijska weisswurst, więcej w przepisie na [białą kiełbasę](/pl/rezepte/biala-kielbasa).",
          },
          {
            text: "Zdejmij garnek z mocnego ognia. Wlej zakwas i tylko krótko podgrzej, bez gwałtownego wrzenia.",
            tip: "Zbyt mocne gotowanie po dodaniu zakwasu spłaszcza zupę i zabiera kwas. Kto robi własny, idzie za [przewodnikiem po zakwasie](/pl/blog/zakwas-na-zurek).",
          },
          {
            text: "Dopraw roztartym czosnkiem i majerankiem. Opcjonalnie chrzan i odrobinę śmietany, wcześniej rozprowadzonej gorącą zupą.",
            tip: "Majeranek naprawdę czyni tę zupę żurkiem. Spróbuj jeszcze raz na końcu, bo kwasowość zmienia się po wlaniu zakwasu.",
          },
          {
            text: "Jajka ugotuj osobno na twardo, obierz i przekrój na pół. Podawaj żurek gorący z plastrami kiełbasy, jajkiem i mocnym chlebem.",
            tip: "Jajko należy na talerz, nie do garnka. Bezmiesna wersja postna bez kiełbasy to linia wigilijna, ten garnek to wersja wielkanocna według [menu wielkanocnego](/pl/blog/menu-wielkanocne).",
          },
        ],
        seoTitle: "Żurek przepis | Alemniam",
        seoDescription:
          "Żurek na Wielkanoc: zupa na zakwasie z białą kiełbasą, ziemniakami i jajkiem na twardo. Zakwas na końcu, z listą zakupów w Niemczech.",
      },
    },
    ingredients: [
      {
        id: "zu-6",
        name: { de: "Brühe oder Wasser", pl: "Bulion lub woda" },
        amount: 1500,
        unit: { de: "ml", pl: "ml" },
        group: "pantry",
        storeHintDe: "Fleischbrühe trägt die Osterversion, Wasser reicht für den Alltag",
      },
      {
        id: "zu-1",
        ...
        unit: { de: "ml", pl: "ml" },
        group: "polish",
        storeHintDe: "Flasche im Polenladen, nicht Essig",
        substitute: {
      ...
      {
        id: "zu-2",
        name: { de: "Biała kiełbasa, roh", pl: "Biała kiełbasa, surowa" },
        amount: 400,
        unit: { de: "g", pl: "g" },
        group: "polish",
        storeHintDe: "Polenladen, gekühlt. Keine Münchner Weißwurst",
      },
      {
        id: "zu-3",
      ...
      },
      {
        ...
        group: "dairy",
        section: "finish",
        storeHintDe: "Separat kochen und auf dem Teller servieren",
      },
      {
        id: "zu-11",
        name: { de: "Meerrettich (optional)", pl: "Chrzan (opcjonalnie)" },
        amount: 1,
        unit: { de: "EL", pl: "łyżka" },
        group: "pantry",
        section: "finish",
        storeHintDe: "Glasware im Polenladen, zur Osterversion",
      },
      {
        id: "zu-12",
        name: { de: "Śmietana (optional)", pl: "Śmietana (opcjonalnie)" },
        amount: 100,
        unit: { de: "ml", pl: "ml" },
        group: "dairy",
        section: "finish",
        storeHintDe: "Schmand oder 18–22 % Śmietana, nicht in den kochenden Topf",
      },
    ],
