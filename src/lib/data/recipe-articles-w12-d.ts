...
export const W12_FACTS_D: Record<string, ArticleFacts> = {
 ...
 shopDe:
 "Hack gemischt, altes Brötchen, Ei, Zwiebel, Brühe. Dill frisch aus dem Supermarkt. Śmietana 12–18 % oft im [Polenladen](/de/blog/polenladen-einkaufen); alternativ Schmand laut [Śmietana/Schmand](/de/blog/smietana-schmand) ehrlich benennen. Keine Semmelbrösel-Panade nötig — das hält den Fokus klar neben [Kotlet mielony](/de/rezepte/kotlet-mielony).",
 shopPl:
 "Mięso mielone, czerstwa bułka, jajko, cebula, bulion. Koperek świeży z marketu. Śmietana 12–18 % często w [sklepie polskim](/pl/blog/sklep-polski-zakupy); schmand według [przewodnika](/pl/blog/smietana-czy-schmand) — nazwać uczciwie. Bułka tarta do panierki nie jest potrzebna — fokus zostaje czysty obok [kotleta mielonego](/pl/rezepte/kotlet-mielony).",
 techniqueDe:
