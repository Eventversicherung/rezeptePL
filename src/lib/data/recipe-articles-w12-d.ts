...
export const W12_FACTS_D: Record<string, ArticleFacts> = {
 ...
 originDe:
 "Klopsy — auch Pulpety — sind das Rezept für Hackfleischkugeln, die in einer Soße garziehen, hier bewusst in der Dill-Sahnelinie. Das ist weder die panierte Bulette [Kotlet mielony](/de/rezepte/kotlet-mielony) noch der panierte Sonntags-Schnitzel [Kotlet schabowy](/de/rezepte/kotlet-schabowy). Form und Technik trennen die Gerichte: rund, ohne Panade, in Soße — nicht flach und knusprig. Menü-Kultur bleibt im [Sonntagsessen-Guide](/de/blog/sonntagsessen-polnisch); Panade-Wissen bleibt im [Panieren-Guide](/de/blog/panieren-schabowy). In der Diaspora oft der pragmatische Hack-Teller, wenn die Pfanne nicht die Panade-Station werden soll.",
 originPl:
 "Klopsy — też pulpety — to przepis na kulki z mielonego mięsa duszone w sosie, tu świadomie linia koperkowo-śmietanowa. To ani panierowany [kotlet mielony](/pl/rezepte/kotlet-mielony), ani [schabowy](/pl/rezepte/kotlet-schabowy). Forma i technika dzielą dania: okrągłe, bez panierki, w sosie — nie płaskie i chrupiące. Kulturę menu zostawiamy w [obiadzie niedzielnym](/pl/blog/obiad-niedzielny); panierka w [przewodniku panierowania](/pl/blog/panierowanie-kotlet). W diasporze często pragmatyczny talerz z mielonego, gdy nie chce się stacji panierki.",
 shopDe:
 "Für die Klopsy brauchst du gemischtes Hack, ein altes Brötchen, Ei und Zwiebel sowie Brühe zum Garziehen. Frischen Dill holst du im Supermarkt; Śmietana (12–18 %) oft im [Polenladen](/de/blog/polenladen-einkaufen). Das ist kein flacher Pfannen-[Kotlet mielony](/de/rezepte/kotlet-mielony) und kein Ofenlaib wie [Pieczeń rzymska](/de/rezepte/pieczen-rzymska) — hier schwimmen die Bällchen in Dill-Sahne-Sauce.",
 shopPl:
 ...
 mistakesDe:
 "Häufig wird Klopsy mit [Kotlet mielony](/de/rezepte/kotlet-mielony) verwechselt und paniert — hier bleiben Kugeln in Soße. Śmietana darf nicht aufkochen, sonst flockt sie; zu wenig Dill und zu große Klopsy machen den Teller flach oder ungleich gar.",
 mistakesPl:
 "Często klopsy myli się z [kotletem mielonym](/pl/rezepte/kotlet-mielony) i panieruje — tu zostają kulki w sosie. Śmietana nie może się zagotować, bo się zwarzy; za mało koperku i za duże klopsy spłaszczają talerz albo garują nierówno.",
 variantsDe:
 ...
 techniqueDe:
 "Teig löffelbar, nicht knetfest. In leicht kochendes Wasser oder Brühe stechen; nach dem Aufschwimmen kurz nachgaren. Zu flüssiger Teig zerfällt; zu fest wird gummiartig. Fertige Fadenudeln aus der Packung sind eine andere Fokus-Linie — hier zählt die Handarbeit mit dem Löffel.",
 techniquePl:
 "Ciasto łyżkowalne, nie do wyrabiania. Odkładać do lekko wrzącej wody lub bulionu; po wypłynięciu krótko dogotować. Za rzadkie ciasto się rozpada; za twarde robi się gumowate. Gotowe nitki z paczki to inna linia fokus — tu liczy się praca łyżką.",
 serveDe:
 ...
 mistakesDe:
 "Mit [Kluski śląskie](/de/rezepte/kluski-slaskie) oder [Kopytka](/de/rezepte/kopytka) verwechseln. Teig zu fest kneten. Zu stark sprudelnd kochen. nein.",
 mistakesPl:
 "Mylenie z [kluskami śląskimi](/pl/rezepte/kluski-slaskie) lub [kopytkami](/pl/rezepte/kopytka). Zbyt twarde wyrabianie. Zbyt gwałtowne gotowanie. Nie mieszać ilości i kroków z sąsiednim przepisem.",
 variantsDe:
