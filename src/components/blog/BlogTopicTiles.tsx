...
export function BlogTopicTiles({
  topics,
  activeKey,
  postsLabel,
}: {
  ...
  return (
    <div className="stagger grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
      {topics.map((topic) => {
        const href = `/blog?typ=${topic.key}` as "/blog";
        ...
        return (
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 p-4">
              ...
              <span className="mt-3 inline-block text-xs font-semibold uppercase tracking-[0.12em] text-white">
                {postsLabel} →
              </span>
            </div>
          </Link>
